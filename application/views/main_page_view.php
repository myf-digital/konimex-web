...
<html lang="en-us">
	<head>
		...
		<!-- Add modern table CSS files -->
		<link href="<?php echo base_url()."assets/" ?>style/modern_table/style.css" rel="stylesheet" type="text/css" media="screen" />
		
		<!-- Add fancyBox CSS files -->
		<link href="<?php echo base_url()."assets/" ?>fancybox/jquery.fancybox.css?v=2.1.5" rel="stylesheet" type="text/css" media="screen" />
		<link href="<?php echo base_url()."assets/" ?>fancybox/helpers/jquery.fancybox-buttons.css?v=1.0.5" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url()."assets/" ?>fancybox/helpers/jquery.fancybox-thumbs.css?v=1.0.7" rel="stylesheet" type="text/css"/>
		...
		<!-- File Upload -->
		<link href="<?php echo base_url(); ?>assets/jquery-filer-master/css/jquery.filer.css" rel="stylesheet" type="text/css">
		<link href="<?php echo base_url(); ?>assets/jquery-filer-master/css/jquery.filer-dragdropbox-theme.css" rel="stylesheet" type="text/css">
		
		<!-- Chosen -->
		<link href="<?php echo base_url()."assets/" ?>chosen/chosen.css" rel="stylesheet" type="text/css">	
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo base_url(); ?>assets/template/css/jqeasy_custom.css">
		...
		<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDvT11YrjTG32Rc2fUaIx0UMK-DwB7JbHM&sensor=false"></script>
	...
	<body class="desktop-detected smart-style-1">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo" style="font-size:15px;">
					<img src="<?php echo base_url(); ?>assets/template/img/search.png" style="width:30px; height: 30px;" alt="Logo">
...
-->
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="<?php echo base_url(); ?>index.php/login/logout" title="Sign Out" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
					...
					<a id="show-shortcut">
						<img src="<?php echo base_url(); ?>assets/template/img/avatars/user.png" alt="me" class="online" /> 
						<span>
							<?php echo $username;?>
						</span>
			...
			<nav>
				...
				<ul>
					...
					<li>
						<a href="change_pass"><i class="fa fa-lock fa-4x"></i> <span class="menu-item-parent">Change Password</span></a>						
					</li>
					...
					<?php
						...
						if ($username != "") {
							...
							echo GenerateMenuToHTML();
							
					?>
						
						<!-- <li>
							<a href="blog_konten"><i class="fa fa-lg fa-fw fa-desktop"></i> <span class="menu-item-parent">Post</span></a>						
						</li>
						
						<li>
							<a href="blog_kategori"><i class="fa fa-lg fa-fw fa-table"></i> <span class="menu-item-parent">Kategori</span></a>						
						</li>
						
						<li>
							<a href="change_pass"><i class="fa fa-lg fa-fw fa-pencil-square-o"></i> <span class="menu-item-parent">Change Password</span></a>						
						</li> -->
					<?php 
		...
		<script>
			var url = '<?php echo base_url(); ?>assets/template/';
			if (!window.jQuery) {
				document.write('<script src="'+url+'js/libs/jquery-2.0.2.min.js"><\/script>');
			}
		</script>
		...
		<!-- EasyUI JavaScript -->
		<script src="<?php echo base_url()."assets/" ?>easyui/easyloader.js"></script>
		<script src="<?php echo base_url()."assets/" ?>easyui/jquery.easyui.min.js"></script>
		<script src="<?php echo base_url()."assets/" ?>easyui/jquery.easyui.mobile.js"></script>
		<script src="<?php echo base_url()."assets/" ?>easyui/table-helper.js"></script>
		
		<!-- EasyUI Plugin JavaScript -->
		<script src="<?php echo base_url()."assets/" ?>easyui/extension/datagrid-filter.js"></script>
		<script src="<?php echo base_url()."assets/" ?>easyui/extension/datagrid-detailview.js"></script>
		<!-- Upload Filer -->
		<script src="<?php echo base_url()."assets/" ?>jquery-filer-master/js/jquery.filer.js"></script>
