                    ...
                    <div class="box-body">
						...
						<div class="form-group col-md-12">
							<div class="col-sm-5" style="padding-left: 0px;">
								<select id="products" class="form-control" size="8" multiple="multiple">
								</select>
							</div>
							<div class="col-sm-2">
								<button type="button" id="products_rightAll" class="btn btn-block"><i class="glyphicon glyphicon-forward"></i></button>
								<button type="button" id="products_rightSelected" class="btn btn-block"><i class="glyphicon glyphicon-chevron-right"></i></button>
								<button type="button" id="products_leftSelected" class="btn btn-block"><i class="glyphicon glyphicon-chevron-left"></i></button>
								<button type="button" id="products_leftAll" class="btn btn-block"><i class="glyphicon glyphicon-backward"></i></button>
							</div>
							
							<div class="col-sm-5" style="padding-right: 0px;">
								<select id="products_to" class="form-control" size="8" multiple="multiple"></select>
							</div>
						</div>
                    </div>
...
<script src="<?php echo base_url() . 'assets/modules/mapping_objective/mapping-objective-form.js' ?>"></script>
