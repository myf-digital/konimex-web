...
class Sku_active_model extends CI_Model
{
    ...
    {
        $field = "a.*";
        $table = " (select a.*, b.account, count(1) count_product, GROUP_CONCAT(a.productid) group_productid 
                        from mapping_sku_active a left join ref_account_outlet b on a.idaccount=b.idaccount 
                    group by a.idaccount, b.account ) a"
                    ;
