				...
				<div>
					...
					<div class="widget-body">
						...
						<form class="form-inline" role="form">
							<fieldset>
								<?php  echo $area_dropdown."<br><br> ".$search_button; ?>
							</fieldset>
						</form>
...
<script type="text/javascript">
        ...
        tbl.datagrid({
			...
			frozenColumns:[[
				//{field: 'options', title: 'ACTION', width: 300, halign: 'center', align: 'center', formatter: formatButton},
				 //{field: 'no', title: 'No', width: 25, sortable: 'true', halign: 'left', align: 'left'},
			]],	
            columns: [[
                   
                    {field: 'input_text', title: 'Input Example', width: 120, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'startdate', title: 'Input Date', width: 200, sortable: 'true',halign: 'center', align: 'center'},
                    {field: 'email', title: 'E-Mail', width: 200, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'select_box', title: 'Select Box', width: 170, sortable: 'true', halign: 'center', align: 'center'},
                    {field: 'text_area', title: 'Text Area', width: 220, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'area_name', title: 'Area', width: 220, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'region_name', title: 'Region', width: 220, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'branch_name', title: 'Branch', width: 220, sortable: 'true', halign: 'center', align: 'left'},
	...
	function search_data() {
		var get = document.getElementsByName('area')[0].value;
		//alert(get);		
		tbl.datagrid('load',{
			area: get,			
		});
