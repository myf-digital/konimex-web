...
<section class="content-header">
    <h1>
        Report Visit Detailing <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Visit Detailing</a></li>
...
<div class="modal fade" id="modal_survei" tabindex="-1" role="dialog" aria-labelledby="myModalSurvei" aria-hidden="true">
  <div class="modal-dialog" >
    <div class="modal-content" style="overflow-y: auto; width:900px; max-height: 700px;" >
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title" id="myModalSurvei"></h4>
      </div>
      <div class="modal-body" id="show-survei" style="text-align: center;width: 100%;"></div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" >Close</button>      
      </div>
    </div>
...
<!-- JS content -->
<script src="<?php echo base_url() . 'assets/modules/rep_visit_detailing/rep-visit-detailing-content.js' ?>"></script>