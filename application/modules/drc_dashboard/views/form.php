    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                ...
                <button id="btn-slob-form" type="button" class="btn btn-danger fa fa-flash btn-lg"> SLOB</button>
                </nav>
                        ...
                        <table class="filter-date" id="id-tbmp">
                            ...
                            <select class="form-control" name="classid[]" id="classid-id-pa">
							</select>
                            </td><td>
                            ...
                            <button id="btn-download-form-pa" type="button" class="btn btn-primary  fa fa-download btn-lg"> Download</button>
                            </td></tr>
                            </tbody>
                            </table>
                            ...
                            <select class="form-control" name="classid" id="classid-id-sos">
							</select>
                            </td><td>
                            <button id="btn-preview-form-sos" type="button" class="btn btn-success fa fa-search btn-lg"> Search</button>
                            </td><td>
                            <button id="btn-download-form-sos" type="button" class="btn btn-primary  fa fa-download btn-lg"> Download National</button>
                            </td></tr>
                            </tbody>
                            </table>

                            <table class="filter-date-sos" id="id-tbslob">
                            <thead>
                                <tr>
                                    <td>Brand</td>
                                    <td>SKU</td>
                            ...
                            <tbody>
                                <tr><td>
                                <select class="form-control" name="brandid_slob" id="brandid-slob-id"></select>
                                </td><td>
                                <select class="form-control" name="productid_slob" id="productid-slob-id"></select>
                                </td><td>
                                <button id="btn-preview-form-slob" type="button" class="btn btn-success fa fa-search btn-lg"> Search</button>
                                </td></tr>
                            </tbody>
                            </table>
