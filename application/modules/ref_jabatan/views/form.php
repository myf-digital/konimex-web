...
<section class="content-header">
    <h1>
        Jabatan <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
            ...
            <div class="box box-success">
                ...
                <form id="fm-jabatan" role="form" method="post">
                    <div class="box-body">
							...
							<div class="form-group">
								<label for="restrict_bu">Business Unit</label>
                                <select id="restrict_bu-id" name="restrict_bu" class="form-control" placeholder="Business Unit"></select>
							</div>
                    </div>
...
<script src="<?php echo base_url() . 'assets/modules/ref_jabatan/jabatan-form.js' ?>"></script>
