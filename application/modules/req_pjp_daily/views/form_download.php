...
<div id="alertnotif" class="alert warning" style="display:none;">
  ...
  <strong></strong> Salesman harus di isi...
</div>
...
<section class="content-header">
  <h1>
      Download Request PJP Daily <small>Control panel</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Download Request PJP Daily</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Download Request PJP Daily</h3>
                </div>
...
<script src="<?php echo base_url() . 'assets/modules/req_pjp_daily/req-pjp-daily-form-download.js' ?>"></script>
