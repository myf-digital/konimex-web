...
class Customer_model extends CI_Model
{
    ...
    public function delete($data)
    {
        ...
        $this->db->query("delete from t_sales_rrk where customerid='".$data['customerid']."' and salesmanid='".$data['salesmanid']."' and periode=(select tanggal from m_setup_site);");
    ...
    public function load($data)
    {
        ...
        $table = " (select a.*, b.nama_regional, c.nama_area, d.nama_area as nama_subarea, e.nama_class as nama_account, 
                                    (select GROUP_CONCAT(salesmanid SEPARATOR ',') from m_customer_ob where customerid=a.customerid) AS usergff,
                                    (select GROUP_CONCAT(nama_salesman SEPARATOR ',') from m_sales_salesman where salesmanid in (select salesmanid from m_customer_ob where customerid=a.customerid)) as nama_gff,
                                    f.tipe_sales position
