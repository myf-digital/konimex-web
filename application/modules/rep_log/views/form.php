...
<section class="content-header">
    <h1>
        History Login <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> History Login</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Report History Login</h3>
                </div>

                <form id="fm-report-log" role="form" method="post">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div id="tbl-content" class="box-table box-primary" style="margin:10px; overflow: auto; max-height: 100%; max-width: 99%; white-space: nowrap;">
                            </div>
                        </div>
                    </div>
                </form>
...
<script src="<?php echo base_url() . 'assets/modules/rep_log/rep-log-form.js' ?>"></script>
