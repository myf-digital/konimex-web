...
<section class="content-header">
    <h1>
        SOS <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> SOS</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Report SOS</h3>
                </div>
...
<script src="<?php echo base_url() . 'assets/modules/rep_sos/rep-sos-form.js' ?>"></script>
