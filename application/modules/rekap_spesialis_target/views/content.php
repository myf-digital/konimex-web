<section class="content-header">
    <h1>Rekap Spesialis Target</h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Rekap Spesialis Target</li>
    </ol>
</section>
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select id="spesialisasi_ids" class="form-control select2" multiple="multiple" data-placeholder="Spesialisasi (Semua)">
                        </select>
                    </div>
            ...
            <div class="box box-primary">
                <div class="box-body table-responsive">
                    <table id="tbl-summary" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" class="text-center">Silakan klik Load Data.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<script src="<?php echo base_url() . 'assets/modules/rekap_spesialis_target/rekap-spesialis-target.js' ?>"></script>
