...
<section class="content-header">
    <h1>
        Switch FJP <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Switch FJP</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Switch FJP</h3>
                </div>

                <form id="fm-add-switch-pjp" role="form" method="post">
                    <div class="box-body">
							...
							<div class="form-group col-xs-12 col-sm-12 col-md-6">
								<label for="salesmanid">From TPE</label>
                                <select id="salesmanid-id-from" name="salesmanid_from" class="form-control" placeholder="Select TPE"></select>
							</div>
							<div class="form-group col-xs-12 col-sm-12 col-md-6">
								<label for="salesmanid">To TPE</label>
                                <select id="salesmanid-id-to" name="salesmanid_to" class="form-control" placeholder="Select TPE"></select>
							</div>
							<!--<div class="form-group col-xs-12 col-sm-12 col-md-6">
...
<script src="<?php echo base_url() . 'assets/modules/conf_setup_pjp/setup-pjp-form-switch.js' ?>"></script>
