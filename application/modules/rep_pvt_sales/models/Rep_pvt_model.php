<?php 
class Rep_pvt_model extends CI_Model { 
...
left join
 ...
 group by y.salesmanid,y.nama_salesman	
	...
	/*function get_list_data() {
		...
		//query data
		$this->db->select("DATE_FORMAT(periode, '%d-%m-%Y') periode,salesmanid,nama_salesman,target,sales,FORMAT(percent,1) percent,ob,oa,oavsob,ec,ecvsoa,salesvsec");	
		$this->db->from("t_productivity");	
		if ($sales != "") {
