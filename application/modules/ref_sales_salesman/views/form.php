        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form User PAR-MA</h3>
                </div>
                ...
                <form id="fm-sales-salesman" role="form" method="post">
                    <div class="box-body">
							...
							<div class="form-group col-md-3">
								...
								<input name="salesmanid" id="salesmanid-id" class="form-control" value="" placeholder="User PAR-MA">
							</div>
							<div class="form-group col-md-3">
							...
							<div class="form-group col-md-7">
								<label for="nama_salesman">Nama User PAR-MA</label>
								<input name="nama_salesman" class="form-control" placeholder="Nama User PAR-MA">
							</div>
							<!--<div class="form-group col-md-3">
							...
							<div class="form-group  col-md-3">
								<label for="tipe_sales">Tipe User PAR-MA</label>
                                <select id="tipe_sales-id" name="tipe_sales" class="form-control" placeholder="PAR-MA Type"></select>
							</div>
