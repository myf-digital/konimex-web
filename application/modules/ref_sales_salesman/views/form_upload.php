...
<section class="content-header">
    <h1>
        Upload MEDREP <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Upload MEDREP</a></li>
        <li class="active">Form Upload MEDREP</li>
    </ol>
</section>
...
<script>
    ...
    function initialize() {
        uiBtnUpload.click(function (e) {
            e.preventDefault();
            let url = common.baseURL("ref_sales_salesman/upload");
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire(
                        ...
                        window.location.href = common.baseURL("ref_sales_salesman");
                    });
                },
        ...
        uiBtnDownloadTemp.click(function () {
            window.location.href = common.baseURL("ref_sales_salesman/download_template");
        });
    }
</script>
