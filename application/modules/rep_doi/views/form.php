...
<section class="content-header">
    <h1>
        DOI <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> DOI</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Report DOI</h3>
                </div>
...
<script src="<?php echo base_url() . 'assets/modules/rep_doi/rep-doi-form.js' ?>"></script>
