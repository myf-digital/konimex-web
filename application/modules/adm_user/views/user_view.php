...
<script>
    ...
    $(document).ready(function () {
        ...
        tbl.datagrid({
            ...
            columns: [[
                    {field: 'username', title: 'Username', width: 200, sortable: 'true', halign: 'center', align: 'center'},
                    {field: 'user_status', title: 'Role Status', width: 100, sortable: 'true', halign: 'center', align: 'center', formatter:formatStatus},
	...
	//load edit view	
	function edit_view(userid) {
		window.location.href = "<?php echo '#'.$controller.'/form/'; ?>"+userid;
	}
