...
<section class="content-header">
    <h1>
        Dokumentasi <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Dokumentasi</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Dokumentasi</h3>
                </div>

                <form id="fm-dokumentasi" role="form" method="post">
                    ...
                    <div class="box-footer">
                        ...
                        <button id="btn-download-form-oos" type="button" class="btn btn-primary fa fa-download">  Download Foto OOS</button>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
...
<script src="<?php echo base_url() . 'assets/modules/rep_dokumentasi/rep-dokumentasi-form.js' ?>"></script>
