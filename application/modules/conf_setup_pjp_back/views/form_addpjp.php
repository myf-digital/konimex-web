                ...
                <form id="fm-add-setup-pjp" role="form" method="post">
                    <div class="box-body">
							...
							<div class="form-group col-xs-12 col-sm-12 col-md-6">
                                ...
                                <select id="salesmanid-id" name="salesmanid" class="form-control" placeholder="TPE (MD/SPG/MEDREP)"></select>
							</div>
							<div class="form-group col-xs-12 col-sm-12 col-md-6">
								<label for="customerid">Outlet</label>
                                <select id="customerid-id" name="customerid[]" class="form-control" placeholder="Select Outlet"></select>
							</div>
							<!--<div class="form-group col-xs-12 col-sm-12 col-md-6">
