    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                ...
                <form id="fm-upload-setup-pjp" role="form" method="post">
                    <div class="box-body">
							...
							<div class="form-group col-xs-12 col-sm-12 col-md-6">
                                ...
                                <input type="file" class="form-control-file" id="fileuploadxls" onchange="return validasiFile()" >
                    ...
                    <div class="box-footer">
                        ...
                        <button id="btn-upload-form" type="button" class="btn btn-primary fa fa-upload">  Upload</button>
                    </div>
                </form>
...
function validasiFile(){
        var inputFile = document.getElementById('fileuploadxls');
        let uiAlertNotif = document.getElementById('alertnotif');
...
<script src="<?php echo base_url() . 'assets/modules/conf_setup_pjp/setup-pjp-form-upload.js' ?>"></script>
