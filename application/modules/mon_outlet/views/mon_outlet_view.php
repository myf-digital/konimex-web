			...
			<div class="jarviswidget" id="dash_map" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
							...
							<div id="filter">
								Segment : 	<label class="select">
												<select name="segmentid" class="chosen-select">
													<option value="">--Select--</option>
													".<?php echo $segment_options; ?>."
												</select>
											</label>
								Class : <label class="select">
												<select name="classid" class="chosen-select">
													<option value="">--Select--</option>
													".<?php echo $class_options; ?>."
												</select>
											</label>	
								Type : <label class="select">
												<select name="typeid" class="chosen-select">
													<option value="">--Select--</option>
													".<?php echo $type_options; ?>."
												</select>
											</label>	
								
								<a href="javascript:void(0)"  class="btn btn-primary" onclick="search_data();" ><i class="fa">view</i></a>	
							</div>	
...
<script>
	...
	function search_data() {
		var getsegment = document.getElementsByName('segmentid')[0].value;
		var getclassid = document.getElementsByName('classid')[0].value;
		var gettypeid = document.getElementsByName('typeid')[0].value;
		$.ajax({
			type:"POST",
			dataType: "html",
			beforeSend : function() {
			...
			data : "segmentid="+getsegment+"&classid="+getclassid+"&typeid="+gettypeid,
