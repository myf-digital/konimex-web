...
class Api_v1_model extends CI_Model
{
	...
	function get_tipesalesman()
    {
		$sql = " select 'MERCHANDISER' as idtipesales, 'MERCHANDISER' as tipesales
				...
				union
				select 'SALESMAN MT' as idtipesales, 'SALESMAN MT' as tipesales
				union
				select 'SALESMAN GT' as idtipesales, 'SALESMAN GT' as tipesales
				union
    ...
    {
		$sql = " replace into t_stock_all_outlet (salesmanid,customerid,productid,qty_akhir,qty_ed,exp_date,price,update_by,last_update)
					select salesmanid, customerid, productid, qty_akhir, total_qty_exp, exp_date, price,modified_by,periode from t_sales_crc where  date_update is not null
