...
<section class="content-header">
    <h1>
      Report Product Knowledge <small>Reporting</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="ModalLabel">List Product Knowledge</h4>
                </div>
                <div class="modal-body">

                        <div id="tbl-listanswer" class="box-table">
                        </div>
...
-->
<!-- JS content -->
<script src="<?php echo base_url() . 'assets/modules/rep_product_knowledge/rep-product-knowledge-content.js' ?>"></script>
