...
class Professional_model extends CI_Model
{
    ...
    public function quick_create($data)
    {
        ...
        $this->db->insert('ref_professional', [
            ...
            'type' => $data['type'] ?? null,
            'tanggal_lahir' => !empty($data['tanggal_lahir']) ? ($data['tanggal_lahir'] == '0000-00-00' ? null : $data['tanggal_lahir']) : null,
            'tanggal_aniv_pernikahan' => !empty($data['tanggal_aniv_pernikahan']) ? ($data['tanggal_aniv_pernikahan'] == '0000-00-00' ? null : $data['tanggal_aniv_pernikahan']) : null,
