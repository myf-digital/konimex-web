...
<script>
    ...
    $(document).ready(function () {
        ...
        tbl.datagrid({
            ...
            columns: [[
                    {field: 'menu_name', title: 'Menu Name', width: 200, sortable: 'true', halign: 'center', align: 'left'},
                    {field: 'menu_icon', title: 'ICON', width: 70, halign: 'center', align: 'center', formatter: formatIcon},
                    {field: 'module_name', title: 'Module URL', width: 170, sortable: 'true', halign: 'center', align: 'center'},
                    {field: 'type_menu', title: 'Type Menu', width: 170, sortable: 'true', halign: 'center', align: 'center', formatter: formatType},
	...
	//load edit view	
	function edit_view(menu_id) {
		window.location.href = "<?php echo '#'.$controller.'/form/'; ?>"+menu_id;
	}
	...
	function formatIcon(val, row, index) {
		...
		var textIcon = row.menu_icon;
		return '<i class="fa fa-lg fa-fw '+textIcon+'"></i>';
