...
class Set_quota_budget_model extends CI_Model
{
	...
	function get_city() {
		$q = $this->db->query("
        select (select nama_regional from m_area_regional where regionalid=a.regionalid) as nama_regional,
                (select nama_area from m_area_areasite where areaid=a.areaid) as nama_area, a.subareaid, a.nama_area city, b.periode, 
                ifnull(b.md,0) md, ifnull(b.spg,0) spg, ifnull(b.sfmt,0) sfmt, ifnull(b.sfgt,0) sfgt, ifnull(b.fc,0) fc 
        ...
        order by nama_regional, nama_area, a.nama_area asc");
		return $q->result_array();
	}
