...
<section class="content-header">
    <h1>
        Upload Stock Product <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Upload Stock Product</a></li>
        <li class="active">Form Upload Stock Product</li>
    </ol>
</section>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Upload Stock Product</h3>
                </div>
                <form id="fm-upload-stock-product" role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="form-group col-xs-12 col-sm-12 col-md-6">
                            <label for="salesmanid">File Upload Stock Product</label>
...
<script>
    ...
    common.setTitle("Upload Stock Product");
    let uiForm = $("#fm-upload-stock-product");
    ...
    function initialize() {
        uiBtnUpload.click(function (e) {
            e.preventDefault();
            let url = common.baseURL("stock_product/upload");
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    Swal.fire(
                        ...
                        window.location.href = common.baseURL("stock_product");
                    });
                },
        ...
        uiBtnCancel.click(function () {
            common.direct("stock_product");
        });

        uiBtnDownloadTemp.click(function () {
            window.location.href = common.baseURL("stock_product/download_template");
        });
    }
</script>
