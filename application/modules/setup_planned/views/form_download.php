...
<section class="content-header">
    <h1>
        Download Planned <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Download Planned</a></li>
        <li class="active">Form Download Planned</li>
    </ol>
</section>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Download Planned</h3>
                </div>

                <form id="fm-download-setup-planned" role="form" method="post">
                    <div class="box-body">
