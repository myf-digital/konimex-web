...
<section class="content-header">
    <h1>
        Upload Planned <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Setup Planned</a></li>
        <li class="active">Form Upload Planned</li>
    </ol>
</section>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Upload Planned</h3>
                </div>

                <form id="fm-upload-setup-planned" role="form" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-8 col-md-6">
                                <label for="salesmanid-id">Pilih PS (Untuk Download Template)</label>
                                <select id="salesmanid-id" name="salesmanid" class="form-control" placeholder="Pilih PS"></select>
                                <small class="text-muted">Pilih PS untuk mengunduh template yang sudah terisi data outlet binaan.</small>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                                <label for="fileupload">File Upload Planned (Excel)</label>
                                <input type="file" name="fileupload" id="fileupload" class="form-control" accept=".xls,.xlsx" onchange="return validasiFile()">
                                <small class="text-muted">*Format file harus .xls atau .xlsx dengan ukuran maksimal 10 MB. Kolom tanggal berformat YYYY-MM-DD atau DD/MM/YYYY.</small>
                            </div>
                        </div>
                    </div>
...
<script src="<?php echo base_url() . 'assets/modules/setup_planned/form-upload.js' ?>?v=1.0"></script>