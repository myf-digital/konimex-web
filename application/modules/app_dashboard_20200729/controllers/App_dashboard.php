	...
	function open_detail() {
		...
		*/
		...
		foreach ($data as $value) {
			$flag = $value['flag'];
			if ($flag == 'Call') {
				$icon = base_url().'assets/mapIcon/numbers/png/delivery.png';
			} else if ($flag == 'ExtraCall') {
				$icon = base_url().'assets/mapIcon/res/drawable-hdpi/ext_call_20.png';
			} else if ($flag == 'Jadwal') {
			...
			$html .='<table class="table table-striped table-bordered table-condensed" style="width:700px;">
						<thead>
							...
							<tr>
								...
								<td class="info" style="text-align:left;padding-left:10px;">'.@$d_rrk->keterangan.'</td>
							</tr>
						</tbody>
					</table>';
							...
							\'<table class="table table-striped table-bordered table-condensed" style="white-space: nowrap;">\'+
								...
								\'<tbody>\'+
									\'<tr>\'+
										...
										\'<td class="info" style="text-align:left;">'.$d_rrk->keterangan.'</td>\'+	
									\'</tr>\'+
								\'</tbody>\'+
							\'</table>\'+
							\'<hr>\'+
