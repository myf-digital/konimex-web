...
<section class="content-header">
    <h1>
        Competitor <small>Control panel</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Competitor</a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Report Competitor</h3>
                </div>
                ...
                <form id="fm-report_promo" role="form" method="post">
                    ...
                    <div class="box-footer">
                        ...
                        <button id="btn-download-form" type="button" class="btn btn-primary fa fa-download">  Download Foto</button>
                        <button id="btn-download-text-form" type="button" class="btn btn-primary fa fa-download">  Download Text</button>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
...
<script src="<?php echo base_url() . 'assets/modules/rep_competitor/rep-competitor-form.js' ?>"></script>
