(function () {
    ...
    */
    ...
    function toolbar() {
        ...
        //return '<div class="action-grid-toolbar">' + btnCreate + btnDownload + btnSwitch + '</div>'; //+ btnUpload
        return '<div class="action-grid-toolbar">' + btnCreate + btnDownload + '</div>'; //+ btnUpload
    }
