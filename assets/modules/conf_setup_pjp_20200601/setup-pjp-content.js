(function () {
    ...
    */
    ...
    function initializeGrid() {
        let option = {
            ...
            columns: [[
				...
				{field:'nama_salesman', title:'NAMA PAR-MA', halign: 'center', align: 'left', sortable:"true", width:200},
				...
				//{field:'alamat', title:'ADDRESS', halign: 'center', align: 'left', sortable:"true", width:200},
				//{field:'group_account', title:'GROUP ACCOUNT', halign: 'center', align: 'left', sortable:"true", width:200},
				//{field:'outlet_type', title:'TYPE', halign: 'center', align: 'left', sortable:"true", width:200},
    ...
    function toolbar() {
        ...
        //return '<div class="action-grid-toolbar">' + btnCreate + btnDownload + btnSwitch + btnUpload  + '</div>'; //+ btnUpload
        return '<div class="action-grid-toolbar">' + btnCreate + btnDownload + btnUpload  + '</div>'; //+ btnUpload
    }
