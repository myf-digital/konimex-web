(function () {
    ...
    // ui components
    let uiTbl = $("#tbl-product-competitor");
    ...
    */
    function initialize() {
        $("#btn-create").click(function () {
            common.removeCookie("module.product.competitor.update");
            common.direct("ref_product_competitor/form");
        });
    }

    function initializeGrid() {
        let option = {
            title: "Product Competitor",
            toolbar: toolbar(),
            url: common.baseURL("ref_product_competitor/load"),
            pageNumber: 1,
            ...
            columns: [[
				{field:'nama_invoice', title:'PRODUK COMPETITOR', halign: 'left', align: 'left', sortable:"true", width:200},
				{field:'category', title:'KATEGORI', halign: 'left', align: 'left', sortable:"true", width:200},
				{field:'status_desc', title:'STATUS', halign: 'left', align: 'left', sortable:"true", width:200},
    ...
    */
    ...
    function updateRow(val) {
        common.setCookie("module.product.competitor.update", val);
        common.direct("ref_product_competitor/form");
    }

    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("ref_product_competitor/delete", val, function (data, status) {
                if (200 === data.code) {
