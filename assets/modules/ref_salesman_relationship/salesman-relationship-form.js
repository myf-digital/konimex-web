(function () {
    ...
    function initialize() {
        let url = param === undefined ? common.baseURL("ref_salesman_relationship/create") : common.baseURL("ref_salesman_relationship/update");
        uiForm.initForm({
            url: url,
            param: param,
            ...
            messages: {
				salesmanid: {
					required: 'Salesman wajib dipilih', 
                },
				relationship: {
    ...
    function loadParamGlobal() {
        common.loading();
        $.post(common.baseURL("api_v1/call_param_key"), {
