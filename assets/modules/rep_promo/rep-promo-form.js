(function () {
    ...
    function initializeParam() {
        ...
        uiSelectAccount.on('select2:select', function (e) {
            ...
            paramdata = {classid:uiSelectAccount.val(), tipepromo:uiSelectTipepromo.val(), start:start, end:end};
            loadPromo(paramdata);
        });
    ...
    function loadPromo(data) {
        ...
        $.post(common.baseURL("rep_promo/load_promo"), {classid: data.classid, tipepromo: data.tipepromo, start:data.start, end:data.end}, function (res) {
            uiSelectPromo.empty();
    ...
    function loadCity(data) {
        common.loading();
        //alert(data.idaccount);
        $.post(common.baseURL("rep_promo/load_city"), {regionalid: data.regionalid}, function (res) {
            uiSelectCity.empty();
