    ...
    function initializeGrid() {
      let option = {
		  ...
		  columns: [[
            ...
            {field: 'salesmanid', title: 'TPE', width:30, sortable: 'true', halign: 'left', align: 'left'},
            {field: 'nama_salesman', title: 'TPE Name', width:30, sortable: 'true', halign: 'left', align: 'left'},
    ...
    function setupFormUI() {          
        ...
        uiBtnDownload.click(function () {
          if ( uiTanggalPicker1.val() == null){
            ...
            common.direct("rep_join_visit/savexls_join_visit_all/"+usersession+"/"+restrict_level+"/"+start_date+"/"+end_date);
          }
        });
    }
  ...
  function optionButton(data) {
	...
	*/
	...
	function loadEvent() {
	  ...
	  $.post(common.baseURL("rep_join_visit/load_event"), {}, function (res) {
		  uiSelectEvent.empty();
    ...
    function viewAnswer(val) {
        ...
        $.ajax({
            ...
            url: common.baseURL("rep_join_visit/open_detail_answer"),
            data : "id_evaluation="+val.id_evaluation,
            success:function(res){
                response = res;
				$('div .modal-header .modal-title').text('Detail Review');			
