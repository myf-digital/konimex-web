(function () {
    ...
    common.setTitle("Download Request PJP Weekly");
    // declare dom
    let uiForm = $("#fm-download-req-pjp-weekly");
    ...
    function initialize() {
        ...
        uiBtnDownload.click(function () {
            common.direct("req_pjp_weekly/savetoxlsx/"+uiSelectSalesman.val()+"/"+paramsession.username+"/"+paramsession.restrict_level);
        });
