    ...
    */
    ...
    function initializeGrid() {
        let option = {
            title: "Config",
            toolbar: toolbar(),
            url: common.baseURL("ref_config/load"),
            pageNumber: 1,
            ...
            columns: [[
				...
				{field:'key_conf', title:'KEY CONF', halign: 'center', align: 'left', sortable:"true", width:200},
				{field:'value', title:'VALUE', halign: 'center', align: 'left', sortable:"true", width:200},
    ...
    */
    ...
    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("ref_config/delete", val, function (data, status) {
                if (200 === data.code) {
