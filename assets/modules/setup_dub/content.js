(function () {
        ...
        if (res.code === 200) {
          ...
          if (details.length === 0) {
            ...
            Object.keys(grouped).forEach(function (key) {
              ...
              body.append(`
                <tr>
                  <td style="padding: 10px; vertical-align: top; font-weight: bold; width: 50%;">${outletCell}</td>
                  <td style="padding: 10px; vertical-align: top; width: 50%;">${usersCell}</td>
                </tr>
              `);
            });
          }
          ...
          footer.empty();
          footer.append('<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>');
  ...
  function handleApproveReject(reqNo, targetStatus) {
    ...
    let inputPlaceholder = targetStatus == 3 ? "Alasan persetujuan (opsional)" : "Alasan penolakan (wajib)";
