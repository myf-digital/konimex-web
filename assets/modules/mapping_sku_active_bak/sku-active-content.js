(function () {
    ...
    */
    function initialize() {
        $("#btn-create").click(function () {
            common.removeCookie("module.sku.active.update");
            common.direct("mapping_sku_active/form");
        });
    }
    ...
    function initializeGrid() {
        let option = {
            title: "Sku Active",
            toolbar: toolbar(),
            url: common.baseURL("mapping_sku_active/load"),
            pageNumber: 1,
            ...
            columns: [[
				...
				{field:'account', title:'ACCOUNT', halign: 'center', align: 'center', sortable:"true", width:200},
				{field:'count_product', title:'JUMLAH PRODUCT', halign: 'center', align: 'center', sortable:"true", width:200},
            ]],
    ...
    */
    ...
    function updateRow(val) {
        common.setCookie("module.sku.active.update", val);
        common.direct("mapping_sku_active/form");
    }

    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("mapping_sku_active/delete", val, function (data, status) {
                if (200 === data.code) {
