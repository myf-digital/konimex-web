(function () {
    ...
    function initializeGrid() {
      let option = {
          ...
          columns: [[
            {field: 'salesmanid', title: 'Kode PAR-MA', width: 100, sortable: 'true', halign: 'left', align: 'left'},
            {field: 'nama_salesman', title: 'Nama PAR-MA', width: 150, sortable: 'true', halign: 'left', align: 'left'},
            ...
            {field: '_extra_call', title: '<img class="color" src="'+baseurl+'/assets/mapIcon/res/drawable-hdpi/ext_call_20.png"></img> Extra Call', width: 75, sortable: 'true', halign: 'center', align: 'center'},
