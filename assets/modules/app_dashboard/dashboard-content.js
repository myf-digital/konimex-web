(function () {
        ...
        [
          ...
          },
          {
            ...
            title:
              '<img class="color" src="' +
              baseurl +
              '/assets/images/ic_call.png"></img> Call',
            width: 70,
            sortable: "true",
            halign: "center",
            align: "center",
          },
          {
            ...
            title:
              '<img class="color" src="' +
              baseurl +
              '/assets/images/ic_extra_call.png"></img> Extra Call',
            width: 70,
            sortable: "true",
            halign: "center",
            align: "center",
  ...
  function toolbar() {
    const btnSearch = commonGrid.btnBuilder(
      "btn-search",
      "success",
      "fa fa-search",
    );
    return (
      '<div class="action-grid-toolbar"> &nbsp;&nbsp;&nbsp; Periode : &nbsp; <input type="text" id="get_date" value="' +
      today +
      '" name="get_date">' +
      btnSearch +
      "</div>"
  ...
  function formatterButton(val, row, index) {
    const btnMap = commonGrid.btnBuilderDash(
      "btn-maps",
      "default",
      "../assets/images/ic_route.png",
    );
    const btnTracking = commonGrid.btnBuilderDash(
      "btn-tracking",
      "info",
      "../assets/images/ic_location.png",
    );
    const btnReport = commonGrid.btnBuilderDash(
      "btn-report",
      "success",
