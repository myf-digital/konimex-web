(function () {
    ...
    */
    function initialize() {
        $("#btn-create").click(function () {
            common.removeCookie("module.area.regional.update");
            common.direct("ref_area_regional/form");
        });
    }
    ...
    function initializeGrid() {
        let option = {
            title: "Area Regional",
            toolbar: toolbar(),
            url: common.baseURL("ref_area_regional/load"),
            pageNumber: 1,
            ...
            columns: [[
				...
				{field:'nama_regional', title:'Regional Name', halign: 'left', align: 'left', sortable:"true", width:200},
    ...
    */
    ...
    function updateRow(val) {
        common.setCookie("module.area.regional.update", val);
        common.direct("ref_area_regional/form");
    }

    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("ref_area_regional/delete", val, function (data, status) {
                if (200 === data.code) {
