(function () {
    ...
    common.setTitle("Tracking Product");
    // declare dom
    ...
    function initializeParam() {
        ...
        $.when(
            ...
            $.post(common.baseURL("tracking_product/load_regional"), filter.build()),
    ...
    function open_preview() {
        ...
        $.ajax({
            ...
            url: common.baseURL("tracking_product/open_detail"),
    ...
    function loadArea(data) {
        common.loading();
        $.post(common.baseURL("tracking_product/load_city"), {regionalid: data.regionalid}, function (res) {
            uiSelectCity.empty();
            uiSelectCity.select2({
                placeholder: "Select City",
                allowClear: true,
    ...
    function save_xls() {
        ...
        common.direct("tracking_product/savetoxlsx/"+year+"/"+month+"/"+brand+"/"+sku+"/"+regionalid+"/"+areaid+"/"+usersession+"/"+restrict_level+"/"+idjabatan);
    }
