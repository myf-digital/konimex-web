    ...
    */
    ...
    function initializeGrid() {
        let option = {
            ...
            toolbar: toolbar(),
            url: common.baseURL("stock_product/load_history"),
            pageNumber: 1,
    ...
    function toolbar() {
        const btnBack = commonGrid.btnBuilderText('btn-back', 'warning', 'fa fa-backward', ' Kembali ke Stock Product');
    ...
    function optionButton(data) {
        ...
        for (const btns of btnContent) {
            ...
            btnDetail.click(function () {
                common.direct("stock_product/history_upload_detail?id=" + param.id);
            });
            index++;
        }
    }
