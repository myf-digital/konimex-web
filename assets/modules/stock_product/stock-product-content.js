    ...
    */
    ...
    function initializeGrid() {
        let option = {
            ...
            columns: [[
				{field:'kode_product_principal', title:'KODE PRODUK', halign: 'center', align: 'left', sortable:"true", width:100},
				{field:'nama_product', title:'NAMA PRODUK', halign: 'center', align: 'left', sortable:"true", width:200},
				{field:'nama_cabang', title:'KODE CABANG', halign: 'center', align: 'left', sortable:"true", width:100},
