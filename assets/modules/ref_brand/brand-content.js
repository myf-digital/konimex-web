(function () {
    ...
    */
    function initialize() {
        $("#btn-create").click(function () {
            common.removeCookie("module.brand.update");
            common.direct("ref_brand/form");
        });
    }
    ...
    function initializeGrid() {
        let option = {
            title: "Brand",
            toolbar: toolbar(),
            url: common.baseURL("ref_brand/load"),
            pageNumber: 1,
            ...
            columns: [[
				{field:'brandid', title:'BRANDID', halign: 'center', align: 'left', sortable:"true", width:200},
				{field:'brand', title:'BRAND', halign: 'center', align: 'left', sortable:"true", width:200},
    ...
    */
    ...
    function updateRow(val) {
        common.setCookie("module.brand.update", val);
        common.direct("ref_brand/form");
    }

    function deleteRow(val) {
        common.dialogDelete(function () {
            $.post("ref_brand/delete", val, function (data, status) {
                if (200 === data.code) {
