    ...
    function initializeGrid() {
      let option = {
          ...
          columns: [[
            ...
            {field: '_call', title: '<img class="color" src="'+baseurl+'/assets/mapIcon/numbers/png/delivery.png"></img> Call', width: 70, sortable: 'true', halign: 'center', align: 'center'},
            {field: '_extra_call', title: '<img class="color" src="'+baseurl+'/assets/mapIcon/res/drawable-hdpi/ext_call_20.png"></img> Extra Call', width: 70, sortable: 'true', halign: 'center', align: 'center'},
