            ...
            (t.innerHTML = `
                    ...
                    <div data-boc-right>
                        <div data-boc-content>
                            ${OrgChart.ui.css() + OrgChart.ui.svg(`100%`, `100%`, [0, 0, 0, 0], { template: `ana`, mode: `light` }, OrgChart.ui.defs(``) + `<text  y="-9999999" x="-9999999" data-hidden-measure></text>`)}
                        </div>
                    </div>`));
      },
    }),
...
((OrgChart.prototype.init = function (t, n) {
  if (t && !this._initCalled) {
    ...
    var r = this;
    if (
      (OrgChart._reorderNodeBinding(n),
      (this.config = OrgChart.mergeDeep(OrgChart._defaultConfig(n), n)),
      this.config.mouseScrool &&
        (this.config.mouseScroll = this.config.mouseScrool),
      (this._layoutConfigs = {
        base: {
    ...
    ((this._event_id = OrgChart._guid()),
      OrgChart._validateConfig(this.config) &&
        ...
        OrgChart._intersectionObserver(this.element, function (t) {
          ((r.isVisible = t),
            OrgChart.events.publish(`visibility-change`, [r]) !== !1 &&
  ...
  (OrgChart.prototype.load = function (t, n) {
    var r = this;
    return (
      (this.config.nodes = t),
  ...
  (OrgChart.prototype.loadXML = function (t, n) {
  ...
  (OrgChart.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.prototype.removeListener = function (t, n) {
    return OrgChart.events.remove(t, n, this._event_id);
  }),
  (OrgChart.prototype.draw = function (t, n, r) {
    ((t ??= OrgChart.action.update), this._draw(!1, t, n, r));
  }),
  (OrgChart.prototype._draw = function (t, n, r, i) {
    var a = this;
    if (!(OrgChart.LAZY_LOADING && !this.isVisible)) {
      ...
      var o = n == OrgChart.action.init ? null : this.getViewBox();
      this.manager.read(
        t,
        this.width(),
        this.height(),
        ...
        function (t) {
          if (!a.notifierUI.show(t.notif)) {
            ...
            for (var f = 0; f < t.visibleNodeIds.length; f++) {
              ...
              if (
                ...
                var {
                  ...
                  thumbPosition: S,
                  scrollBarDisplay: C,
                } = OrgChart._treeListGetTumbPositionFromScrollTop(p);
                s += `</g>

                
                <rect style="display: ${C}" data-treelist-scroll="${p.id}"  class="boc-scroll" x="${p.x + p.w - p.padding[1] - OrgChart.TREELIST_SCROLLBAR_WIDTH}" y="${p.y + p.padding[0]}" width="${OrgChart.TREELIST_SCROLLBAR_WIDTH}" height="${p.h - p.padding[2] - p.padding[0]}"></rect>
                <rect style="display: ${C}" data-treelist-thumb="${p.id}" class="boc-scroll-thumb" x="${p.x + p.w - p.padding[1] - OrgChart.TREELIST_SCROLLBAR_WIDTH}" y="${S}" width="${OrgChart.TREELIST_SCROLLBAR_WIDTH}" height="${x}"></rect>
            ...
            var o = { content: s, res: t };
            if (
              (OrgChart.events.publish(`render`, [a, o]),
              (s = o.content),
              (t = o.res),
              (s += a.ui.lonely(a.config)),
              n === OrgChart.action.exporting)
            ) {
              var w = t.boundary,
                T = w.maxX - w.minX,
                E = w.maxY - w.minY,
                D = a.ui.svg(T, E, [w.minX, w.minY, T, E], a.config, s, c);
              i.call(a, D, t);
              return;
            }
            ((n === OrgChart.action.centernode ||
              ...
              (u = l),
              n === OrgChart.action.init && l != null && (u = l),
              n === OrgChart.action.centerNode && l != null && (u = l),
              (a.response = t),
              (a._lastSize = { width: a.width(), height: a.height() }),
            ...
            if (!a._initialized)
              ((a.element.innerHTML =
                ...
                a.aiUI.init(a),
                a.orgScribeUI.init(a),
                a.powerPointPreviewUI.init(a),
                a.pdfPreviewUI.init(a),
                a.svgPreviewUI.init(a),
                a.pngPreviewUI.init(a),
              ...
              var O = a.getSvg(),
                k = O.parentNode;
              (k.removeChild(O),
                k.insertAdjacentHTML(`afterbegin`, D),
                a._attachEventHandlers(),
                a.xScrollUI.addListener(a.getSvg()),
                a.yScrollUI.addListener(a.getSvg()),
                a.xScrollUI.setPosition(),
            ...
            var A = !1,
              j = a.response.animations;
            if (j[0].length > 0) {
              a._hideBeforeAnimation(j[0].length);
              for (var f = 0; f < j[0].length; f++)
                j[0][f] = a.getNodeElement(j[0][f]);
              OrgChart.animate(
                j[0],
                j[1],
                j[2],
            ...
            (n === OrgChart.action.centerNode
              ...
              : l &&
                  a.response &&
                  (l[0] != a.response.viewBox[0] ||
                    l[1] != a.response.viewBox[1] ||
                    l[2] != a.response.viewBox[2] ||
                    l[3] != a.response.viewBox[3]) &&
                  (n === OrgChart.action.insert ||
                    n === OrgChart.action.expand ||
                    n === OrgChart.action.collapse ||
                    n === OrgChart.action.update ||
                ...
                ? a._loaded
                  ...
                  : (a.setViewBox(a.response.viewBox),
                    OrgChart.events.publish(`redraw`, [a]))
                : j[0].length == 0 &&
                  (A ||=
                    (i && i.call(a),
  ...
  (OrgChart.prototype.setViewBox = function (e) {
  ...
  (OrgChart.prototype.ripple = function (t, n, r) {
    ...
    if (i != null) {
      ...
      if (a != null) {
        ...
        (OrgChart.events.publish(`ripple`, [this, b]),
          _.setAttribute(`x`, b.ripple.rect ? b.ripple.rect.x : 0),
          _.setAttribute(`y`, b.ripple.rect ? b.ripple.rect.y : 0),
          _.setAttribute(`width`, b.ripple.rect ? b.ripple.rect.width : i.w),
          _.setAttribute(`height`, b.ripple.rect ? b.ripple.rect.height : i.h),
          _.setAttribute(`rx`, b.ripple.radius),
          _.setAttribute(`ry`, b.ripple.radius),
          v.setAttribute(`clip-path`, `url(#` + y + `)`),
          v.setAttribute(`cx`, s),
          v.setAttribute(`cy`, c),
          v.setAttribute(`r`, 0),
          v.setAttribute(`fill`, b.ripple.color),
          v.setAttribute(`class`, `boc-ripple`),
          g.appendChild(_),
          h.appendChild(g),
          h.appendChild(v),
          a.appendChild(h),
  ...
  (OrgChart.prototype.centerInNodes = function (t, n) {
    ...
    var l = s - o,
      u = a - i,
      d = l / (l + this.config.padding * 2),
      f = u / (u + this.config.padding * 2),
      p = d > f ? f : d;
    (p > this.config.scaleMax && (p = this.config.scaleMax),
      p < this.config.scaleMin && (p = this.config.scaleMin));
    var m = [50, 50],
      h = this.width(),
      g = this.height(),
      d = h / r[2],
    ...
    ((r[2] /= p / _),
      (r[3] /= p / _),
      (r[0] = v[0] - (r[2] - y) / (100 / m[0])),
      (r[1] = v[1] - (r[3] - b) / (100 / m[1])),
      (r[0] = o - (h / p - l) / 2),
      (r[1] = i - (g / p - u) / 2));
    var x = this;
    ((this._centerInNodesTimeout &&=
      (clearTimeout(this._centerInNodesTimeout), null)),
      (this._centerInNodesTimeout = OrgChart.animate(
        this.getSvg(),
        { viewBox: this.getViewBox() },
        { viewBox: r },
        ...
        this.config.anim.func,
        function () {
          x.draw(OrgChart.action.update, null, function () {
            n && n.call(x);
          });
        },
      )));
  }),
  (OrgChart.prototype.center = function (t, n, r) {
    var i,
      a,
      o = t,
      s = !0,
      c = !0;
    (n && n.parentState != null && (i = n.parentState),
      n && n.childrenState != null && (a = n.childrenState),
      n && n.rippleId != null && (o = n.rippleId),
      n && n.vertical != null && (s = n.vertical),
      n && n.horizontal != null && (c = n.horizontal));
    var l = {
      parentState: i,
      childrenState: a,
      rippleId: o,
  ...
  (OrgChart.prototype.getNode = function (e) {
    return this.nodes[e];
  }),
  (OrgChart.prototype.setLayout = function (t, n) {
    ((n ||= `base`),
      (this._layoutConfigs[n].layout = t),
      n == `base` && (this.config.layout = t),
      this._draw(!1, OrgChart.action.update));
  }),
  (OrgChart.prototype.setOrientation = function (t, n, r) {
    var i = this;
    ((n ||= `base`),
      (this._layoutConfigs[n].orientation = t),
      n == `base` && (this.config.orientation = t),
  ...
  (OrgChart.prototype.search = function (t, n, r) {
    return (
      OrgChart.isNEU(n) && (n = this.searchUI._searchFields),
      OrgChart.isNEU(r) && (r = n),
  ...
  (OrgChart.prototype._hideBeforeAnimation = function (t) {
    if (
      ...
      if (n.length > OrgChart.TEXT_THRESHOLD)
      ...
      if (i.length > OrgChart.IMAGES_THRESHOLD)
        for (var r = 0; r < i.length; r++) i[r].style.display = `none`;
      var a = this.element.querySelectorAll(`[` + OrgChart.attr.link_id + `]`);
      if (a.length > OrgChart.LINKS_THRESHOLD)
        for (var r = 0; r < a.length; r++) a[r].style.display = `none`;
      ...
      if (s.length > OrgChart.BUTTONS_THRESHOLD)
        for (var r = 0; r < s.length; r++) s[r].style.display = `none`;
      this._hideBeforeAnimationCompleted = !0;
    }
  }),
  (OrgChart.prototype._showAfterAnimation = function () {
    for (
      var t = this.element.getElementsByTagName(`text`), n = 0;
      n < t.length;
      n++
    )
      t[n].style.display = ``;
    for (
      var r = this.element.getElementsByTagName(`image`), n = 0;
      n < r.length;
      n++
    )
      r[n].style.display = ``;
  ...
  (OrgChart.prototype.isChild = function (e, t) {
  ...
  (OrgChart.prototype.getCollapsedIds = function (e) {
  ...
  (OrgChart.prototype.generateId = function () {
    for (;;) {
      var e =
        `_` + (`0000` + ((Math.random() * 36 ** 4) | 0).toString(36)).slice(-4);
      if (this.nodes == null || !this.nodes.hasOwnProperty(e)) return e;
    }
  }),
  (OrgChart.prototype.moveNodesToVisibleAreaAfterExpand = function (t, n, r) {
    OrgChart._moveNodesToVisibleAreaAfterExpand(this, t, n, r);
  }),
  (OrgChart.prototype.moveNodesToVisibleArea = function (t, n) {
    for (
      var r = this,
        i = this.roots[0],
        a = this.getSvg(),
      ...
      f.x != null &&
        f.y != null &&
        ((s === null || s < f.x + f.w) && (s = f.x + f.w),
        (c === null || c < f.y + f.h) && (c = f.y + f.h),
        (l === null || l > f.x) && (l = f.x),
        (u === null || u > f.y) && (u = f.y));
    }
    if (!(s == null || c == null || l == null || u == null)) {
      var p = this.width(),
        m = this.height(),
        h = s - l + this.config.padding * 2,
        g = c - u + this.config.padding * 2,
        _ = p / h,
        v = m / g,
        y = _ > v ? v : _,
        b = Math.ceil(p / y),
      ...
      if (b - this.config.padding * 2 >= s - l) h = (s + l) / 2 - b / 2;
        ...
        switch (
          ((h =
            i.x - b / 2 + OrgChart.manager._getNodeWidth(i, this.config) / 2),
          this.config.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            ((h = -(b / 2 - (l - s) / 2)),
              h < this.config.padding - b && (h = this.config.padding - b));
            break;
          ...
          case OrgChart.orientation.left_top:
            ((h = -(b / 2 - (s - l) / 2)),
              h > -this.config.padding && (h = -this.config.padding));
            break;
        }
      if (x - this.config.padding * 2 >= c - u) g = (c + u) / 2 - x / 2;
        ...
        switch (
          ((g = -(x / 2 - (c - u) / 2)),
          g > -this.config.padding && (g = -this.config.padding),
          this.config.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            ((g = -(x / 2 - (u - c) / 2)),
              g < this.config.padding - x && (g = this.config.padding - x));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            g =
              i.y - x / 2 + OrgChart.manager._getNodeWidth(i, this.config) / 2;
            break;
        }
      var S = [h, g, b, x];
      o[0] !== S[0] || o[1] !== S[1]
        ? OrgChart.animate(
            ...
            this.config.anim.func,
            function () {
              r.draw(OrgChart.action.update, void 0, n);
            },
          )
        : n && n();
    }
  ...
  (OrgChart.prototype._nodeHasHiddenParent = function (t) {
    return !t.parent && !OrgChart.isNEU(t.pid);
  }),
  ...
  (OrgChart.localStorage.getItem = function (e) {
    ...
    else if (((t = new Date(t)), t < new Date())) {
  ...
  (OrgChart.localStorage.setItem = function (e, t) {
    try {
  ...
  (OrgChart.prototype.canUpdateLink = function (e, t) {
    ...
    return n &&
      r &&
      (n.isPartner ||
        (n.hasPartners && r.isAssistant) ||
        (n.hasAssistants && r.isPartner))
      ? !1
      : !this.isChild(e, t);
  }),
  (OrgChart.prototype._canUpdateLink = OrgChart.prototype.canUpdateLink),
  (OrgChart.prototype.updateNode = function (t, n, r, i) {
    if (t) {
      var a = this,
        o = this.get(t.id);
      if (r === !0 && OrgChart.events.publish(`update`, [this, o, t]) === !1)
        return !1;
      (this.update(t),
        this._ai.setContext(),
        OrgChart.events.publish(`updated`, [this]),
        this.filterUI.update());
      var s = this.getNode(t.id),
        c = s.pid;
      ((c ??= s.stpid),
        this._draw(!1, OrgChart.action.update, { id: c }, function () {
          (i || a.ripple(t.id), n && n());
        }));
    }
  }),
  (OrgChart.prototype.update = function (e) {
  ...
  (OrgChart.prototype.removeNode = function (t, n, r) {
    if (!this.canRemove(t)) return !1;
    var i = this._getNewPidsAndStpidsForIds(t);
    return r === !0 && OrgChart.events.publish(`remove`, [this, t, i]) === !1
      ? !1
      : (this.remove(t),
        this._ai.setContext(),
        OrgChart.events.publish(`updated`, [this]),
  ...
  (OrgChart.prototype.remove = function (e) {
    var t = this.get(e);
    if (t) {
      (this._putInUndoStack(), this.clearRedo());
      for (var n = this.config.nodes.length - 1; n >= 0; n--)
        ((this.config.nodes[n].pid == e || this.config.nodes[n].stpid == e) &&
          ((this.config.nodes[n].pid = t.pid),
          (this.config.nodes[n].stpid = t.stpid)),
          this.config.nodes[n].id == e && this.config.nodes.splice(n, 1));
    }
    return this;
  }),
  (OrgChart.prototype._getNewPidsAndStpidsForIds = function (e) {
    var t = this.get(e),
      n = {},
      r = {};
    if (t)
      for (var i = this.config.nodes.length - 1; i >= 0; i--)
        this.config.nodes[i].pid == e
          ? (n[this.config.nodes[i].id] = t.pid)
          : this.config.nodes[i].stpid == e &&
            (r[this.config.nodes[i].id] = t.stpid);
    return { newPidsForIds: n, newStpidsForIds: r };
  }),
  (OrgChart.prototype.addNode = function (t, n, r) {
    var i = this;
    if (r === !0 && OrgChart.events.publish(`add`, [this, t]) === !1) return !1;
    (this.add(t),
      this._ai.setContext(),
      OrgChart.events.publish(`updated`, [this]),
      this.filterUI.update(),
  ...
  (OrgChart.prototype.addNodes = function (t, n, r) {
    if (Array.isArray(n)) {
      var i = this,
        a = [];
      ...
      (this._ai.setContext(),
        ...
        this.filterUI.update());
      var s = { id: t };
      i._draw(!1, OrgChart.action.update, s, function () {
        r && r();
      });
    }
  }),
  (OrgChart.prototype.add = function (t) {
    if (
      (t.id ?? console.error(`Call addNode without id`),
      ...
      n &&
        (n.movex != null && (t.movex = n.movex),
        n.movey != null && (t.movey = n.movey));
    }
    return (this.config.nodes.push(t), this);
  }),
  (OrgChart.prototype.replaceIds = function (t, n) {
    (this._replaceIds(t), this._draw(!1, OrgChart.action.update, void 0, n));
  }),
  (OrgChart.prototype._replaceIds = function (t) {
    ...
    if (this.manager.oldNodes) {
      for (var s in this.manager.oldNodes)
        if (!OrgChart.isNEU(t[s])) {
          var o = t[s],
            c = this.manager.oldNodes[s];
          ((c.id = o), (this.manager.oldNodes[o] = c));
        }
    }
    if (this.roots) {
      for (var s in this.roots)
        if (!OrgChart.isNEU(t[s])) {
          var o = t[s],
            c = this.roots[s];
    ...
    (n(this.config.clinks),
      n(this.config.slinks),
      n(this.config.groupDottedLines),
      n(this.config.dottedLines));
  }),
  (OrgChart.prototype._get = function (t) {
    ...
    if (
      ...
      !OrgChart.isNEU(t) &&
      typeof t == `string` &&
      (t.indexOf(`balkan_group_dotted_`) != -1 ||
        t.indexOf(`balkan_dotted_`) != -1)
    ) {
      ((t = t.replace(`balkan_group_dotted_`, ``)),
        (t = t.replace(`balkan_dotted_`, ``)));
      var r = t.indexOf(`_balkan_id_`);
      if (((t = t.substring(r + 11)), (n = this.__get(t)), n)) return n;
    }
    return null;
  }),
  (OrgChart.prototype.__get = function (e) {
    for (var t = 0; t < this.config.nodes.length; t++)
      if (this.config.nodes[t].id == e) return this.config.nodes[t];
    return null;
  }),
  (OrgChart.prototype.get = function (e) {
    var t = this._get(e);
    return t == null ? null : JSON.parse(JSON.stringify(t));
  }),
  (OrgChart.prototype.canRemove = function (e) {
    var t = this.getNode(e);
    return !(!t || t.hasPartners || t.hasAssistants);
  }),
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart._ajax = function (t, n, r, i, a) {
    i ??= `arraybuffer`;
    var o = new XMLHttpRequest();
    for (var s in ((o.onload = function (e) {
      o.readyState == 4 &&
        this.status === 200 &&
        (e.target == null ? a(this.response) : a(e.target.response));
    }),
    ...
    OrgChart.REQUEST_CUSTOM_HEADERS))
      o.setRequestHeader(s, OrgChart.REQUEST_CUSTOM_HEADERS[s]);
    r == null ? o.send() : o.send(r);
  }),
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.animate = function (t, n, r, i, a, o, s) {
    var c = 10,
      l = 1,
      u = 1,
      d = i / c + 1,
      ...
      for (var p = 0; p < t.length; p++)
        for (var m in r[p]) {
          ...
          switch (m.toLowerCase()) {
            case `d`:
              var g =
                  a((u * c - c) / i) * (r[p][m][0] - n[p][m][0]) + n[p][m][0],
                _ = a((u * c - c) / i) * (r[p][m][1] - n[p][m][1]) + n[p][m][1];
              t[p].setAttribute(
                `d`,
                t[p].getAttribute(`d`) + ` L` + g + ` ` + _,
              );
              break;
            case `r`:
            ...
            case `transform`:
              if (r[p][m]) {
                ...
                for (var S in y)
                  x[S] = a((u * c - c) / i) * (b[S] - y[S]) + y[S];
                t[p].hasAttribute(`transform`)
                  ? t[p].setAttribute(
                      `transform`,
                      `matrix(` + x.toString() + `)`,
                    )
                  : (t[p].style.transform = `matrix(` + x.toString() + `)`);
              }
              break;
            case `viewbox`:
              if (r[p][m]) {
  ...
  (OrgChart.anim = {}),
  (OrgChart.anim.inPow = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : e ** 2;
  }),
  (OrgChart.anim.outPow = function (e) {
    var t = 2;
    if (e < 0) return 0;
    if (e > 1) return 1;
    var n = t % 2 == 0 ? -1 : 1;
  ...
  (OrgChart.anim.inOutPow = function (t) {
    ...
    if (t < 0) return 0;
    if (t > 1) return 1;
    if (((t *= 2), t < 1)) return OrgChart.anim.inPow(t, n) / 2;
    var r = n % 2 == 0 ? -1 : 1;
    return (r / 2) * ((t - 2) ** n + r * 2);
  }),
  (OrgChart.anim.inSin = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : -Math.cos((Math.PI / 2) * e) + 1;
  }),
  (OrgChart.anim.outSin = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : Math.sin((Math.PI / 2) * e);
  }),
  (OrgChart.anim.inOutSin = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : -0.5 * (Math.cos(Math.PI * e) - 1);
  }),
  (OrgChart.anim.inExp = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : 2 ** (10 * (e - 1));
  }),
  (OrgChart.anim.outExp = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : -(2 ** (-10 * e)) + 1;
  }),
  (OrgChart.anim.inOutExp = function (e) {
    return e < 0
      ? 0
      : e > 1
        ? 1
  ...
  (OrgChart.anim.inCirc = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : -(Math.sqrt(1 - e * e) - 1);
  }),
  (OrgChart.anim.outCirc = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : Math.sqrt(1 - (e - 1) * (e - 1));
  }),
  (OrgChart.anim.inOutCirc = function (e) {
    return e < 0
      ? 0
      : e > 1
        ? 1
  ...
  (OrgChart.anim.rebound = function (e) {
    return e < 0
      ? 0
      : e > 1
        ? 1
  ...
  (OrgChart.anim.inBack = function (e) {
    return e < 0 ? 0 : e > 1 ? 1 : e * e * (2.70158 * e - 1.70158);
  }),
  (OrgChart.anim.outBack = function (e) {
    return e < 0
      ? 0
      : e > 1
        ? 1
  ...
  (OrgChart.anim.inOutBack = function (e) {
    return e < 0
      ? 0
      : e > 1
        ? 1
        : e < 0.5
          ? 0.5 * (4 * e * e * (3.5949 * 2 * e - 2.5949))
          : 0.5 *
            ((2 * e - 2) * (2 * e - 2) * (3.5949 * (2 * e - 2) + 2.5949) + 2);
  }),
  (OrgChart.anim.impulse = function (e) {
    var t = 2 * e;
    return t * Math.exp(1 - t);
  }),
  (OrgChart.anim.expPulse = function (e) {
  ...
  (OrgChart.prototype._attachEventHandlers = function (t) {
    if (this.config.interactive) {
      ...
      (t.addEventListener(
        ...
        this.config.mouseScroll != OrgChart.action.none &&
          t.addEventListener(
            `wheel`,
            function (e) {
  ...
  (OrgChart.attr.control_node_btn = `data-ctrl-n-btn`),
  ...
  (OrgChart.SERVER_PREFIX = `.azurewebsites.net/api/you-see-this-request-because-it-is-trial-version-of-orgchartjs`),
  ...
  (OrgChart._intersects = function (t, n, r) {
    ...
    switch (r.orientation) {
      ...
      case OrgChart.orientation.left_top:
        ((i = t.x),
          ...
          (o = t.x),
          (s = t.y + t.h + r.siblingSeparation / 4));
        break;
    }
    var c = n.p,
      l = n.q,
  ...
  (OrgChart._addPoint = function (t, n, r, i, a) {
    switch (r.orientation) {
      case OrgChart.orientation.top:
      case OrgChart.orientation.top_left:
        return OrgChart._addPointTop(t, n, r, i, a);
      case OrgChart.orientation.bottom:
      case OrgChart.orientation.bottom_left:
        return OrgChart._addPointBottom(t, n, r, i, a);
      case OrgChart.orientation.left:
      case OrgChart.orientation.left_top:
        return OrgChart._addPointLeft(t, n, r, i, a);
      case OrgChart.orientation.right:
      case OrgChart.orientation.right_top:
        return OrgChart._addPointRight(t, n, r, i, a);
    }
  }),
  (OrgChart._addPointTop = function (e, t, n, r, i) {
    var a, o, s;
    return (
      i == `left`
        ? (a = e.leftNeighbor
            ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2
            : e.x - n.siblingSeparation / 2)
        : i == `right` &&
          (a = e.rightNeighbor
            ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2
            : e.x + e.w + n.siblingSeparation / 2),
      t.push([a, t[t.length - 1][1]]),
      t.push([a, e.y - n.levelSeparation / 3]),
      (o = t[t.length - 1][1]),
      (s = a),
      (r.p = a),
      (r.q = o),
  ...
  (OrgChart._addPointBottom = function (e, t, n, r, i) {
    var a, o, s;
    return (
      i == `left`
        ? (a = e.leftNeighbor
        ...
        : i == `right` &&
          (a = e.rightNeighbor
            ...
            : e.x + e.w + n.siblingSeparation / 2),
      t.push([a, t[t.length - 1][1]]),
      t.push([a, e.y + e.h + n.levelSeparation / 3]),
      (o = t[t.length - 1][1]),
      (s = a),
      (r.p = a),
      (r.q = o),
  ...
  (OrgChart._addPointLeft = function (e, t, n, r, i) {
    var a = t[t.length - 1][0],
      o;
    (i == `bottom`
      ? (o = e.rightNeighbor
          ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2
          : e.y + e.h + n.siblingSeparation / 2)
      : i == `top` &&
        (o = e.leftNeighbor
          ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2
          : e.y - n.siblingSeparation / 2),
      t.push([t[t.length - 1][0], o]),
      t.push([e.x - n.levelSeparation / 3, o]),
      (a = t[t.length - 1][0]));
    var s = o;
    return ((r.p = a), (r.q = o), (r.s = s), r);
  }),
  (OrgChart._addPointRight = function (e, t, n, r, i) {
    var a = t[t.length - 1][0],
      o;
    (i == `bottom`
      ? (o = e.rightNeighbor
      ...
      : i == `top` &&
        (o = e.leftNeighbor
          ...
          : e.y - n.siblingSeparation / 2),
      t.push([t[t.length - 1][0], o]),
      t.push([e.x + e.w + n.levelSeparation / 3, o]),
      (a = t[t.length - 1][0]));
    var s = o;
    return ((r.p = a), (r.q = o), (r.s = s), r);
  }),
  (OrgChart._addConnectorLines = function (t, n) {
    (OrgChart._addConnectorLine(t, { x1: n.xa, y1: n.ya, x2: n.xb, y2: n.yb }),
      OrgChart._addConnectorLine(t, { x1: n.xb, y1: n.yb, x2: n.xc, y2: n.yc }),
  ...
  (OrgChart._addConnectorLine = function (e, t) {
    if (t.x1 == t.x2) {
      if ((e.x[t.x1] || (e.x[t.x1] = []), t.y1 > t.y2)) {
        var n = t.y1;
        ((t.y1 = t.y2), (t.y2 = n));
      }
      e.x[t.x1].push({ y1: t.y1, y2: t.y2 });
    }
    if (t.y1 == t.y2) {
      ...
      e.y[t.y1].push({ x1: t.x1, x2: t.x2 });
    }
  }),
  (OrgChart._addLineToPath = function (t, n, r) {
    return (
      OrgChart._avoidOverlapping(n, r),
      t.push([r.x1, r.y1]),
      t.push([r.x2, r.y2]),
      OrgChart._addConnectorLine(n, r),
      r
    );
  }),
  (OrgChart._slinkRemoveUnusedPoints = function (e) {
    for (var t = e.length - 2; t >= 1; t--) {
      var n = e[t - 1],
        r = e[t],
        i = e[t + 1];
      ((r[0] == n[0] && r[0] == i[0]) || (r[1] == n[1] && r[1] == i[1])) &&
        e.splice(t, 1);
    }
  }),
  (OrgChart._slinkAvoidOverlaping = function (t, n, r, i) {
          ...
          for (var u of c)
            if (
              ...
              i == OrgChart.orientation.top_left
                ? r == `left`
                  ? (s[0] -= OrgChart.SLINK_GAP)
                  : r == `right` && (s[0] += OrgChart.SLINK_GAP)
                : (i == OrgChart.orientation.bottom ||
                    i == OrgChart.orientation.bottom_left) &&
                  (r == `right`
                    ? (s[0] += OrgChart.SLINK_GAP)
                    : r == `left` && (s[0] -= OrgChart.SLINK_GAP)),
                (l = !1));
              break;
            }
          if (l) break;
  ...
  (OrgChart._slinkAvoidOverlapingSecond = function (t, n, r) {
  ...
  (OrgChart._slinkAvoidOverlaping2 = function (t, n, r, i) {
    for (var a = 1; a < n.length; a++) {
      var o = n[a - 1],
        s = n[a];
      if (o[1] == s[1]) {
  ...
  (OrgChart._slinkAvoidOverlapingSecond2 = function (t, n, r) {
    for (var i = 1; i < n.length; i++) {
      var a = n[i - 1],
        o = n[i],
        s = !1;
  ...
  (OrgChart.editUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.editUI.prototype.show = function (t, n, r) {
    if (this.hide(!0)) {
      if (
        ((this.nodeId = t),
        (this.detailsMode = n),
        OrgChart.events.publish(`show`, [this, t]) === !1)
      )
        return !1;
      var i = this,
        a = this.content(t, n, r);
      (this.obj.element.appendChild(a.element),
        OrgChart.input.init(this.obj.element),
        OrgChart.events.publish(`shown`, [this, { nodeId: t }]),
        r
          ? n || this._focusElement(a.focusId)
        ...
        this.obj.element
          ...
          .addEventListener(`click`, function (n) {
            (n.preventDefault(),
              OrgChart.events.publish(`cancel`, [i, { id: t }]) !== !1 &&
                i.hide());
          }),
        this.obj.element
      ...
      for (
        var o = this.obj.element.querySelectorAll(`[data-input-btn]`), s = 0;
        s < o.length;
        s++
      )
        o[s].addEventListener(`click`, function (n) {
          (n.preventDefault(),
      ...
      (this.obj.element
        ...
        .addEventListener(`click`, function (t) {
          ...
          (n.parentNode.insertAdjacentHTML(`beforebegin`, r.html),
            (n.style.display = `none`),
            OrgChart.input.init(n.parentNode.previousSibling));
          var a = document.getElementById(r.id);
          (a.focus(),
            a.nextElementSibling.addEventListener(`click`, function (t) {
              (t.stopPropagation(), t.preventDefault());
              var r = a.value,
                o = i.obj.element.querySelector(
                  `[data-binding="` +
                    OrgChart._escapeDoubleQuotes(a.value) +
                    `"]`,
                );
              if (!OrgChart.isNEU(r) && !o) {
                ...
                (a.parentNode.parentNode.parentNode.removeChild(
                  ...
                  n.parentNode.insertAdjacentHTML(`beforebegin`, s.html),
                  (n.style.display = ``),
                  OrgChart.input.init(n.parentNode.previousSibling));
        ...
        this.obj.element
          ...
          .addEventListener(`click`, function (n) {
            for (
              ...
              r = r.parentNode;
            if (r && r.hasAttribute) {
              var a = r.getAttribute(`data-edit-from-btn`),
                o = {
              ...
              if (OrgChart.events.publish(`button-click`, [i, o]) === !1)
                return !1;
              switch (a) {
                case `edit`:
      ...
      for (
        var c = this.obj.element.querySelectorAll(
  ...
  (OrgChart.editUI.prototype._replaceNodeWith = function (e) {
    var t = document.createElementNS(`http://www.w3.org/2000/svg`, `g`);
    t.innerHTML = e;
    var n = t.firstElementChild;
    this.obj.getNodeElement(this.nodeId).replaceWith(n);
  }),
  (OrgChart.editUI.prototype.setAvatar = function (e) {
    var t = this.obj.element.querySelector(`[id="boc-avatar"]`),
      n = this.obj.element.querySelector(`[id="boc-avatar"] img`),
      r = this.obj.element.querySelector(`[id="boc-avatar"] svg`);
    if (t)
      n
        ? n.setAttribute(`src`, e)
        : r &&
          (t.innerHTML = `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${e}">`);
    else return;
  ...
  (OrgChart.editUI.prototype.save = function (t) {
    var n = this.obj.element.querySelector(`[data-boc-edit-form]`),
      r = OrgChart.input.validateAndGetData(n);
    if (r !== !1) {
      var i = this.obj.get(this.nodeId),
        a = { data: OrgChart.mergeDeep(i, r) };
      return OrgChart.events.publish(`save`, [this, a]) === !1
        ? void 0
        : (this.obj.updateNode(a.data, null, !0, t), !0);
    }
    return !1;
  }),
  (OrgChart.editUI.prototype._focusElement = function (t) {
    ...
    (OrgChart.isNEU(this.obj.config.editForm.focusBinding)
      ? OrgChart.isNEU(t) || (n = document.getElementById(t))
  ...
  (OrgChart.editUI.prototype.content = function (t, n, r, i, a) {
    var o = this.obj.config.editForm.readOnly,
      s = JSON.parse(JSON.stringify(this.obj.config.editForm.elements)),
      c = this.obj.config.editForm.addMore,
      l = this.obj.config.editForm.saveAndCloseBtn,
      u = this.obj.config.editForm.buttons,
      d = this.obj.config.editForm.titleBinding,
      f = this.obj.config.editForm.photoBinding,
      p = this.obj.getNode(t),
      m = this.obj._get(t),
      h = OrgChart.t(p.templateName, p.min, this.obj.getScale()),
      g = m[d],
      _ = m[f];
    if (this.obj.config.editForm.generateElementsFromFields)
      for (var v = 0; v < this.fields.length; v++) {
        ...
        if (y != `tags`) {
          ...
          b || s.push({ type: `textbox`, label: y, binding: y });
        }
      }
    (OrgChart.isNEU(g) && (g = ``),
      (_ = OrgChart.isNEU(_)
        ? OrgChart.icon.user(150, 150, `#8C8C8C`, 0, 0)
        : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${_}"></img>`));
    var C,
      w = !n,
      T = n ? `display:none;` : ``,
      E = n || !c ? `display:none;` : ``,
      D = h.editFormHeaderColor
        ? `style="background-color:${h.editFormHeaderColor};"`
        : ``,
      O = document.createElement(`form`);
    if (
      (O.setAttribute(`data-boc-edit-form`, ``),
      O.classList.add(`boc-edit-form`),
      O.classList.add(this.obj.config.mode),
      O.classList.add(p.templateName.replaceAll(` `, ``)),
      O.classList.add(OrgChart.ui._defsIds[p.templateName]),
      Array.isArray(p.tags) && p.tags.length)
    )
      for (var v = 0; v < p.tags.length; v++)
        O.classList.add(p.tags[v].replaceAll(` `, ``));
    ((O.style.display = `flex`),
      (O.style.opacity = r ? 1 : 0),
      (O.style.right = r ? 0 : `-20px`),
      i && (O.style.width = i));
    var k = [];
    return (
      (O.innerHTML = `<div>
                        <div class="boc-edit-form-header" ${D}>
                            ${a ? `` : OrgChart.EDITFORM_CLOSE_BTN}
                            ${OrgChart.editUI.renderHeaderContent(g, _, p, m)}
                        </div>
                        ...
                        ${(function () {
                          ...
                          for (var r in u) {
                            ...
                            OrgChart.isNEU(i) ||
                              (w && i.hideIfEditMode) ||
                              (n && i.hideIfDetailsMode) ||
                              (o && i.text == `Edit`) ||
                              (t += `<div data-edit-from-btn='${r}' class="boc-img-button" ${D} title="${i.text}">${i.icon}</div>`);
                          }
                          return t;
                        })()}    
                        </div>
                                  ...
                                  for (var t = ``, r = 0; r < s.length; r++) {
                                    ...
                                    if (Array.isArray(i)) {
                                      ...
                                      for (var a = 0; a < i.length; a++) {
                                        ...
                                        (!OrgChart.isNEU(c.id) &&
                                          OrgChart.isNEU(C) &&
                                          OrgChart.isNEU(c.value) &&
                                          (C = c.id),
                                          OrgChart.isNEU(c.value) ||
                                            k.push(`${o.label}: ${c.value}`),
                                          (t += c.html));
                                      }
                                      t += `</div>`;
                                    } else {
                                      var c = OrgChart.elements[i.type](
                                        m,
                                        i,
                                        `280px`,
                                        n,
...
`),
  ...
  (OrgChart.editUI.prototype.hide = function (t) {
    ...
    if (n) {
      ...
      if (OrgChart.events.publish(`hide`, [this]) === !1) return !1;
  ...
  (OrgChart.editUI.renderHeaderContent = function (t, n, r, i) {
  ...
  (OrgChart.menuUI.prototype.init = function (t, n) {
    ((this.obj = t),
      (this.wrapper = null),
      (this.menu = n),
      (this._event_id = OrgChart._guid()));
  }),
  (OrgChart.menuUI.prototype.showStickIn = function (e, t, n, r) {
    var i = e.getBoundingClientRect(),
      a = this.obj.getSvg().getBoundingClientRect(),
      o = i.left - a.left,
      s = i.top - a.top;
    return this.show(o, s, t, n, r);
  }),
  (OrgChart.menuUI.prototype.show = function (e, t, n, r, i) {
    return this._show(e, t, n, r, i);
  }),
  (OrgChart.menuUI.prototype._show = function (t, n, r, i, a) {
    var o = this;
    (this.hide(), (a ||= this.menu));
    var s = { firstNodeId: r, secondNodeId: i, menu: a };
    if (
      OrgChart.events.publish(`show`, [this, s]) === !1 ||
      ((a = s.menu), !a || Object.keys(a).length == 0)
    )
      return !1;
    var c = this.obj;
    ((this.wrapper = OrgChart.menuUI._createMenuElement(a, c)),
      this.wrapper.addEventListener(`click`, function (t) {
        for (var n = t.target, s = []; n && n !== o.wrapper; )
          (n.hasAttribute &&
            n.hasAttribute(`data-item`) &&
            s.unshift(n.getAttribute(`data-item`)),
            (n = n.parentNode));
        if (s.length) {
          var c = !0,
            l = a;
          ...
          var d = l.onClick;
          (OrgChart._onClickHandler(o.obj, u, d, r, i) === !1 && (c = !1),
            c && o.hide());
        }
      }),
      setTimeout(() => {
    ...
    let l = window.innerWidth,
      ...
      d = this.wrapper.offsetWidth,
      f = this.wrapper.offsetHeight;
    return (
      t + d > l && (t = l - d - 10),
      n + f > u && (n = u - f - 10),
      (this.wrapper.style.left = `${t}px`),
      (this.wrapper.style.top = `${n}px`),
      this.wrapper.querySelectorAll(`.boc-has-submenu`).forEach((e) => {
        e.addEventListener(`mouseenter`, () => {
          var t = e.querySelector(`.boc-submenu`);
          if (t) {
            (t.classList.remove(`boc-submenu-left`),
              t.classList.remove(`boc-submenu-top`));
            var n = t.getBoundingClientRect(),
              r = window.innerWidth,
              i = window.innerHeight;
            (n.right > r && t.classList.add(`boc-submenu-left`),
              n.bottom > i && t.classList.add(`boc-submenu-top`));
          }
        });
      }),
      !0
  ...
  (OrgChart.menuUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.menuUI._createMenuElement = function (t, n) {
    var r = document.createElement(`div`);
    (r.classList.add(`boc-menu`),
      r.setAttribute(`data-menu`, ``),
      (r.id = `custom-boc-menu`));
    var i = document.createElement(`table`);
    return (
      i.classList.add(`boc-menu-options`),
      i.setAttribute(`cellpadding`, `0`),
      i.setAttribute(`cellspacing`, `0`),
      OrgChart.menuUI._createMenuItemElements(t, i),
      r.appendChild(i),
      n.element.appendChild(r),
      r
    );
  }),
  (OrgChart.menuUI._createMenuItemElements = function (t, n) {
    for (var r in t) {
      var i = t[r],
      ...
      if ((o.classList.add(`boc-menu-submenu`), i.subMenu)) {
        ...
        (s.setAttribute(`cellpadding`, `0`),
          ...
          s.classList.add(`boc-submenu`),
          OrgChart.menuUI._createMenuItemElements(i.subMenu, s),
          a.classList.add(`boc-has-submenu`),
          o.appendChild(s));
      }
      var c = i.text,
        l = i.icon,
      ...
      (l === void 0 &&
        (l = OrgChart.icon[r]
          ? typeof OrgChart.icon[r] == `function`
            ? OrgChart.icon[r](24, 24, `#7A7A7A`)
            : OrgChart.icon[r]
          : ``),
        typeof c == `function` ? (c = c()) : (c ||= r),
        typeof l == `function` && (l = l()));
      var d = document.createElement(`td`);
      (d.classList.add(`boc-menu-icon`),
        (d.innerHTML = l || ``),
        a.appendChild(d));
      ...
      if (
        (p.classList.add(`boc-menu-shortcut`),
        i.subMenu
          ? (p.innerHTML = `<span class="boc-submenu-arrow">â–¶</span>`)
          : (p.textContent = u || ``),
        a.appendChild(p),
        a.appendChild(o),
        n.appendChild(a),
        ...
        (m.classList.add(`boc-menu-divider`),
          (m.innerHTML = `<td colspan="3"><div class="boc-menu-line"></div></td>`),
          n.appendChild(m));
      }
    }
  }),
  (OrgChart.controlsUI = function () {}),
  (OrgChart.controlsUI.prototype.init = function (e) {
    ((this.instance = e),
      (this.elements = {
        top_right: null,
        right_top: null,
  ...
  (OrgChart.controlsUI.prototype.show = function () {
    ...
    if (r) {
      ...
      for (var a in r) {
        ...
        ((o.anchor ||= OrgChart.anchor.bottom_right), (i[o.anchor] += u));
      }
      for (var a in i)
        i[a] &&
          ((this.elements[a] = document.createElement(`div`)),
          (this.elements[a].className = `boc-controls boc-controls-` + a),
          (this.elements[a].innerHTML = i[a]),
          this.elements[a].addEventListener(`click`, n),
          this.instance.element.appendChild(this.elements[a]));
    }
  }),
  ...
  (OrgChart.circleMenuUI.prototype.init = function (t, n) {
    ((this.obj = t),
      (this.menu = n),
      (this._menu = null),
  ...
  (OrgChart.circleMenuUI.prototype.show = function (e, t) {
    this._show(e, t);
  }),
  ...
  (OrgChart.circleMenuUI.prototype._show = function (t, n) {
    var r = this,
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
      var o = this.obj.getSvg(),
        ...
        c = this.obj.getNodeElement(t),
        l = OrgChart._getTransform(s),
        u = OrgChart._getTransform(c),
        d = l[4] + u[4],
        f = l[5] + u[5],
        p = s.querySelectorAll(`line`),
        m = this.obj.element.querySelector(
          `[` + OrgChart.attr.control_node_circle_menu_wrraper_id + `]`,
        );
      if (
        !OrgChart.isNEU(m) &&
        m.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) == t
      ) {
        this.hide();
        return;
      } else this.hide();
      n ||= this.menu;
      var h = { nodeId: t, menu: n },
        g = OrgChart.events.publish(`show`, [this, h]);
      if (((this._menu = n), g === !1)) return !1;
      for (
        var _ = 0,
          v = Object.keys(h.menu).length,
          y = a.nodeCircleMenuButton.radius * 2 + 4,
          b = 2 * Math.PI * y,
          x = b / v - (a.nodeCircleMenuButton.radius * 2 + 2);
        x < 0;
      )
        ((y += 8),
          (b = 2 * Math.PI * y),
          (x = b / v - (a.nodeCircleMenuButton.radius * 2 + 2)));
      for (var S in ((m = document.createElementNS(
        `http://www.w3.org/2000/svg`,
        `g`,
      )),
      m.setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t),
      m.setAttribute(`transform`, `matrix(1,0,0,1,` + d + `,` + f + `)`),
      o.appendChild(m),
      h.menu)) {
        var C = h.menu[S].icon,
          w = h.menu[S].color,
        ...
        (E.setAttribute(`transform`, `matrix(1,0,0,1,0,0)`),
          E.setAttribute(OrgChart.attr.control_node_circle_menu_name, S),
          (E.style.cursor = `pointer`));
        var D = document.createElementNS(`http://www.w3.org/2000/svg`, `title`);
        OrgChart.isNEU(T) || (D.innerHTML = T);
        ...
        (O.setAttribute(`cx`, 0),
          O.setAttribute(`cy`, 0),
          O.setAttribute(`r`, a.nodeCircleMenuButton.radius),
          O.setAttribute(`fill`, w),
          O.setAttribute(`stroke-width`, `1`),
          O.setAttribute(`stroke`, a.nodeCircleMenuButton.stroke),
          E.appendChild(O),
          E.appendChild(D),
          (E.innerHTML += C),
          m.appendChild(E));
        ...
        if ((k.setAttribute(`pointer-events`, `none`), k)) {
          var A = parseInt(k.getAttribute(`width`)),
            j = parseInt(k.getAttribute(`height`));
        ...
        this._buttonsInterval.push(
          OrgChart.animate(
            ...
            { transform: [1, 0, 0, 1, N, P] },
            250,
            OrgChart.anim.outBack,
            function (t) {
              var n = t[0].getAttribute(
              ...
              (t[0].addEventListener(`mouseenter`, function (t) {
                OrgChart.events.publish(`mouseenter`, [
                  r,
                  { from: i, menuItem: h.menu[n], menuItemName: n, event: t },
                ]);
              }),
  ...
  (OrgChart.circleMenuUI.prototype.hide = function () {
    ...
    this._buttonsInterval = [];
    for (var t = this._linesInterval.length - 1; t >= 0; t--)
      (clearInterval(this._linesInterval[t]), this._linesInterval.splice(t, 1));
    this._linesInterval = [];
    var n = this.obj.element.querySelector(
      `[` + OrgChart.attr.control_node_circle_menu_wrraper_id + `]`,
    );
    if (n != null) {
      var r = n.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id),
  ...
  (OrgChart.circleMenuUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.idb = {
  ...
  (OrgChart.idb._open = function (t) {
    ...
    var n = indexedDB.open(OrgChart.idb.dbName, OrgChart.idb.version);
    ((n.onerror = function (e) {
      (console.error(`Cannot open database!`), t && t(!1));
    }),
      (n.onsuccess = function (n) {
        ((OrgChart.idb.db = n.target.result), t && t(!0));
      }),
      (n.onupgradeneeded = function (t) {
        var n = t.target.result;
        (n.objectStoreNames.contains(OrgChart.idb.tableName) &&
          n.deleteObjectStore(OrgChart.idb.tableName),
          n.createObjectStore(OrgChart.idb.tableName, {
            keyPath: OrgChart.idb.keyPath,
          }));
      }));
  }),
  (OrgChart.idb.read = function (t, n) {
  ...
  (OrgChart.idb.write = function (t, n) {
  ...
  (OrgChart.idb.delete = function (t, n) {
    OrgChart.idb._open(function (r) {
      if (r) {
        var i = OrgChart.idb.db
          .transaction([OrgChart.idb.tableName], `readwrite`)
  ...
  (OrgChart.toolbarUI.prototype.init = function (t, n) {
    if (n) {
      ((this.obj = t),
        (this.toolbar = n),
        (this._visible = !1),
      ...
      var r = this.div.querySelector(`[` + OrgChart.attr.tlbr + `="plus"]`),
        ...
        s = this.div.querySelector(`[` + OrgChart.attr.tlbr + `="expand"]`),
        c = this;
      (r &&
        ...
        this.layouts &&
          this.layouts.addEventListener(`click`, function (t) {
            for (var n = t.target; n; ) {
              if (n.hasAttribute && n.hasAttribute(OrgChart.attr.layout)) {
                ((n = n.getAttribute(OrgChart.attr.layout)),
                  c.obj.setLayout(OrgChart.layout[n]));
                break;
              }
              n = n.parentNode;
            }
  ...
  (OrgChart.notifierUI.prototype.init = function (e) {
    this.obj = e;
  }),
  (OrgChart.notifierUI.prototype.show = function (t, n) {
    if (t == null) return !1;
    (t == 1 && ((t = OrgChart.MAX_NODES_MESS), (n = `#FFCA28`)),
      t == 2 && ((t = OrgChart.OFFLINE_MESS), (n = `#FFCA28`)));
    var r = document.createElement(`div`);
    ((r.innerHTML = t),
    ...
    OrgChart.icon.png =
      function (e, t, n, r, i) {
        return (
          (r ??= 0),
          (i ??= 0),
          `<svg width="${e}" height="${t}" viewBox="0 0 550.801 550.801" x="${r}" y="${i}">
  ...
  (OrgChart.icon.csv_export = OrgChart.icon.csv =
    function (e, t, n, r, i) {
      return (
        (r ??= 0),
        (i ??= 0),
        `<svg width="${e}" height="${t}" viewBox="0 0 548.29 548.291" x="${r}" y="${i}">'
  ...
  (OrgChart.icon.json_export = OrgChart.icon.json =
    function (e, t, n, r, i) {
      return (
        (r ??= 0),
        (i ??= 0),
        `<svg width="${e}" height="${t}" viewBox="0 0 32 32" x="${r}" y="${i}">
  ...
  (OrgChart.icon.excel = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 24 24" x="${r}" y="${i}">
  ...
  (OrgChart.icon.edit = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 528.899 528.899" x="${r}" y="${i}">
                <path fill="${n}" d="M328.883,89.125l107.59,107.589l-272.34,272.34L56.604,361.465L328.883,89.125z M518.113,63.177l-47.981-47.981 c-18.543-18.543-48.653-18.543-67.259,0l-45.961,45.961l107.59,107.59l53.611-53.611 C532.495,100.753,532.495,77.559,518.113,63.177z M0.3,512.69c-1.958,8.812,5.998,16.708,14.811,14.565l119.891-29.069 L27.473,390.597L0.3,512.69z" />'
            </svg>`
    );
  }),
  (OrgChart.icon.details = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 512 512" x="${r}" y="${i}">
  ...
  (OrgChart.icon.remove = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 900.5 900.5" x="${r}" y="${i}">
  ...
  (OrgChart.icon.add = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 922 922" x="${r}" y="${i}">
  ...
  (OrgChart.icon.search = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 485.213 485.213" x="${r}" y="${i}">
  ...
  (OrgChart.icon.link = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 512.092 512.092" x="${r}" y="${i}">
  ...
  (OrgChart.icon.happy = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 512 512" x="${r}" y="${i}">
  ...
  (OrgChart.icon.sad = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" viewBox="0 0 512 512" x="${r}" y="${i}">
  ...
  (OrgChart.icon.share = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 512 512">
  ...
  (OrgChart.icon.user = function (t, n, r, i, a) {
    return (
      OrgChart.isNEU(i) && (i = 0),
      OrgChart.isNEU(a) && (a = 0),
      `<svg width="${t}" height="${n}" x="${i}" y="${a}" viewBox="0 0 24 24">
  ...
  (OrgChart.icon.close = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 512 512">
  ...
  (OrgChart.icon.undo = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 24 24">
  ...
  (OrgChart.icon.redo = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 24 24" >
  ...
  (OrgChart.icon.send = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}"  viewBox="0 0 24 24" >
  ...
  (OrgChart.icon.x = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 24 24">
  ...
  (OrgChart.icon.fit = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 128 128">
  ...
  (OrgChart.icon.expand_all = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 32 32">
  ...
  (OrgChart.icon.full_screen = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}"  viewBox="0 0 48 48">
...
<rect x="24" y="24" width="20" height="16" rx="2" fill="none" stroke="${n}" stroke-width="4" stroke-linejoin="round"/>
  ...
  (OrgChart.icon.zoom_in = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 32 32" >
  ...
  (OrgChart.icon.zoom_out = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 -12 32 32" >
  ...
  (OrgChart.icon.layout_normal = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg  width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.layout_right_offset = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg  width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.layout_left_offset = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.layout_mixed = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.layout_tree = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.layout_grid = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 110 100">
  ...
  (OrgChart.icon.cursor = function (e, t, n, r, i) {
    return (
      (r ??= 0),
      (i ??= 0),
      `<svg width="${e}" height="${t}" x="${r}" y="${i}" viewBox="0 0 16 16" >
  ...
  (OrgChart.prototype.shareProfile = function (e) {
    ...
    var r = { title: t.title, text: t.shareText, url: n.href };
    try {
      navigator.share(r);
    } catch (e) {
  ...
  (OrgChart.prototype.exportToCSV = OrgChart.prototype.exportCSV =
    function (t) {
      var n = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, `csv`),
        r = this.getNode(n.nodeId),
        i = null;
      r
        ? ((i = []), OrgChart._exportIterateForJSON_XML_CSV(this, r, n, i))
        : n.min === !1 || n.expandChildren === !1
          ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, n, i)
          : (i = JSON.parse(JSON.stringify(this.config.nodes)));
      var a = { ext: `csv`, filename: t, options: n, nodes: i },
        o = OrgChart.events.publish(`exportstart`, [this, a]);
      if (o === !1) return !1;
      var s = OrgChart._json2csv(a.nodes),
        c = {
          ext: a.ext,
          filename: a.filename,
          options: n,
        ...
        o = OrgChart.events.publish(`exportend`, [this, c]);
      if (o === !1) return !1;
      OrgChart._downloadFile(
        `text/csv;charset=utf-8;`,
        `ï»¿` + c.content,
        c.options.filename,
        c.options.openInNewTab,
        c.ext,
      );
    }),
  (OrgChart.prototype.exportToXML = OrgChart.prototype.exportXML =
    function (t) {
      var n = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, `xml`),
        r = this.getNode(n.nodeId),
        i = null;
      r
        ? ((i = []), OrgChart._exportIterateForJSON_XML_CSV(this, r, n, i))
        : n.min === !1 || n.expandChildren === !1
          ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, n, i)
          : (i = JSON.parse(JSON.stringify(this.config.nodes)));
      var a = { ext: `xml`, filename: t, options: n, nodes: i },
        o = OrgChart.events.publish(`exportstart`, [this, a]);
      if (o === !1) return !1;
      var s = OrgChart._json2xml(a.nodes),
        c = {
          ext: a.ext,
          filename: a.filename,
          options: n,
  ...
  (OrgChart.prototype.exportToJSON = OrgChart.prototype.exportJSON =
    function (t) {
      var n = OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON(t, `json`),
        r = this.getNode(n.nodeId),
        i = null;
      r
        ? ((i = []), OrgChart._exportIterateForJSON_XML_CSV(this, r, n, i))
        : n.min === !1 || n.expandChildren === !1
          ? OrgChart._exportIterateForJSON_XML_CSV(this, this.roots, n, i)
          : (i = JSON.parse(JSON.stringify(this.config.nodes)));
      var a = { ext: `json`, filename: n.filename, options: n, nodes: i },
        o = OrgChart.events.publish(`exportstart`, [this, a]);
      if (o === !1) return !1;
      var s = {
          ext: a.ext,
        ...
        o = OrgChart.events.publish(`exportend`, [this, s]);
      if (o === !1) return !1;
      OrgChart._downloadFile(
        `application/json`,
        s.content,
  ...
  (OrgChart._exportIterateForJSON_XML_CSV = function (t, n, r, i) {
    if (Array.isArray(n)) {
      for (var a = 0; a < n.length; a++)
        OrgChart._exportIterateForJSON_XML_CSV(t, n[a], r, i);
      return;
    }
    var o = t.get(n.id);
    if ((i.push(o), r.min))
      for (var a = 0; a < n.stChildrenIds.length; a++)
        OrgChart._exportIterateForJSON_XML_CSV(
          t,
          t.getNode(n.stChildrenIds[a]),
          r,
          i,
        );
    else
      for (var a = 0; a < n.stChildren.length; a++)
        OrgChart._exportIterateForJSON_XML_CSV(t, n.stChildren[a], r, i);
    if (r.expandChildren)
      for (var a = 0; a < n.childrenIds.length; a++)
        OrgChart._exportIterateForJSON_XML_CSV(
          t,
          t.getNode(n.childrenIds[a]),
          r,
          i,
        );
    else
      for (var a = 0; a < n.children.length; a++)
        OrgChart._exportIterateForJSON_XML_CSV(t, n.children[a], r, i);
  }),
  (OrgChart._defaultExportProfileOptionsForCSV_SVG_JSON = function (t, n) {
    return (
      OrgChart.isNEU(t) && (t = {}),
      typeof t == `string` && (t = { filename: t }),
      OrgChart.isNEU(t.filename) && (t.filename = `OrgChart.${n}`),
  ...
  (OrgChart.prototype.exportToPDFProfile = function (e, t) {
    chart.exportToPDF(
      { format: `A4`, pages: [{ nodeId: e, isProfile: !0 }] },
      t,
    );
  }),
  (OrgChart.prototype.exportToVisio = function (t, n) {
    var r = this;
    ((t = OrgChart._setDefaultOptions(t, `vsdx`)),
      this._createExportPages(`vsdx`, t, function (i) {
        for (var a = 0; a < t.pages.length; a++)
          OrgChart.loading.show(t.pages[a].chartInstance);
        r._requestToExportVisio(i, t, function (i) {
          var a = !0;
          if ((n && (a = n(i)), a !== !1)) {
            var a = OrgChart.events.publish(`exportend`, [r, i]);
            if (a === !1) return (OrgChart._exportHideAnimation(t), !1);
            OrgChart._downloadFile(
  ...
  (OrgChart.prototype.exportToPDF = function (t, n) {
    var r = this;
  ...
  (OrgChart.prototype.exportToPNG = function (t, n) {
    var r = this;
  ...
  (OrgChart.prototype.exportToSVG = function (t, n) {
    var r = this;
  ...
  (OrgChart.prototype.exportToPowerPoint = function (t, n) {
    var r = this;
  ...
  (OrgChart._exportHideAnimation = function (t) {
    for (var n = 0; n < t.pages.length; n++)
      OrgChart.loading.hide(t.pages[n].chartInstance);
  }),
  (OrgChart._setDefaultOptions = function (t, n, r) {
    return (
      (t ||= {}),
      (t.type = n),
      t.landscape ??
        (n == `pdf` ? (t.landscape = !1) : n == `pptx` && (t.landscape = !0)),
      (t.header ??= ``),
      (t.expandChildren ??= !1),
      (t.childLevels ??= null),
      (t.parentLevels ??= null),
      ...
      t.format ??
        (n == `pdf` && !r
          ...
          : n == `pdf` && r
            ? (t.format = `A4`)
            : n == `pptx` && (t.format = `Widescreen`)),
      t.footer ??
        (n == `pdf`
          ? t.format == `auto`
            ? (t.footer = ``)
            : (t.footer = `<text style="fill: #aeaeae" x="0" y="15">Page {current-page} of {total-pages}</text>`)
          : n == `png` || n == `svg`
            ? (t.footer = ``)
            : n == `pptx`
              ? (t.footer = `<text style="fill: #aeaeae" x="0" y="15">Slide {current-page} of {total-pages}</text>`)
              : n == `vsdx` && (t.footer = ``)),
      (t.fileName ??= `OrgChart.` + n),
      (t.openInNewTab ??= !1),
      t.width == null &&
        t.height == null &&
        (n == `png` ||
      ...
      (t.margin ??= [30, 20, 30, 20]),
      (t.padding ??= 0),
      (t.pages ||= [{}]),
      t
    );
  }),
  (OrgChart.prototype._requestToExportPDF = function (t, n, r) {
  ...
  (OrgChart.prototype._requestToExportPNG = function (t, n, r) {
    OrgChart.__requestExport(
  ...
  (OrgChart.prototype._requestToExportVisio = function (t, n, r) {
    OrgChart.__requestExport(
  ...
  (OrgChart.prototype._requestToExportSVG = function (t, n, r) {
    OrgChart.__requestExport(
  ...
  (OrgChart.prototype._requestToExportPowerPoint = function (t, n, r) {
    OrgChart.__requestExport(
  ...
  (OrgChart.__requestExport = function (t, n, r, i) {
    var a = { filename: n, pages: r };
    OrgChart._ajax(t, `POST`, JSON.stringify(a), `arraybuffer`, function (e) {
      i(e);
    });
  }),
  (OrgChart.prototype._createExportPages = function (e, t, n) {
    var r = [];
    if (t.pages.length)
      for (var i = 0; i < t.pages.length; i++)
        this.__createExportPages(e, i, r, t, n);
    else n(r);
  }),
  (OrgChart.prototype.__createExportPages = function (t, n, r, i, a) {
    var o = this,
      s = i.pages[n];
    if (
      ((s.chartInstance ||= this),
      s.expandChildren === void 0 && (s.expandChildren = i.expandChildren),
      s.childLevels === void 0 && (s.childLevels = i.childLevels),
      s.parentLevels === void 0 && (s.parentLevels = i.parentLevels),
      s.min === void 0 && (s.min = i.min),
      s.header === void 0 && (s.header = i.header),
      s.footer === void 0 && (s.footer = i.footer),
      s.childLevels != null && (s.expandChildren = !1),
      s.padding === void 0 && (s.padding = i.padding),
      s.margin === void 0 && (s.margin = i.margin),
      s.content != null || s.isProfile === !0)
    ) {
  ...
  (OrgChart.prototype._createMasterSvg = function (t, n, r, i, a) {
    var o = !1;
    n == `` &&
      ((o = !0),
      (n = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="display:block;" width="100" height="100" viewBox="0,0,0,0"><svg>`));
    var s = i.pages[r],
    ...
    var l = OrgChart._getSvgAttributes(n);
    o
      ? i.width == `auto`
        ? (s.width = 1e3)
        : (s.width = i.width)
      : i.width == `auto`
        ? (s.width = l.width + s.margin[3] + s.margin[1])
        : (s.width = i.width);
    var u = document.createElementNS(`http://www.w3.org/2000/svg`, `g`);
    ((u.innerHTML = `${s.header.replaceAll(`{current-page}`, r + 1).replaceAll(`{total-pages}`, i.pages.length)}`),
      c.appendChild(u),
      OrgChart._setYAttrToTextElements(s, i, u));
    var d = u.getBoundingClientRect();
    (d.height && (d.height += 10),
      u.setAttribute(
        `transform`,
        `matrix(1,0,0,1,${s.margin[3]},${s.margin[0]})`,
      ));
    var f = document.createElementNS(`http://www.w3.org/2000/svg`, `g`);
    ((f.innerHTML = `${s.footer.replaceAll(`{current-page}`, r + 1).replaceAll(`{total-pages}`, i.pages.length)}`),
      c.appendChild(f),
      OrgChart._setYAttrToTextElements(s, i, f));
    ...
    if (
      (o
        ...
        : i.height == `auto`
          ? (s.height =
              l.height + s.margin[0] + s.margin[2] + d.height + p.height)
          : (s.height = i.height),
      f.setAttribute(
        `transform`,
        `matrix(1,0,0,1,${s.margin[3]},${s.height - s.margin[2] - p.height})`,
      ),
      c.classList.add(`boc-` + this.config.mode),
      document.body.removeChild(c),
      !s.isProfile)
    ) {
      var m = (s.width - s.margin[3] - s.margin[1]) / l.width,
        h =
          (s.height - s.margin[0] - s.margin[2] - d.height - p.height) /
          l.height,
        g = Math.min(m, h, 1);
      ((l.width *= g),
        (l.height *= g),
        (l.viewBox[0] -= s.padding),
        (l.viewBox[1] -= s.padding),
        (l.viewBox[2] += s.padding * 2),
        (l.viewBox[3] += s.padding * 2),
        (l.x = (s.width - l.width) / 2),
        (l.y =
          s.margin[0] +
          d.height +
          (s.height -
    ...
    var _ = a
        ? OrgChart._isSVG(n)
          ? n
          : `<foreignObject x="0" y="0" width="100%" height="100%">${n}</foreignObject>`
        : OrgChart._setSvgAttributes(n, l),
      v = s.width,
      y = s.height;
    return (
      t == `pdf` && !s.isProfile && ((v += 2), (y += 2)),
      c.setAttribute(`width`, v),
      c.setAttribute(`height`, y),
      (c.innerHTML = _ + c.innerHTML),
      c
    );
  }),
  (OrgChart.prototype._createProfileSvg = function (t, n) {
  ...
  (OrgChart.prototype.___createExportPages = function (t, n, r, i, a) {
    if (n >= i.pages.length - 1) {
      var o = { pages: r, options: i, styles: `` };
      if (OrgChart.events.publish(`exportstart`, [this, o]) === !1) return !1;
      var s = this.mainElement.querySelector(`[data-boc-styles]`);
      if ((s && (o.styles += s.outerHTML), o.styles))
        for (var c = 0; c < o.pages.length; c++) {
          var l = o.pages[c];
          (l.insertAdjacentHTML(`afterbegin`, o.styles),
            (o.pages[c] = l.outerHTML));
        }
      return (
        OrgChart.CONVERT_IMAGES_TO_BASE64_BEFORE_EXPORT
          ? OrgChart._convertImagesToBase64(o.pages).then(function (e) {
              ((o.pages = e), a(o.pages));
            })
          : a(o.pages),
        !0
  ...
  (OrgChart._setYAttrToTextElements = function (e, t, n) {
    for (var r = n.querySelectorAll(`text`), i = 0; i < r.length; i++) {
      ...
      if (a.hasAttribute(`text-anchor`) && !a.hasAttribute(`x`)) {
        var s = a.getAttribute(`text-anchor`).toLowerCase(),
          c = e.width - e.margin[1] - e.margin[3];
        s == `end`
          ? a.setAttribute(`x`, c)
          : s == `middle` && a.setAttribute(`x`, c / 2);
      }
    }
  }),
  (OrgChart.exportUI = function (e) {
    ((this.instance = null),
      (this.interval = null),
      (this.element = null),
      (this.options = null),
      ...
      e == `pdf`
        ...
        : e == `png`
          ...
          : e == `svg`
            ? ((this.locAddNew = `Add new SVG`),
              (this.locRemove = `Remove SVG`))
            : e == `pptx` &&
      ...
      Object.defineProperty(this, `selectedPage`, {
        get() {
          var e =
            this.instance.leftElement.querySelector(`.boc-export-selected`);
          if (e) {
  ...
  (OrgChart.exportUI.prototype.init = function (e) {
    this.instance = e;
  }),
  ...
  (OrgChart.exportUI.prototype.hide = function () {
    ((this.instance.leftElement.style.display = `none`),
      (this.element &&=
        (this.element.parentNode.removeChild(this.element), null)));
  }),
  ...
  (OrgChart.exportUI.prototype._init = function (t) {
    ...
    (this.type == `pdf` &&
      ...
      (r = `<button ${this.buttons.landscapePortrait ? `` : `style="display: none;"`} data-boc-export-landcapeportrait>${this.options.landscape ? this.locPortrait : this.locLandscape}</button> `),
    ...
    (i &&
      ...
      this.instance.leftElement
        ...
        .addEventListener(`click`, function (e) {
          for (
            var t = e.target;
            t && t.hasAttribute && !t.hasAttribute(`data-boc-export-page`);
          )
            t = t.parentNode;
          var r;
          (t &&
            t.hasAttribute &&
            t.hasAttribute(`data-boc-export-page`) &&
            (r = t.getAttribute(`data-boc-export-page`)),
            e.target.hasAttribute &&
              (e.target.hasAttribute(`data-export-remove`)
                ? n.removePage(r)
                : e.target.hasAttribute(`data-export-child-plus`)
                  ? n._incrementDecrementChildLevel(r, !0)
                  : e.target.hasAttribute(`data-export-child-minus`)
                    ? n._incrementDecrementChildLevel(r, !1)
                    : e.target.hasAttribute(`data-export-parent-plus`)
                      ? n._incrementDecrementParentLevel(r, !0)
                      : e.target.hasAttribute(`data-export-parent-minus`)
                        ? n._incrementDecrementParentLevel(r, !1)
                        : e.target.hasAttribute(`data-export-profiletree`)
                          ? n.toggelePrintTreeOrProfile(r, !1)
                          : n.selectPage(r)));
        }));
    ...
    (o &&
      o.addEventListener(`click`, function (e) {
        n.instance.powerPointPreviewUI.isVisible()
          ? n.instance.exportToPowerPoint(n.options)
          : n.instance.pdfPreviewUI.isVisible()
            ? n.instance.exportToPDF(n.options)
            : n.instance.pngPreviewUI.isVisible()
              ? n.instance.exportToPNG(n.options)
              : n.instance.svgPreviewUI.isVisible() &&
                n.instance.exportToSVG(n.options);
      }),
      (this.interval &&= (clearTimeout(this.interval), null)),
      (this.interval = OrgChart.animate(
        this.element,
        { opacity: 0 },
        { opacity: 1 },
  ...
  (OrgChart.exportUI.prototype._draw = function (t) {
    ...
    for (var r = 0; r < t.length; r++) {
      var i = t[r],
        a = this.options.pages[r].width / this.options.pages[r].height,
        o = OrgChart._getSvgAttributes(i);
      ((o.viewBox[0] = 0),
        (o.viewBox[1] = 0),
        (o.viewBox[2] = o.width),
        (o.viewBox[3] = o.height),
        (o.width = `100%`),
        (o.height = `100%`));
      var s = OrgChart._setSvgAttributes(i, o),
        c = OrgChart._getSvgAttributes;
      ...
      (this.type == `pdf` &&
        ...
        (l += `<div ${this.buttons.printProfileOrTree ? `` : `style="display: none;"`} class="boc-export-profiletree-buttons">                    
        ...
        !this.options.pages[r].isProfile &&
          !OrgChart.isNEU(this.options.pages[r].nodeId) &&
          (l =
            `<div ${this.buttons.parentLevels ? `` : `style="display: none;"`} class="boc-export-parent-buttons">                    
        ...
        (n.innerHTML += `<div data-boc-export-page="${r}" style="aspect-ratio: ${a};" class="boc-export-page ${c}">
                                            ${s}
                                            ${l}                                                                                                                     
                                        </div>`));
    }
  ...
  (OrgChart.exportUI.prototype.toggleLanscape = function () {
    ...
    ((this.options.landscape = !this.options.landscape),
      ...
      (this.options = OrgChart._setDefaultOptions(
        this.options,
        this.type,
        !0,
      )));
    var n = this.instance.leftElement.querySelector(
      `[data-boc-export-landcapeportrait]`,
    );
    ((n.innerHTML = this.options.landscape
      ? this.locPortrait
      : this.locLandscape),
      this.instance._createExportPages(this.type, this.options, function (e) {
  ...
  (OrgChart.exportUI.prototype.removePage = function (e) {
    e = parseInt(e);
    var t = this;
    (e <= t.selectedIndex &&
      (t.selectedIndex--, t.selectedIndex < 0 && (t.selectedIndex = 0)),
      this.options.pages.splice(e, 1),
      this.instance._createExportPages(this.type, this.options, function (e) {
        (t._draw(e), t.selectPage(t.selectedIndex));
      }));
  }),
  (OrgChart.exportUI.prototype._incrementDecrementChildLevel = function (e, t) {
    var n = this;
    e < n.selectedIndex && n.selectedIndex--;
    var r = this.options.pages[e];
    (r.childLevels ?? (t ? (r.childLevels = 0) : (r.childLevels = 2)),
      t ? r.childLevels++ : r.childLevels--,
      r.childLevels == -1 && (r.childLevels = 0),
      (r.expandChildren = !1),
      this.instance._createExportPages(this.type, this.options, function (e) {
        (n._draw(e), n.selectPage(n.selectedIndex));
      }));
  }),
  (OrgChart.exportUI.prototype.toggelePrintTreeOrProfile = function (e) {
    var t = this,
      n = this.options.pages[e];
    ((n.isProfile = !n.isProfile),
      (this.options.pages[e].content = void 0),
      this.instance._createExportPages(this.type, this.options, function (e) {
        (t._draw(e), t.selectPage(t.selectedIndex));
      }));
  }),
  (OrgChart.exportUI.prototype._incrementDecrementParentLevel = function (
    ...
    (r.parentLevels == null
      ...
      : t
        ? r.parentLevels++
        : r.parentLevels--,
      r.parentLevels == -1 && (r.parentLevels = 0),
      this.instance._createExportPages(this.type, this.options, function (e) {
        (n._draw(e), n.selectPage(n.selectedIndex));
      }));
  }),
  (OrgChart.exportUI.prototype.selectPage = function (e) {
    for (
      var t = this.instance.leftElement.querySelectorAll(
      ...
      t[n].classList.remove(`boc-export-selected`);
    for (
      var t = this.instance.leftElement.querySelectorAll(`.boc-export-select`),
        n = 0;
      n < t.length;
      n++
    )
      t[n].parentNode.removeChild(t[n]);
    var r = this.instance.leftElement.querySelectorAll(
      `[data-boc-export-pages] .boc-export-page`,
    );
    if (r.length) {
      var i = r[e];
      (i.classList.contains(`boc-export-empty`) &&
        (i.innerHTML += `<div class="boc-export-select">${this.locClickToAdd}</div>`),
        i.classList.add(`boc-export-selected`),
    ...
    return {
      on: function (e, n, r) {
        (Array.isArray(t[e]) || (t[e] = []),
          t[e].push({ listener: n, event_id: r }));
      },
      ...
      removeForEventId: function (e) {
        for (var n in t)
          if (Array.isArray(t[n]))
            for (var r = t[n].length - 1; r >= 0; r--)
              t[n][r].event_id == e && t[n].splice(r, 1);
      },
      publish: function (e, n) {
        if (t[e]) {
          for (var r = [], i = 0; i < t[e].length; i++) {
            var a = t[e][i];
            (a.event_id == null || a.event_id == n[0]._event_id) &&
              r.push(a.listener);
          }
          if (r.length > 0) {
            for (
              ...
              (n.length == 1
                ...
                : n.length == 2
                  ...
                  : n.length == 3
                    ? (o = r[i](n[0], n[1], n[2]) && o)
                    : n.length == 4
                      ? (o = r[i](n[0], n[1], n[2], n[3]) && o)
                      : n.length == 5 &&
                        (o = r[i](n[0], n[1], n[2], n[3], n[4]) && o),
              o !== !1);
              i++
            );
            return o;
  ...
  (OrgChart.prototype.importCSV = function () {
    ...
    (n.setAttribute(`type`, `file`),
      ...
      (n.onchange = function (n) {
        ...
        ((i.onload = function () {
          var n = i.result,
            r = OrgChart._csvToArray(n),
            a = [],
            o = r[0];
          OrgChart._importSetColumnNames(o, function (n) {
            for (var i = 1; i < r.length; i++) {
              for (var o = {}, s = 0; s < r[i].length; s++) {
                var c = n[s],
                  l = r[i][s];
                o[c] = OrgChart._convertStringToArray(c, l);
              }
              o.id.trim() != `` && a.push(o);
            }
            var u = { nodes: a, columnNames: r[0] };
            OrgChart.events.publish(`import`, [t, u]) != 0 &&
              (t._putInUndoStack(),
              t.clearRedo(),
              (t.config.nodes = u.nodes),
              t._ai.setContext(),
  ...
  (OrgChart._importSetColumnNames = function (t, n) {
    ...
    ((l.style.height = `0.1px`),
      ...
      (c.style.left = a.offsetWidth - 20 + `px`));
    var u = document.createElement(`div`);
    (u.setAttribute(`id`, `overlay`),
      (u.style.width = `100%`),
      (u.style.height = `100%`),
      (u.style.left = 0),
      (u.style.top = 0),
    ...
    var d = document.createElement(`LABEL`),
      f = document.createTextNode(`Name:`);
    ...
    var v = document.createElement(`LABEL`),
      y = document.createTextNode(`Reports to:`);
    (v.setAttribute(`for`, `pid-select`),
      v.appendChild(y),
    ...
    ((x.innerHTML = `Import`),
      ...
      (x.onclick = function () {
        ...
        var e = p.options[p.selectedIndex].value,
          r = t.indexOf(e);
        t[r] = `id`;
        var i = b.options[b.selectedIndex].value,
          o = t.indexOf(i);
        ((t[o] = `pid`), n(t));
      }));
  ...
  (OrgChart._importCenter = function (e) {
    e &&
  ...
  (OrgChart.prototype.importXML = function () {
    ...
    (n.setAttribute(`type`, `file`),
      ...
      (n.onchange = function (n) {
        ...
        ((i.onload = function () {
          var n = i.result,
            r = OrgChart._xml2json(n);
          OrgChart.events.publish(`import`, [t, r]) != 0 &&
            (t._putInUndoStack(),
            t.clearRedo(),
            (t.config.nodes = r),
            t._ai.setContext(),
  ...
  (OrgChart.prototype.expand = function (t, n, r) {
    if (
      (this._treeListExpandCollapseHandler(t),
      this._resetMovableNodes(),
      (n = this._filterOnlyExistingAndCallOnDemandForOthers(t, n)),
      n.length)
    ) {
      var i = { id: t, ids: n };
  ...
  (OrgChart.prototype.collapse = function (t, n, r) {
    (this._treeListExpandCollapseHandler(t), this._resetMovableNodes());
    var i = { id: t, ids: n };
    this._draw(!1, OrgChart.action.collapse, i, r);
  }),
  (OrgChart.prototype.expandCollapse = function (t, n, r, i) {
    (this._treeListExpandCollapseHandler(t),
      this._resetMovableNodes(),
      Array.isArray(n) || (n = []),
      Array.isArray(r) || (r = []),
      (n = this._filterOnlyExistingAndCallOnDemandForOthers(t, n)));
    var a = { id: t, expandIds: n, collapseIds: r, ids: n.concat(r) };
    this._draw(!1, OrgChart.action.collapse, a, i);
  }),
  (OrgChart.prototype.changeRoots = function (t, n, r) {
    this.config.roots = n;
    var i = { id: t, changeRoots: n };
    this._draw(!1, OrgChart.action.update, i, r);
  }),
  (OrgChart.prototype._filterOnlyExistingAndCallOnDemandForOthers = function (
    t,
    n,
  ) {
    var r = [],
    ...
    return (
      r.length &&
        OrgChart.events.publish(`on-demand`, [this, { ids: r, id: t }]),
      i
    );
  }),
  ...
  (OrgChart.prototype._expCollHandler = function (t) {
    ...
    if (n.collapsedChildrenIds.length) {
      var r = OrgChart.events.publish(`expcollclick`, [
        this,
        !1,
        t,
  ...
  (OrgChart.prototype._upHandler = function (t) {
    ...
    if (OrgChart.events.publish(`up-click`, [this, n]) === !1) return !1;
  ...
  (OrgChart.prototype._upHandlerCreateArgs = function (t) {
    ...
    if ((i && (a = i), a)) {
      ...
      OrgChart.events.publish(`on-demand`, [this, { ids: [n.pid], id: n.id }]);
    return { id: n.id, roots: r };
  }),
  ...
  (OrgChart.prototype._clickHandler = function (t, n) {
    if (!(n.button > 0)) {
      for (var r = n.target; r != t; ) {
        ...
        if (r.hasAttribute(OrgChart.attr.control_node_menu_id)) {
          ...
          var i = r.getAttribute(OrgChart.attr.control_node_menu_id),
            a = this.getNode(i);
          this._nodeMenuClickHandler(a.id, r, n);
          return;
        }
        if (r.hasAttribute(OrgChart.attr.control_node_btn)) {
          (n.stopPropagation(), n.preventDefault());
          for (
            var o = r.getAttribute(OrgChart.attr.control_node_btn);
            !r.hasAttribute(OrgChart.attr.node_id);
          )
            r = r.parentNode;
          var i = r.getAttribute(OrgChart.attr.node_id);
          OrgChart._onClickHandler(this, o, void 0, i, void 0);
          return;
        }
        if (r.hasAttribute(OrgChart.attr.control_node_circle_menu_id)) {
          (n.stopPropagation(), n.preventDefault());
          var i = r.getAttribute(OrgChart.attr.control_node_circle_menu_id);
        ...
        if (r.hasAttribute(OrgChart.attr.s_link_from)) {
          OrgChart.events.publish(`slink-click`, [
            this,
            {
      ...
      OrgChart.events.publish(`canvas-click`, [this, { event: n }]);
    }
  }),
  (OrgChart.prototype._mouseDownHandler = function (t, n, r, i) {
    var a = this;
    (OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE &&
      ...
      this.nodeContextMenuUI.hide(),
      this.menuUI.hide());
    var o = this.getViewBox(),
      s = this.getScale(),
      c = OrgChart._getClientTouchesXY(n, 0),
      l = OrgChart._getClientTouchesXY(n, 1),
      u = {
        diffX: 0,
        diffY: 0,
        x0: c.x,
    ...
    n.touches &&
      ...
      ((u.type = `pinch`),
      (u.dist = Math.sqrt(
        (c.x - l.x) * (c.x - l.x) + (c.y - l.y) * (c.y - l.y),
      )));
    var d = null;
    if (i) {
    ...
    var p = 0,
      m = function (t) {
        var n = OrgChart._getClientTouchesXY(t, 0);
        if (u && u.type == `pan`) {
          (clearTimeout(a._timeout),
            (u.diffX = n.x - u.x0),
            (u.diffY = n.y - u.y0),
            (p = Math.max(Math.abs(u.diffY), Math.abs(u.diffX))));
          var r = -(u.diffY / s) + u.viewBoxTop,
            c = -(u.diffX / s) + u.viewBoxLeft;
          p > 3 &&
            (i
              ? ((i.treeList.scrollTop = u.scrollTop - u.diffY / s),
                (a._treeListUpdateInterval &&=
                  (clearInterval(a._treeListUpdateInterval), null)),
                a._treeListUpdate(i, d))
              : (a._hideBeforeAnimation(),
                a._changeCursorOnPanStart(o, s, t),
                a._move(r, c, o)));
          ...
          var l = OrgChart._getClientTouchesXY(t, 1),
            ...
            m = 1 + (f - u.dist) / (u.dist / 100) / 100;
          u.dist = f;
          var h = OrgChart._pinchMiddlePointInPercent(
            a.element,
            a.width(),
            a.height(),
            t,
      ...
      h = function (n) {
        if (
          p < 3 &&
          u.type != `pinch` &&
          (n.touches == null || n.touches.length <= 1)
        )
          a._clickHandler(t, n);
        else if (u.type == `pan` && i) {
          var o = Date.now() - u.time,
            s = Math.abs(p / o);
          if (s > 0.5) {
            var c = i.treeList.scrollTop,
              l = c + s * 400 * (u.diffY > 0 ? -1 : 1),
              f = i.stChildren[0].h;
            ((l = Math.round(l / f) * f),
              l != c &&
                ((a._treeListUpdateInterval &&=
                  (clearInterval(a._treeListUpdateInterval), null)),
                (a._treeListUpdateInterval = OrgChart.animate(
                  null,
                  {},
                  {},
                  1500,
                  ...
                  function () {},
                  function (e) {
                    ((i.treeList.scrollTop = e * (l - c) + c),
                      a._treeListUpdate(i, d.orientation));
                  },
                ))));
          } else {
            var c = i.treeList.scrollTop,
              f = i.stChildren[0].h,
              l = Math.round(i.treeList.scrollTop / f) * f;
            l != c &&
              ((a._treeListUpdateInterval &&=
                (clearInterval(a._treeListUpdateInterval), null)),
              (a._treeListUpdateInterval = OrgChart.animate(
          ...
          u.type == `pan` && !i && p > 10 && a._draw(!0, OrgChart.action.pan);
        (u.type == `pan` && !i && a._changeCursorOnPanEnd(),
          (u = null),
          t.removeEventListener(r.move, m),
          t.removeEventListener(r.up, h),
          r.leave && t.removeEventListener(r.leave, h),
          r.touchstart && t.removeEventListener(r.touchstart, h));
      };
    (t.addEventListener(r.move, m, { passive: !0 }),
      t.addEventListener(r.up, h),
      r.leave && t.addEventListener(r.leave, h),
      r.touchstart && t.addEventListener(r.touchstart, h, { passive: !0 }));
  }),
  (OrgChart.prototype._changeCursorOnPanStart = function (t, n, r) {
    var i = this.getPointerElement();
    if (i) {
      var a = OrgChart._getOffsetXY(this.element, r),
        o = a.x / n + t[0] - 16 / n,
        s = a.y / n + t[1] - 16 / n;
      ((i.style.display = `inherit`),
        i.setAttribute(`transform`, `matrix(0,0,0,0,` + o + `,` + s + `)`),
        OrgChart.animate(
          i,
          { transform: [0, 0, 0, 0, o, s], opacity: 0 },
          { transform: [1 / n, 0, 0, 1 / n, o, s], opacity: 1 },
          300,
          OrgChart.anim.outBack,
        ));
  ...
  (OrgChart.prototype._globalMouseDownHandler = function (t, n) {
    var r = { move: `mousemove`, up: `mouseup`, leave: `mouseleave` };
    (n.type.indexOf(`touch`) != -1 &&
      (n.touches.length == 1
        ? (this._touch = { x: n.touches[0].clientX, y: n.touches[0].clientY })
        : (this._touch = null),
      (r = { move: `touchmove`, up: `touchend`, touchstart: `touchstart` })),
      (this._treeListUpdateInterval &&=
        (clearInterval(this._treeListUpdateInterval), null)));
    for (
      var i = null, a = n.target;
      a != t &&
      !a.hasAttribute(OrgChart.attr.control_node_menu_id) &&
      !a.hasAttribute(OrgChart.attr.control_node_btn) &&
      !a.hasAttribute(OrgChart.attr.control_node_circle_menu_id);
    ) {
      if (a.hasAttribute) {
        var o = null;
        (a.hasAttribute(OrgChart.attr.node_id)
          ? (o = this.getNode(a.getAttribute(OrgChart.attr.node_id)))
          : a.hasAttribute(OrgChart.attr.control_expcoll_id)
            ? (o = this.getNode(
                a.getAttribute(OrgChart.attr.control_expcoll_id),
              ))
            : a.hasAttribute(OrgChart.attr.control_node_menu_id)
              ? (o = this.getNode(
                  a.getAttribute(OrgChart.attr.control_node_menu_id),
                ))
              : a.hasAttribute(OrgChart.attr.control_node_btn) &&
                (o = this.getNode(
                  a.getAttribute(OrgChart.attr.control_node_btn),
                )),
          (i ||= OrgChart._getScrollableTreeListNodeInTouchEnabledDevice(o)));
      }
      if (
        a.hasAttribute(OrgChart.attr.node_id) &&
        !i &&
      ...
      } else if (a.hasAttribute(OrgChart.attr.control_node_circle_menu_name)) {
        if ((n.stopPropagation(), n.touches == null || n.touches.length <= 1)) {
          this._nodeCircleNodeMenuItemMouseDownHandler(t, a, n, r);
          return;
        }
      } else if (
        a.hasAttribute(`data-treelist-thumb`) &&
        (n.stopPropagation(), n.touches == null || n.touches.length <= 1)
      ) {
  ...
  (OrgChart.prototype._globalContextHandler = function (t, n) {
    for (var r = n.target; r != t; ) {
      if (r.hasAttribute(OrgChart.attr.node_id)) {
        var i = r.getAttribute(OrgChart.attr.node_id),
          a = this.getNode(i);
  ...
  (OrgChart.prototype._nodeContextHandler = function (t, n) {
    (n.preventDefault(),
      OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE &&
        this.searchUI.hide(),
      this.nodeMenuUI.hide(),
    ...
    var r = this.get(t),
      i = null;
    if (r != null && Array.isArray(r.tags))
  ...
  (OrgChart.prototype._globalDbClickHandler = function (t, n) {
    for (var r = n.target; r != t; ) {
      if (r.hasAttribute(OrgChart.attr.node_id)) {
        var i = r.getAttribute(OrgChart.attr.node_id),
          a = this.getNode(i);
  ...
  (OrgChart.prototype._mouseScrollHandler = function (e, t) {
    for (
      var n = !1, r = t.target, i = null;
      r &&
      r.hasAttribute &&
      !r.hasAttribute(`data-n-id`) &&
      !r.hasAttribute(`data-ctrl-ec-id`);
    )
      r = r.parentNode;
    ...
    (t.ctrlKey && (n = !1),
      n
        ? this.__mouseScrollHandlerTreeList(i, t)
        : this.__mouseScrollHandler(this.getSvg(), t));
  }),
  (OrgChart.prototype.__mouseScrollHandler = function (t, n) {
    if (n.ctrlKey) {
      if (this.config.mouseScroll == OrgChart.action.zoom) return;
    } else if (
      this.config.mouseScroll == OrgChart.action.ctrlZoom ||
      this.config.mouseScroll != OrgChart.action.zoom
    )
      return;
    if (
      (n.preventDefault(),
      ...
      let i = n.deltaY / 1e3;
      i = Math.abs(i) < 0.1 ? (0.1 * n.deltaY) / Math.abs(n.deltaY) : i;
      var r = OrgChart._centerPointInPercent(t, n.clientX, n.clientY);
      this.zoom(1 - i, r);
    } else {
      var i = this,
        a = !1,
        o = this.config.zoom.speed,
        s = this.config.zoom.smooth,
        c = 0,
        l = this.getScale(),
        r = OrgChart._centerPointInPercent(t, n.clientX, n.clientY);
      function f() {
        a = !0;
        var e = (c - l) / s;
        (e > 0 ? e++ : e--,
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    var a = n.parentNode.getAttribute(
        OrgChart.attr.control_node_circle_menu_wrraper_id,
      ),
      o = n.getAttribute(OrgChart.attr.control_node_circle_menu_name),
      s = this.nodeCircleMenuUI._menu[o];
    if (!s.draggable) {
    ...
    var m = this.getSvg(),
      ...
      g = function (t) {
        ...
        var n = OrgChart._getTransform(t);
        return { x: n[4], y: n[5] };
      },
      _ = n.cloneNode(!0);
    m.insertBefore(_, m.firstChild);
    var v = OrgChart._getTransform(_),
      y = v[4],
      b = v[5],
      x = g(n);
    (_.setAttribute(
      `transform`,
      `matrix(1,0,0,1,` + (y + x.x) + `,` + (b + x.y) + `)`,
    ),
      (_.style.opacity = 0.7));
    var S = function (t, n) {
        if (t != null) {
          ...
          for (
            var r = OrgChart.getStParentNodes(c.getNode(f)), i = 0;
            i < r.length;
            i++
          ) {
      ...
      C = function (t) {
        if (h) {
          ...
          (OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y)),
            (r.x += x.x * d),
            (r.y += x.y * d));
          var a = OrgChart._getOffsetXY(c.element, t),
            l = {
          ...
          if (l.left || l.right || l.up || l.down) {
            m.classList &&
              (m.classList.remove(`boc-cursor-grab`),
              m.classList.add(`boc-cursor-move`),
              m.classList.remove(`boc-cursor-nodrop`),
              m.classList.remove(`boc-cursor-copy`));
            var u = v[4],
              g = v[5],
              C = h.x,
              T = h.y,
            ...
            c.moveStart(l, function (e) {
              ((v[4] = u + e.x),
                (v[5] = g + e.y),
                (h.x = C - e.xWithoutScale),
                (h.y = T - e.yWithoutScale),
                (r.x = E - e.xWithoutScale),
                (r.y = D - e.yWithoutScale),
                _.setAttribute(`transform`, `matrix(` + v.toString() + `)`));
            });
          } else {
            for (
              c.moveEnd(),
                m.classList &&
                  (m.classList.add(`boc-cursor-grab`),
                  m.classList.remove(`boc-cursor-move`),
                  m.classList.remove(`boc-cursor-nodrop`),
                  m.classList.remove(`boc-cursor-copy`)),
                S(f, p),
                f = null,
              ...
              if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                var O = i.getAttribute(OrgChart.attr.node_id);
                ((f = O), (p = i));
                break;
              }
              i = i.parentNode;
            ...
            if (f != null) {
              ...
              for (
                var k = c.getNode(f), A = OrgChart.getStParentNodes(k), j = 0;
                j < A.length;
                j++
              ) {
              ...
              (m.classList.remove(`boc-cursor-grab`),
                m.classList.remove(`boc-cursor-move`),
                m.classList.add(`boc-cursor-copy`),
                m.classList.remove(`boc-cursor-nodrop`));
            }
            var N = (r.x - h.x) / d,
              P = (r.y - h.y) / d;
            ((v[4] = y + N),
              (v[5] = b + P),
              !n._dragEventFired &&
                (Math.abs(r.x - h.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                  Math.abs(r.y - h.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE) &&
                ((c._gragStartedId = n.parentNode.getAttribute(
                  OrgChart.attr.control_node_circle_menu_wrraper_id,
                )),
                OrgChart.events.publish(`drag`, [
                  c.nodeCircleMenuUI,
                  { from: O, menuItem: s, menuItemName: o },
                ]) === !1 && w(),
                (n._dragEventFired = !0)),
              _.setAttribute(`transform`, `matrix(` + v.toString() + `)`));
          }
      ...
      w = function (t) {
        if (
          ...
          m.classList &&
            ...
            m.classList.remove(`boc-cursor-nodrop`),
            m.classList.remove(`boc-cursor-copy`)),
          m.removeEventListener(i.move, C),
          m.removeEventListener(i.up, w),
          i.leave && m.removeEventListener(i.leave, w),
          u.id == f || f == null)
        ) {
          (m.removeChild(_),
            (c._gragStartedId = null),
            n._dragEventFired &&
              OrgChart.events.publish(`drop`, [
                c.nodeCircleMenuUI,
                { from: u.id, menuItemName: o, menuItem: s, event: t },
              ]));
          return;
        }
        var r = c.getNode(f);
        (OrgChart.events.publish(`drop`, [
          c.nodeCircleMenuUI,
          { from: u.id, to: r.id, menuItem: s, menuItemName: o, event: t },
        ]),
          S(f, p),
          m.removeChild(_),
          (c._gragStartedId = null));
      };
    (m.addEventListener(i.move, C),
      m.addEventListener(i.up, w),
      i.leave && m.addEventListener(i.leave, w));
  }),
  (OrgChart.prototype._nodeMouseDownHandler = function (t, n, r) {
    var i = t.getAttribute(OrgChart.attr.node_id),
      a = this.getNode(i);
    this.config.movable && !OrgChart.getRootOf(a).stParent
      ? this._movableHandler(t, n, r)
      : this.config.enableDragDrop && this._dragDropHandler(t, n, r);
  }),
  (OrgChart.prototype._resizeHandler = function (t, n) {
    if (this.isVisible && !(t == 0 || n == 0)) {
      ...
      if (r) {
        ...
        var i = t / r[2],
          a = n / r[3];
        (Math.abs(this._lastSize.width - t) >
        Math.abs(this._lastSize.height - n)
          ? (r[3] = n / i)
          : (r[2] = t / a),
          this.nodeMenuUI.hide(),
          this.nodeContextMenuUI.hide(),
          ...
          this.yScrollUI.create(n),
          this._draw(!0, OrgChart.action.resize));
      }
    }
  }),
  (OrgChart.prototype._nodeDbClickHandler = function (t, n) {
    if (OrgChart.events.publish(`dbclick`, [this, this.get(t)]) === !1)
      return !1;
    this._commonClickHandler(t, n, this.config.nodeMouseDbClick);
  }),
  (OrgChart.prototype._nodeClickHandler = function (t, n) {
    if (
      OrgChart.events.publish(`click`, [
        this,
        { node: this.getNode(t), event: n },
      ]) === !1
    )
      return !1;
    if (
      this.powerPointPreviewUI.isVisible() &&
      this.powerPointPreviewUI.selectedPage != null
    ) {
      ((this.powerPointPreviewUI.selectedPage.content = void 0),
        ...
        this.ripple(t, n.clientX, n.clientY));
      return;
    }
    if (
      this.pdfPreviewUI.isVisible() &&
      this.pdfPreviewUI.selectedPage != null
    ) {
    ...
    if (
      this.svgPreviewUI.isVisible() &&
      this.svgPreviewUI.selectedPage != null
    ) {
    ...
    if (
      this.pngPreviewUI.isVisible() &&
      this.pngPreviewUI.selectedPage != null
    ) {
  ...
  (OrgChart.prototype._nodeCircleMenuItemClickHandler = function (t, n) {
    ...
    OrgChart.events.publish(`click`, [
      ...
      { nodeId: r, menuItemName: i, menuItem: a, event: n },
    ]);
  }),
  ...
  (OrgChart.prototype._commonClickHandler = function (t, n, r) {
    if (
      (OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE &&
        this.searchUI.hide(),
      this.nodeMenuUI.hide(),
      ...
      this.menuUI.hide(),
      this.nodeCircleMenuUI.hide(),
      r == OrgChart.action.expandCollapse && this.toggleExpandCollapse(t, n),
    ...
    if (r == OrgChart.action.details) {
      var i = this.getNode(t);
      i &&
        (this.editUI.show(i.id, !0), this.ripple(i.id, n.clientX, n.clientY));
    }
  }),
  (OrgChart.prototype._menuHandlerMouseDownHandler = function (e, t) {
    (t.stopPropagation(), t.preventDefault());
  }),
  (OrgChart.prototype._nodeMenuClickHandler = function (t, n, r) {
    (OrgChart.SEARCH_CLOSE_RESULT_ON_ESCAPE_OR_CLICKOUTSIDE &&
      this.searchUI.hide(),
      this.nodeMenuUI.hide(),
      this.nodeContextMenuUI.hide(),
    ...
    if (Array.isArray(i.tags))
      for (var o = 0; o < i.tags.length; o++) {
        var s = i.tags[o];
        this.config.tags[s] &&
          this.config.tags[s].nodeMenu &&
          (a = this.config.tags[s].nodeMenu);
      }
    this.nodeMenuUI.showStickIn(n, t, null, a);
  }),
  (OrgChart.prototype._menuClickHandler = function (e, t) {
    (t.stopPropagation(),
      t.preventDefault(),
      this.nodeMenuUI.hide(),
      this.nodeContextMenuUI.hide(),
  ...
  (OrgChart.prototype.toggleExpandCollapse = function (t, n) {
    var r = this.getNode(t);
    if (r.collapsedChildrenIds.length) {
      var i = OrgChart.events.publish(`expcollclick`, [
        this,
        !1,
        t,
  ...
  (OrgChart.prototype._dragDropHandler = function (t, n, r) {
    var i = OrgChart._getClientXY(n),
    ...
    var l = this,
      u = this.getSvg(),
      d = { x: i.x, y: i.y },
      f = OrgChart._getTransform(t),
      p = f[4],
      m = f[5],
      h = l.getScale(),
      g = t.cloneNode(!0);
    (g.setAttribute(`data-n-id`, `draging`),
    ...
    var _ = function (t, n) {
        if (t != null) {
          n.classList.remove(`boc-drag-over`);
          for (
            var r = l.getNode(s), i = OrgChart.getStParentNodes(r), a = 0;
            a < i.length;
            a++
          ) {
      ...
      v = function (n) {
        ...
        if (d) {
          var r = OrgChart._getClientXY(n),
            i = n.target;
          OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y));
          var a = OrgChart._getOffsetXY(l.element, n),
            v = {
          ...
          if (v.left || v.right || v.up || v.down) {
            u.classList &&
              (u.classList.remove(`boc-cursor-grab`),
              u.classList.add(`boc-cursor-move`),
              u.classList.remove(`boc-cursor-nodrop`),
              u.classList.remove(`boc-cursor-copy`));
            var b = f[4],
              x = f[5],
              S = d.x,
              C = d.y,
            ...
            l.moveStart(v, function (e) {
              ((f[4] = b + e.x),
                (f[5] = x + e.y),
                (d.x = S - e.xWithoutScale),
                (d.y = C - e.yWithoutScale),
                (r.x = w - e.xWithoutScale),
                (r.y = T - e.yWithoutScale),
                g.setAttribute(`transform`, `matrix(` + f.toString() + `)`));
            });
          } else {
            if (
              (l.moveEnd(),
              u.classList &&
                (u.classList.add(`boc-cursor-grab`),
                u.classList.remove(`boc-cursor-move`),
                u.classList.remove(`boc-cursor-nodrop`),
                u.classList.remove(`boc-cursor-copy`)),
              _(s, c),
              (s = null),
              ...
              for (; i != null && i != u; ) {
                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                  var E = i.getAttribute(OrgChart.attr.node_id);
            ...
            if ((s == `draging` && ((s = null), (c = null)), s != null)) {
              ...
              for (
                var D = l.getNode(s), O = OrgChart.getStParentNodes(D), k = 0;
                k < O.length;
                k++
              ) {
              ...
              !l.canUpdateLink(o.id, s) && u.classList
                ? (u.classList.remove(`boc-cursor-grab`),
                  u.classList.remove(`boc-cursor-move`),
                  u.classList.remove(`boc-cursor-copy`),
                  u.classList.add(`boc-cursor-nodrop`))
                : u.classList &&
                  (u.classList.remove(`boc-cursor-grab`),
                  u.classList.remove(`boc-cursor-move`),
                  u.classList.add(`boc-cursor-copy`),
                  u.classList.remove(`boc-cursor-nodrop`));
            }
            var j = (r.x - d.x) / h,
              M = (r.y - d.y) / h;
            ((f[4] = p + j),
              ...
              !t._dragEventFired &&
                ...
                ((l._gragStartedId = E),
                OrgChart.events.publish(`drag`, [l, E, n]) === !1 && y(),
                (t._dragEventFired = !0)),
              g.setAttribute(`transform`, `matrix(` + f.toString() + `)`));
          }
        }
      ...
      y = function (n) {
        if (
          ...
          u.classList &&
            ...
            u.classList.remove(`boc-cursor-nodrop`),
            u.classList.remove(`boc-cursor-copy`)),
          u.removeEventListener(r.move, v),
          u.removeEventListener(r.up, y),
          r.leave && u.removeEventListener(r.leave, y),
          o.id == s || s == null)
        ) {
          (t._dragEventFired &&
            OrgChart.events.publish(`drop`, [l, o.id, void 0, g, n]),
            u.removeChild(g),
            (l._gragStartedId = null));
          return;
        }
        var i = l.getNode(s);
        if (OrgChart.events.publish(`drop`, [l, o.id, i.id, g, n]) === !1) {
        ...
        if (l.canUpdateLink(o.id, s)) {
          ...
          ((a.pid = s),
            (a.stpid = null),
            a.movex != null && (a.movex = void 0),
            a.movey != null && (a.movey = void 0),
            l.updateNode(a, null, !0));
        } else (u.removeChild(g), _(s, c));
        l._gragStartedId = null;
      };
    (u.addEventListener(r.move, v),
      u.addEventListener(r.up, y),
      r.leave && u.addEventListener(r.leave, y));
  }),
  (OrgChart.prototype._movableHandler = function (t, n, r) {
    var i = this,
      a = t.getAttribute(OrgChart.attr.node_id),
      o = [],
      s = function (e, t) {
      ...
      c = function (e, t) {
        ...
        t.push(e.id);
        for (var n = 0; n < e.stChildrenIds.length; n++)
          c(i.getNode(e.stChildrenIds[n]), t);
        for (var n = 0; n < e.childrenIds.length; n++)
          c(i.getNode(e.childrenIds[n]), t);
      },
      l = this.getNode(a);
    s(l, o);
    for (
      var u = this.getSvg(),
        d = OrgChart._getClientXY(n),
        f = [],
        p = [],
        m = [],
        h = [],
      ...
      (f.push(x), m.push({ x: x.x, y: x.y }));
      var S = this.getNodeElement(o[b]);
      if (S) {
        g.push(S);
        var C = OrgChart._getTransform(S);
        (h.push({ x: C[4], y: C[5] }), p.push(C));
        var w = this.element.querySelector(`[data-ctrl-ec-id="${o[b]}"]`);
        if (w) {
          _.push(w);
          var T = OrgChart._getTransform(w);
          (v.push(T), y.push({ x: T[4], y: T[5] }));
    ...
    var O = { x: d.x, y: d.y },
      ...
      A = function (t, n) {
        if (t != null) {
          n.classList.remove(`boc-drag-over`);
          for (
            var r = i.getNode(E), a = OrgChart.getStParentNodes(r), o = 0;
            o < a.length;
            o++
          ) {
      ...
      j = function (n) {
        ...
        if (O) {
          var r = OrgChart._getClientXY(n),
            s = n.target;
          OrgChart.isMobile() && (s = document.elementFromPoint(r.x, r.y));
          var c = OrgChart._getOffsetXY(i.element, n),
            d = {
          ...
          if (d.left || d.right || d.up || d.down) {
            u.classList &&
              ...
              u.classList.remove(`boc-cursor-nodrop`),
              u.classList.remove(`boc-cursor-copy`));
            for (var b = [], x = [], S = [], C = [], w = 0; w < p.length; w++)
              (b.push(p[w][4]),
                x.push(p[w][5]),
                v[w]
                  ? (S.push(v[w][4]), C.push(v[w][5]))
                  : (S.push(null), C.push(null)));
            var T = O.x,
              j = O.y,
              N = r.x,
              P = r.y;
            i.moveStart(d, function (t) {
              for (var n = 0; n < p.length; n++) {
                ...
                ((p[n][4] = a + t.x),
                  (p[n][5] = o + t.y),
                  (O.x = T - t.xWithoutScale),
                  (O.y = j - t.yWithoutScale),
                  (r.x = N - t.xWithoutScale),
                  (r.y = P - t.yWithoutScale),
                  (f[n].x = a + t.x),
                  (f[n].y = o + t.y),
                  (f[n].movex = t.x),
                  (f[n].movey = t.y),
                  v[n] && ((v[n][4] = s + t.x), (v[n][5] = c + t.y)));
                for (
            ...
            if (
              ...
              for (; s != null && s != u; ) {
                if (s.hasAttribute && s.hasAttribute(OrgChart.attr.node_id)) {
                  var F = s.getAttribute(OrgChart.attr.node_id);
            ...
            if (E != null) {
              ...
              for (
                var I = i.getNode(E), ee = OrgChart.getStParentNodes(I), L = 0;
                L < ee.length;
                L++
              ) {
                var te = i.getNodeElement(ee[L].id);
                te && (te.style.opacity = 0.1);
              }
              !i.canUpdateLink(f[0].id, E) && u.classList
                ? (u.classList.remove(`boc-cursor-grab`),
                  u.classList.remove(`boc-cursor-move`),
                  u.classList.remove(`boc-cursor-copy`),
                  u.classList.add(`boc-cursor-nodrop`))
            ...
            for (
              var ne = (r.x - O.x) / k, re = (r.y - O.y) / k, w = 0;
              w < p.length;
              w++
            ) {
              ((p[w][4] = h[w].x + ne),
                (p[w][5] = h[w].y + re),
                v[w] && ((v[w][4] = y[w].x + ne), (v[w][5] = y[w].y + re)),
                (f[w].x = m[w].x + ne),
                (f[w].y = m[w].y + re));
              for (
                var ie = OrgChart.ui.link(
                    f[w],
                    i,
                    k,
                    i.response.bordersByRootIdAndLevel,
                ...
                var R = ie[L],
                  z = i.element.querySelector(
                    `[data-l-id="[${R.id}][${R.childId}]"]`,
                  );
            ...
            if (
              !t._dragEventFired &&
              (Math.abs(r.x - O.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                Math.abs(r.y - O.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)
            ) {
              if (
                ((i._gragStartedId = o[0]),
                OrgChart.events.publish(`drag`, [i, a, n, o]) === !1 && M(),
                i.config.enableDragDrop)
              )
                for (var w = 0; w < g.length; w++)
                  u.insertBefore(g[w], u.firstChild);
              t._dragEventFired = !0;
            }
      ...
      M = function (a) {
        !t._dragEventFired &&
          (a.touches == null || a.touches.length <= 1) &&
          i._clickHandler(i.getSvg(), n);
        for (var o = 0; o < f.length; o++)
          ((f[o].x = m[o].x), (f[o].y = m[o].y));
        if (
          (i.moveEnd(),
          u.classList &&
            (u.classList.remove(`boc-cursor-grab`),
            ...
            u.classList.remove(`boc-cursor-nodrop`),
            u.classList.remove(`boc-cursor-copy`)),
          u.removeEventListener(r.move, j),
          u.removeEventListener(r.up, M),
          r.leave && u.removeEventListener(r.leave, M),
          f[0].id == E || E == null)
        ) {
          if (t._dragEventFired) {
            var s = OrgChart.events.publish(`drop`, [
              i,
              f[0].id,
              void 0,
              g[0],
            ...
            if (i.config.movable && s !== !1)
              if (i.config.movable == OrgChart.movable.detachTree) {
                var d = OrgChart._getTransform(i.getNodeElement(l.id)),
                  p = i.get(l.id);
                ...
                for (
                  ...
                  var p = i.get(h[o]);
                  p &&
                    (p.movex == null ? (p.movex = _) : (p.movex += _),
                    p.movey == null ? (p.movey = v) : (p.movey += v),
                    i.update(p));
                }
                (i._ai.setContext(),
                  OrgChart.events.publish(`updated`, [i]),
                  i.draw(OrgChart.action.update, { dragNodeIdList: h }));
              }
          }
        ...
        var y = i.getNode(E),
          s = OrgChart.events.publish(`drop`, [i, f[0].id, y.id, g[0], a]);
        if (s === !1) {
    ...
    (u.addEventListener(r.move, j),
      u.addEventListener(r.up, M),
      r.leave && u.addEventListener(r.leave, M));
  }),
  (OrgChart.prototype._move = function (e, t, n) {
    ((n[0] = t),
      (n[1] = e),
      this.setViewBox(n),
  ...
  (OrgChart.prototype.moveStart = function (t, n, r, i) {
    if (!t) {
    ...
    function p() {
      var p = { x: 0, y: 0, xWithoutScale: 0, yWithoutScale: 0 };
      (t.left
        ? (c++,
          (p.x = (c * OrgChart.MOVE_STEP) / s),
          (p.xWithoutScale = c * OrgChart.MOVE_STEP))
        : t.right &&
          (c++,
          (p.x = -(c * OrgChart.MOVE_STEP) / s),
          (p.xWithoutScale = -(c * OrgChart.MOVE_STEP))),
        t.up
          ? (l++,
            (p.y = (l * OrgChart.MOVE_STEP) / s),
            (p.yWithoutScale = l * OrgChart.MOVE_STEP))
          : t.down &&
            (l++,
            (p.y = -(l * OrgChart.MOVE_STEP) / s),
            (p.yWithoutScale = -(l * OrgChart.MOVE_STEP))));
      ...
      ((p.x *= m),
        ...
        (p.y *= m),
        (p.yWithoutScale *= m),
        a.setViewBox([o[0] + p.x, o[1] + p.y, o[2], o[3]]),
        n && n(p),
        (f += d));
    }
  ...
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.node = function (e, t, n, r) {
    ((this.templateName = r),
      (this.id = e),
      (this.pid = t),
      (this.children = []),
  ...
  (OrgChart.searchUI.prototype.init = function (t) {
    ...
    if (a) {
      var o = a.getBoundingClientRect(),
        s = this.instance.getSvg().getBoundingClientRect();
      ((r = s.right - o.left + 10), (i = o.top - s.top - 10));
    }
    var c = document.createElement(`div`);
    (c.classList.add(`boc-search`),
      (c.style.right = r + `px`),
      (c.style.top = i + `px`));
    ...
    ((c.innerHTML += l.html),
      (this.xBtn = c.querySelector(`[data-input-btn]`)),
      (this.xBtn.style.display = `none`),
      (this.searchTableWrapper = document.createElement(`div`)),
      c.appendChild(this.searchTableWrapper));
    var u = this.instance.getSvg().nextSibling;
    (this.instance.element.insertBefore(c, u),
      OrgChart.input.init(c),
      ...
      this.input.addEventListener(`blur`, function (t) {
        OrgChart.isNEU(n.input.value) &&
          OrgChart.SEARCH_HELP_SYMBOL != n.input.value &&
          (n.xBtn.style.display = `none`);
      }),
          ...
          : t.key == `ArrowUp`
            ...
            : t.key == `Enter`
              ...
              : t.key == `Escape`
                ? n.hide()
                : this.value.length >=
                    OrgChart.MINIMUM_SYMBOLS_IN_SEARCH_INPUT && n._search();
      }));
    var d = function () {
        var e = n.instance.element.querySelectorAll(`[data-search-item-id]`),
          t = n.instance.element.querySelector(`[data-selected="yes"]`);
        t == null && e.length > 0
          ? e[0].setAttribute(`data-selected`, `yes`)
          : e.length > 0 &&
            t.nextSibling &&
            t.nextSibling.setAttribute &&
            (t.removeAttribute(`data-selected`),
            t.nextSibling.setAttribute(`data-selected`, `yes`));
      },
      f = function () {
        var e = n.instance.element.querySelectorAll(`[data-search-item-id]`),
          t = n.instance.element.querySelector(`[data-selected="yes"]`);
        t == null && e.length > 0
          ...
          : e.length > 0 &&
            t.previousSibling &&
            t.previousSibling.setAttribute &&
            (t.removeAttribute(`data-selected`),
            t.previousSibling.setAttribute(`data-selected`, `yes`));
      };
  }),
  (OrgChart.searchUI.prototype._enterHandler = function () {
    ...
    if (!t)
      ...
      this.input.value == OrgChart.SEARCH_HELP_SYMBOL
        ? ((this.input.value = n + ` `),
          (this.searchTableWrapper.innerHTML = ``))
        : OrgChart.events.publish(`searchclick`, [this, { nodeId: n }]) != 0 &&
          (this.instance.center(n), OrgChart.isMobile() && this.hide());
    }
  }),
  (OrgChart.searchUI.prototype._initSearchFields = function () {
    if (this.instance.config.searchFields == null) {
      ...
      for (var t = 0; t < this.instance.response.allFields.length; t++) {
        ...
        n != `tags` &&
          !OrgChart._fieldIsImg(this.instance.config, n) &&
          this._searchFields.indexOf(n) == -1 &&
          this._searchFields.push(n);
      }
  ...
  (OrgChart.searchUI.prototype.addMatchTag = function (e) {
  ...
  (OrgChart.searchUI.prototype._search = function () {
    ...
    this._searchAfterEnterPress = !1;
    var n;
    if (this.input.value == OrgChart.SEARCH_HELP_SYMBOL) n = this.helpView();
    else {
      this.__search();
      ...
      n = `<table border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            ${(function () {
                              for (
                                var n = ``, i = 0;
                                i < t.lastSearch.length &&
                                !(i >= OrgChart.SEARCH_RESULT_LIMIT);
                                i++
                              ) {
                                var a = t.lastSearch[i],
                                  o = ``;
                                if (r) {
                                ...
                                var u = {
                                  ...
                                  second: l,
                                  searchItem: a,
                                  html: OrgChart.searchUI.createItem(
                                    o,
                                    a.id,
                                    c,
                                    l,
                                ...
                                (OrgChart.events.publish(`add-item`, [t, u]),
                                  (n += u.html));
                              }
                              return n;
                            })()}  
    ...
    for (
      ...
      i[a].addEventListener(`click`, function () {
        if (this.hasAttribute(`data-search-item-id`)) {
          ...
          if (t.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
            var r = OrgChart.events.publish(`searchclick`, [t.instance, n]),
              i = OrgChart.events.publish(`searchclick`, [t, { nodeId: n }]);
            if ((r === !1 && (i = !1), i !== !1)) {
  ...
  (OrgChart.searchUI.prototype.helpView = function () {
    ...
    for (var t in this.searchFieldsAbbreviation)
      e += `<tr data-search-item-id="${t}" style="height: 50px;"><td class="boc-search-image-td" style="text-align: center;">${t}</td><td class="boc-search-text-td">${this.searchFieldsAbbreviation[t]}</td></tr>`;
    return ((e += `</table>`), e);
  }),
  (OrgChart.searchUI.createItem = function (t, n, r, i) {
    return (
      (r &&= `<b>` + r + `</b>`),
      (t = t
  ...
  (OrgChart.searchUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  OrgChart.events.on(`redraw`, function (t, n) {
    for (
      var r = t.element.querySelectorAll(`[data-n-id]`), i = 0;
      i < r.length;
      i++
    )
      (r[i].addEventListener(`mouseover`, function (n) {
        if (!this.contains(n.relatedTarget)) {
          var r = this.getAttribute(`data-n-id`),
            i = { node: t.getNode(r), event: n };
          if (OrgChart.events.publish(`node-mouseover`, [t, i]) === !1) return;
          OrgChart._hover._addSelectedStyle(
            t,
            i.node,
            i.node.id,
            t.config.highlightOnHover,
          );
        }
      }),
        r[i].addEventListener(`mouseleave`, function (n) {
          var r = this.getAttribute(`data-n-id`),
            i = { node: t.getNode(r), event: n };
          OrgChart.events.publish(`node-mouseleave`, [t, i]) !== !1 &&
            OrgChart._hover._removeSelectedStyle(t);
        }));
  }),
  (OrgChart.prototype.highlightNode = function (t, n) {
    var r = this.getNode(t);
    return (r && OrgChart._hover._addSelectedStyle(this, r, r.id, n), this);
  }),
  (OrgChart._hover = {}),
  (OrgChart._hover._addSelectedStyle = function (t, n, r, i) {
    n.isSplit ||
      ((i == `parents` || i == `childrenAndParents`) &&
        OrgChart._hover._addSelectedStyleParents(t, n, r),
      (i == `children` || i == `childrenAndParents`) &&
        OrgChart._hover._addSelectedStyleChildren(t, n, r),
      i == `sameLevel` && OrgChart._hover._addSelectedStyleSameLevel(t, n, r),
      OrgChart._hover._addSelectedStyleSelf(t, n, r, i));
  }),
  (OrgChart._hover._addSelectedStyleSelf = function (e, t, n, r) {
    var i = e.getNodeElement(t.id);
    i &&
      (!i.classList.contains(`boc-hover`) &&
        r == `self` &&
        i.classList.add(`boc-hover`),
      i.classList.add(`boc-hover-self`));
  }),
  (OrgChart._hover._addSelectedStyleChildren = function (t, n, r) {
    ...
    if ((a && a.classList.add(`boc-hover`), n.id != r)) {
      if (
        n.rightNeighbor &&
        n.rightNeighbor.isSplit &&
        n.rightNeighbor.pid == n.pid
      ) {
        var o = t.element.querySelector(
          `[data-l-id="[${n.parent.id}][${n.id}]"]`,
        );
        o && o.classList.add(`boc-hover`);
      }
      if (
        n.leftNeighbor &&
        n.leftNeighbor.isSplit &&
        n.leftNeighbor.pid == n.pid
      ) {
        var o = t.element.querySelector(
          `[data-l-id="[${n.parent.id}][${n.id}]"]`,
        );
    ...
    for (var s of n.children)
      if (s.isSplit) {
        ...
        (o && o.classList.add(`boc-hover`),
          OrgChart._hover._addSelectedStyleChildren(t, s, r));
      }
    for (var c of n.childrenIds) {
      var s = t.getNode(c),
        o = t.element.querySelector(`[data-l-id="[${n.id}][${s.id}]"]`);
      (o && o.classList.add(`boc-hover`),
        OrgChart._hover._addSelectedStyleChildren(t, s, r));
    }
  }),
  (OrgChart._hover._addSelectedStyleSameLevel = function (e, t, n) {
    var r = e.getNodeElement(t.id);
    r && r.classList.add(`boc-hover`);
    for (var i of e.element.querySelectorAll(`[data-l="${t.level}"]`))
      i.classList.add(`boc-hover`);
  }),
  (OrgChart._hover._addSelectedStyleParents = function (t, n, r) {
    var i = t.getNodeElement(n.id);
    ...
    (n.rightNeighbor &&
      n.rightNeighbor.isSplit &&
      n.rightNeighbor.pid == n.pid &&
      OrgChart._hover._addSelectedStyleParents(t, n.rightNeighbor, r),
      n.leftNeighbor &&
        n.leftNeighbor.isSplit &&
        n.leftNeighbor.pid == n.pid &&
        OrgChart._hover._addSelectedStyleParents(t, n.leftNeighbor, r),
      n.parent &&
        n.parent.isSplit &&
        OrgChart._hover._addSelectedStyleParents(t, n.parent, r));
    var s = t.getNode(n.pid);
    n.parent && OrgChart._hover._addSelectedStyleParents(t, s, r);
  }),
  (OrgChart._hover._removeSelectedStyle = function (e) {
    let t = e.element.querySelectorAll(`.boc-hover, .boc-hover-self`);
    for (let e = 0; e < t.length; e++)
      (t[e].classList.remove(`boc-hover`),
        t[e].classList.remove(`boc-hover-self`));
  }),
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.manager = function (e) {
  ...
  (OrgChart.manager.prototype.read = function (t, n, r, i, a, o, s, c) {
    var l = this;
    OrgChart.state._get(this.config.state, n, r, function (u) {
      ((l.state = u),
        (l.action = a),
        (l.actionParams = o),
        a != OrgChart.action.init ||
        !l.state ||
        (o && o.method && o.method == `fit`)
      ...
      var d = l.maxX,
        ...
        p = l.minX,
        m = l.minY,
        h = l.bordersByRootIdAndLevel,
        g = l.roots,
        _ = l.nodes;
      if (!t)
        (_ ? (l.oldNodes = _) : (l.oldNodes = null),
          l._read(function (t) {
            ((d = t.maxX),
              (f = t.maxY),
              (p = t.minX),
              (m = t.minY),
              (h = t.bordersByRootIdAndLevel),
              (g = t.roots),
              (_ = t.nodes));
            ...
            ((i.notif = t.limit),
              ...
              a != OrgChart.action.exporting &&
                ...
                (l.bordersByRootIdAndLevel = h),
                (l.rootList = t.rootList)),
              s(i));
          }, c));
      else {
        var v = OrgChart.manager._getResponse(
          n,
          r,
          l.visibleNodeIds,
          l.config,
        ...
        (a != OrgChart.action.exporting &&
          ...
          (l.roots = g),
          (l.nodes = _),
          (l.visibleNodeIds = v.visibleNodeIds)),
          (v.bordersByRootIdAndLevel = h),
          (v.roots = g),
          (v.adjustify = { x: 0, y: 0 }),
          l.state && (v.adjustify = l.state.adjustify),
          s(v));
      }
    });
  }),
  (OrgChart.manager.prototype._read = function (t, n) {
    var r = this,
    ...
    ((s ??= OrgChart.local),
      s._setPositions(
        ...
        r.layoutConfigs,
        function (n) {
          var s = OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(
            o,
            a,
            r.action,
            r.actionParams,
          ...
          (r.state &&
            ...
            r.action == OrgChart.action.exporting
              ? (s = r._fixAdjustForExport)
              : (r._fixAdjustForExport = s));
          for (
            var c = { minX: null, minY: null, maxX: null, maxY: null },
              l = {},
              u = [],
              d = 0;
            d < o.length;
          ...
          for (var d = 0; d < o.length; d++)
            OrgChart.manager._setChildCountPropsIterate(o[d], a);
          for (var f in u)
            for (var p in u[f]) {
              var m = l[f][p],
                h = u[f][p];
  ...
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.manager._initDinamicNode = function (t, n, r) {
    (n && (t.lcn = n), r && (t.isAssistant = !0));
    var i = OrgChart.t(t.templateName);
    ((t.w = i && i.size ? i.size[0] : 0),
      (t.h = i && i.size ? i.size[1] : 0),
      (t.isSplit = t.templateName == `split`),
      (t.isMirror = t.templateName == `mirror`),
      (t.isSubLevel = t.templateName == `subLevel`));
  }),
  (OrgChart.manager._setCollpasedProperty = function (t, n, r, i, a, o, s, c) {
    if (
      (t.collapsed == null && n.collapse && n.collapse.allChildren
        ? (t.collapsed = !0)
        : (t.collapsed ??= !1),
      a == OrgChart.action.expand &&
        r.ids.indexOf(t.id) != -1 &&
        (t.collapsed = !1),
      a == OrgChart.action.collapse && (r.expandIds || r.collapseIds)
        ? r.expandIds && r.expandIds.indexOf(t.id) != -1
          ? (t.collapsed = !1)
          : r.collapseIds &&
            r.collapseIds.indexOf(t.id) != -1 &&
            (t.collapsed = !0)
        : a == OrgChart.action.collapse &&
          r.ids.indexOf(t.id) != -1 &&
          (t.collapsed = !0),
      a == OrgChart.action.expand && r.ids == `all` && (t.collapsed = !1),
      a == OrgChart.action.exporting &&
      ...
      if (
        ...
        if (l == t) t.collapsed = !1;
          ...
          (r.parentLevels != null && u && d <= r.parentLevels) ||
          (r.childLevels != null && f && p <= r.childLevels) ||
          (f && r.expandChildren)
            ? (t.collapsed = !1)
            : (t.collapsed = !0);
        }
    ...
    a == OrgChart.action.init && s != null
      ? (t.collapsed = !s.exp.has(t.id))
      : a == OrgChart.action.init
        ? t.tags.indexOf(`left-partner`) != -1 ||
          t.tags.indexOf(`right-partner`) != -1 ||
          t.tags.indexOf(`partner`) != -1 ||
          t.parentPartner
          ? (t.collapsed =
              n.collapse && o >= n.collapse.level && i.indexOf(t.id) == -1)
          : (t.collapsed =
              n.collapse && o >= n.collapse.level - 1 && i.indexOf(t.id) == -1)
  ...
  (OrgChart.manager._initNode = function (t, n, r, i, a, o, s) {
    var c = s.manager.config,
      l = s.manager.layoutConfigs,
      u = s.manager.action,
      d = s.manager.actionParams,
      f = s.manager.state,
      p = OrgChart._hasOnDemandHandler(s),
      m = l[r || `base`];
    t.parent ??
      OrgChart.manager._setCollpasedProperty(t, m, d, a, u, i - 1, f, n);
    for (var h = 0; h < t.childrenIds.length; h++) {
      var g = n[t.childrenIds[h]];
      if (g)
        if (
          (OrgChart.manager._setCollpasedProperty(g, m, d, a, u, i, f, n),
          g.collapsed)
        )
          t.collapsedChildrenIds.push(g.id);
        else {
          if (((g.parent = t), g.ppid != null)) {
            var _ = n[g.ppid];
            _ && (g.parentPartner = _);
          }
          ((g.tags.indexOf(`left-partner`) != -1 ||
            g.tags.indexOf(`right-partner`) != -1 ||
            g.tags.indexOf(`partner`) != -1 ||
            g.parentPartner) &&
            o.indexOf(t.id) == -1 &&
            o.push(t.id),
            t.children.push(g));
    ...
    if (
      (u == OrgChart.action.minimize && !t.min
        ? (d.all || d.id == t.id) && (t.min = !0)
        : u == OrgChart.action.maximize && t.min === !0
          ? (d.all || d.id == t.id) && (t.min = !1)
          : u == OrgChart.action.exporting && d.min === !1
            ? (t.min = !1)
            : u == OrgChart.action.init &&
              f != null &&
              (t.min = f.min.has(t.id)),
      !t.min && (!t.tags || !t.tags.has(`filter`)))
    )
      for (var h = 0; h < t.stChildrenIds.length; h++) {
        var g = n[t.stChildrenIds[h]];
        ((g.stParent = t), t.stChildren.push(g));
      }
    (i != null && (t.level = i), r && (t.lcn = r));
    var v = OrgChart._getSubLevels(t.tags, c.tags);
    (v > 0 && (t.subLevels = v),
      t.tags.indexOf(`assistant`) != -1 &&
        t.parent != null &&
        (t.isAssistant = !0),
      m.layout == OrgChart.layout.treeList && (t.isTreeListItem = !0),
      m.template &&
        c.template == t.templateName &&
        (t.templateName = m.template));
    var y = OrgChart.t(t.templateName, t.min);
    if (
      ((t.w = y && y.size ? y.size[0] : 0),
      (t.h = y && y.size ? y.size[1] : 0),
      (t.padding = y && y.padding ? y.padding : [0, 0, 0, 0]),
    ...
    var x = { node: t };
    OrgChart.events.publish(`node-initialized`, [s, x]);
  }),
  (OrgChart.manager._iterate = function (t, n, r, i, a, o, s, c, l, u, d, f) {
    var p = f.manager.layoutConfigs;
    if (
      (OrgChart.manager._initNode(n, r, l, i, u, d, f),
      n.isAssistant && (o[n.pid] || (o[n.pid] = []), o[n.pid].push(n.id)),
      n.subLevels > 0 && s.push(n.id),
      ...
      if (
        ...
        n.parent.children[n.parent.children.length - 1] == n
      ) {
        for (
          var m = [], h = 0, g = 0, _ = 0;
          _ < n.parent.children.length;
          _++
        ) {
          var v = n.parent.children[_];
          v.tags.indexOf(`partner`) == -1 &&
          v.tags.indexOf(`left-partner`) == -1 &&
          v.tags.indexOf(`right-partner`) == -1 &&
          v.tags.indexOf(`assistant`) == -1 &&
          v.children.length == 0
            ? m.push(v.id)
            : v.tags.indexOf(`assistant`) == -1
              ? (v.tags.indexOf(`partner`) != -1 ||
        ...
        ((OrgChart.MIXED_LAYOUT_ALL_NODES &&
          m.length > 1 &&
          m.length == n.parent.children.length - h - g) ||
      ...
      ((OrgChart.MIXED_LAYOUT_ALL_NODES &&
        m.length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN &&
        m.length == n.parent.childrenIds.length - h - g) ||
        (!OrgChart.MIXED_LAYOUT_ALL_NODES &&
          m.length >
    ...
    n.stChildren.length &&
      ((t.stContainerNodes ||= []), t.stContainerNodes.push(n));
    for (var y = 0; y < n.stChildren.length; y++) {
      for (var b = ``, _ = 0; _ < n.tags.length; _++)
        if (p[n.tags[_]]) {
          b = n.tags[_];
          break;
        }
      (a.push(n.stChildren[y].id),
    ...
    for (var y = 0; y < n.children.length; y++)
      (n.isTreeListItem && (n.children[y].isTreeListItem = n.isTreeListItem),
        OrgChart.manager._iterate(
          t,
          n.children[y],
          r,
  ...
  (OrgChart.manager.__createNodes = function (t, n, r, i, a, o, s, c) {
    for (
      var l = [],
        u = OrgChart._addDottedLines(r),
        d = [],
        f = OrgChart._hasOnDemandHandler(c),
        p = 0;
      p < u.length;
      p++
    ) {
      ...
      var _ = OrgChart._getTemplate(h, r.tags, r.template);
      m && m.template && (_ = m.template);
      var v = new OrgChart.node(m.id, m.pid, h, _);
      (OrgChart.isNEU(m.ppid) || (v.ppid = m.ppid),
        OrgChart.isNEU(m.stpid) || (v.stpid = m.stpid),
        m.movex != null && (v.movex = m.movex),
        m.movey != null && (v.movey = m.movey),
        (t[m.id] = v),
        l.push(m.id),
        m.cids && d.push(m));
    }
    for (var m of d) {
      ...
      for (var b of m.cids) {
        var x = t[b];
        x &&
          (!OrgChart.isNEU(x.pid) &&
            x.pid != y.id &&
            console.error(
              `node: ${x.id} has pid: ${x.pid} fifferent from ${y.id}`,
            ),
          (x.pid = y.id));
      }
    }
    if (r.orderBy != null) {
      var S = OrgChart.manager._getOrderSortArray(r.orderBy);
      l.sort(function (e, t) {
        var n, r;
        for (var i of u)
          if ((i.id == e && (n = i), i.id == t && (r = i), n && r)) break;
      ...
      if ((T || (v.stpid = null), !y && !f && (v.pid = null), T)) {
        ...
        y
          ? (w &&
              ...
              (v.min = w.min),
              (v.treeList = w.treeList)),
            y.childrenIds.push(v.id))
          : (w &&
              ((v.collapsed = w.collapsed),
              (v.min = w.min),
              (v.treeList = w.treeList)),
            n.push(v),
            s.push(v.id));
      i == OrgChart.action.init && (v.min = OrgChart._getMin(v, r));
    }
    for (var m of d) {
      var y = t[m.id];
  ...
  (OrgChart._hasOnDemandHandler = function (t) {
    return OrgChart.events.has(`on-demand`, t._event_id);
  }),
  (OrgChart.manager._createNodes = function (t) {
    var n = t.manager.config,
      r = t.manager.layoutConfigs,
      i = t.manager.action,
      a = t.manager.actionParams,
      o = t.manager.oldNodes,
      s = t.manager.state,
      c = {},
      l = [],
      u = [];
    if (
      (OrgChart.manager.__createNodes(c, l, n, i, a, o, u, t), n.roots != null)
    ) {
      l = [];
      for (var d = 0; d < n.roots.length; d++) {
        var f = c[n.roots[d]];
        if (f && i == OrgChart.action.centerNode) {
          for (var p = f; p.pid != null || p.stpid != null; )
            p = p.pid == null && p.stpid != null ? c[p.stpid] : c[p.pid];
          for (var m = c[a.id]; (m.pid != null || m.stpid != null) && m != f; )
            m = m.pid == null && m.stpid != null ? c[m.stpid] : c[m.pid];
          p == m && (f = p);
        }
        if (f) {
    ...
    if (i == OrgChart.action.exporting && a.id != null)
      if (a.parentLevels) {
        for (var _ = c[a.id], y = 0; y < a.parentLevels && c[_.pid]; )
          (y++, (_ = c[_.pid]));
        ((_.pid = null), (l = [_]));
      } else {
        var b = c[a.id];
    ...
    var x = [];
    if (i == OrgChart.action.init && n.expand && n.expand.nodes && s == null)
      for (var d = 0; d < n.expand.nodes.length; d++) {
        var b = c[n.expand.nodes[d]];
        for (
          n.expand.allChildren === !0 &&
          OrgChart.manager._addExpandedNodeIdsIterate(b, c, x);
          b;
        )
          (x.push(b.id),
            b.pid == null && b.stpid != null
              ? ((b = c[b.stpid]), (b.min = !1))
              : (b = c[b.pid]));
      }
    else if (
      (i == OrgChart.action.expand && a.ids && a.ids != `all`) ||
      (i == OrgChart.action.collapse && a && a.expandIds)
    )
      for (
        var S = i == OrgChart.action.expand ? a.ids : a.expandIds, d = 0;
        d < S.length;
        d++
      )
        for (var b = c[S[d]], _ = c[b.pid]; _; )
          (x.push(_.id),
            _.pid == null && _.stpid != null
              ? ((_ = c[_.stpid]), (_.min = !1))
              : (_ = c[_.pid]));
    else if (i == OrgChart.action.centerNode) {
      for (var C = OrgChart._getCenterNodeFromParams(c, a); C; ) {
        if (
          (x.push(C.id),
          a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && C)
        )
          for (var d = 0; d < C.childrenIds.length; d++) {
      ...
      if (
        ((C = OrgChart._getCenterNodeFromParams(c, a)),
        a.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
      )
        for (var d = 0; d < C.childrenIds.length; d++) {
      ...
      if (
        ...
        var _ = c[C.pid];
        if (_)
          for (var d = 0; d < _.childrenIds.length; d++) {
      ...
      for (var b = c[a.insertedNodeId]; b; )
        (x.push(b.id),
          b.pid == null && b.stpid != null
            ? ((b = c[b.stpid]), (b.min = !1))
            : (b = c[b.pid]));
    for (var O = [], k = {}, A = [], j = {}, M = [], d = 0; d < l.length; d++)
      OrgChart.manager._iterate(l[d], l[d], c, 0, O, k, A, j, ``, x, M, t);
    if (
    ...
    for (var d = 0; d < M.length; d++) {
      for (
        ...
        w.isAssistant
          ? N.push(w.id)
          : w.tags.indexOf(`right-partner`) == -1
            ? w.tags.indexOf(`left-partner`) == -1
              ? w.tags.indexOf(`partner`) != -1 && !(ee % 2)
                ? ((w.isPartner = 1), (w.children = []), P.push(w.id), ee++)
                : w.tags.indexOf(`partner`) != -1 && ee % 2
                  ? ((w.isPartner = 2), (w.children = []), F.push(w.id), ee++)
                  : w.parentPartner
                    ? (I[w.parentPartner.id] || (I[w.parentPartner.id] = []),
                      I[w.parentPartner.id].push(w.id))
                    : N.push(w.id)
              : ((w.isPartner = 2), (w.children = []), F.push(w.id))
            : ((w.isPartner = 1), (w.children = []), P.push(w.id));
      }
      b.children = [];
      for (var ie = [], E = 0; E < P.length; E++) {
        var w = c[P[E]];
        I[w.id] ? b.children.push(w) : b.children.splice(0, 0, w);
        for (var R = 0; R < w.childrenIds.length; R++)
          ie.push(w.childrenIds[R]);
      }
      ...
      for (var E = 0; E < z.length; E++) {
        var w = c[z[E]];
        w.collapsed ||
          ((w.parentPartner = w.parent),
          (w.parent = b),
          (w.isChildOfPartner = !0),
          b.children.push(w));
      }
      for (var E = F.length - 1; E >= 0; E--)
        if (I[F[E]])
          for (var g = 0; g < I[F[E]].length; g++)
            (b.children.push(c[I[F[E]][g]]),
              L++,
              re.indexOf(F[E]) == -1 && re.push(F[E]));
      ...
      for (var E = 0; E < P.length; E++)
        if (I[P[E]])
          for (var g = 0; g < I[P[E]].length; g++)
            (b.children.push(c[I[P[E]][g]]),
              te++,
              ne.indexOf(P[E]) == -1 && ne.push(P[E]));
      ...
      ((b.partnerSeparation =
        Math.max(re.length, ne.length) * n.partnerChildrenSplitSeparation +
        n.minPartnerSeparation),
        !N.length && L && !te
          ? (b.hasPartners = 2)
          : !N.length && !L && te
            ? (b.hasPartners = 3)
    ...
    for (var d = 0; d < A.length; d++)
      for (
        var b = c[A[d]], ae = b.lcn ? b.lcn : `base`, oe = r[ae], E = 0;
        E < b.subLevels;
        E++
      ) {
        var B = new OrgChart.node(
          b.id + `_sub_level_index_` + E,
          b.pid,
          [],
          `subLevel`,
        );
        OrgChart.manager._initDinamicNode(B, b.lcn);
        var _ = b.parent;
        if (_) {
          (b.movex != null && (B.movex = b.movex),
            b.movey != null && (B.movey = b.movey));
          var v = _.children.indexOf(b);
          (v > -1 && (_.children.splice(v, 1), _.children.splice(v, 0, B)),
            B.children.push(b),
            (B.parent = _),
            (b.parent = B),
            (c[B.id] = B));
    ...
    for (var V in k) {
      ...
      _.hasAssistants = !0;
      var B = new OrgChart.node(
        _.id + `_split_assitant_0`,
        _.id,
        [`assistant`],
        `split`,
      );
      (_.movex != null && (B.movex = _.movex),
        _.movey != null && (B.movey = _.movey),
        OrgChart.manager._initDinamicNode(B, _.lcn, !0),
        (c[B.id] = B));
      for (var H = [], E = _.children.length - 1; E >= 0; E--) {
        var w = _.children[E];
        w.isAssistant
          ? ((w.parent = null), _.children.splice(E, 1), H.splice(0, 0, w.id))
          : w.isPartner ||
            (w.parent &&
              j[w.parent.id] &&
              B &&
              ...
              (Object.defineProperty(
                j,
                B.id,
                Object.getOwnPropertyDescriptor(j, w.parent.id),
              ),
              delete j[w.parent.id]),
            (w.parent = B),
            B.children.unshift(w),
            _.children.splice(E, 1));
      }
      if (H.length % 2) {
        var U = c[H[H.length - 1]],
          se = new OrgChart.node(U.id + `_mirror`, _.pid, [], `mirror`);
        (OrgChart.manager._initDinamicNode(se, U.lcn, !0),
          (se.isAssistant = !0),
          (se.w = U.w),
          (se.h = U.h),
          (c[se.id] = se),
          H.splice(H.length - 1, 0, se.id));
      }
      for (var ce = 1, E = H.length - 1; E >= 0; E--)
        if (E % 2 && E != H.length - 1) {
          var W = new OrgChart.node(
            _.id + `_split_assitant_` + ce,
            _.pid,
            [],
            `split`,
          );
          (OrgChart.manager._initDinamicNode(W, _.lcn, !0),
            _.movex != null && (W.movex = _.movex),
            _.movey != null && (W.movey = _.movey),
            (c[W.id] = W),
            H.splice(E, 0, W.id),
            ce++);
    ...
    var de = OrgChart.events.has(`node-layout`, t._event_id);
    if (ue || de) {
      var Y = { nodes: c, config: n, action: i, actionParams: a };
      if (A.length) {
        var fe = !1;
        for (var V in j) {
        ...
        if (fe) {
          var X = {},
            ...
            me = {};
          for (var V in j)
            for (var S = j[V], he = !1, ge = null, d = 0; d < S.length; d++) {
              var _e = S[d];
              ((ge === null || A.has(_e)) &&
                ((ge = c[_e].parent.id),
                !he &&
                  !OrgChart.isNEU(c[_e].subLevels) &&
                  (he = c[_e].subLevels > 0)),
                X[ge] || (X[ge] = []),
                X[ge].push(_e),
                he && ((me[ge] = V), pe[ge] || (pe[ge] = []), pe[ge].push(_e)));
            }
          for (var V in ((j = {}), pe))
            if (
              pe[V].length >
              ...
              for (var ve = me[V], d = c[ve].children.length - 1; d >= 0; d--) {
      ...
      for (var V in j) {
        ...
        var ae = _.lcn ? _.lcn : `base`,
          oe = r[ae];
        if (oe.layout != 0 || de) {
          ((Y.pnode = _),
            (Y.layout = oe.layout),
            (Y.layoutGridColumns = n.layoutGridColumns),
            (Y.childrenIds = j[V]),
            (Y.lastChildrenPidIds = j),
            (Y.subLevels = 0),
            (Y.layouts = []),
            OrgChart.events.publish(`node-layout`, [t, Y]),
            OrgChart.events.publish(`layout`, [Y]),
            Y.layouts.length ||
              Y.layouts.push({
                layout: Y.layout,
          ...
          for (var ye = 0; ye < Y.layouts.length; ye++) {
            var Q = Y.layouts[ye];
            for (
              OrgChart.isNEU(Q.subLevels) && (Q.subLevels = 0),
                OrgChart.isNEU(Q.layout) && (Q.layout = oe.layout),
                _ = c[V],
                Z = _;
              Z.isSplit;
            )
            ...
            for (var be = _, E = 0; E < Q.subLevels; E++) {
              var B = new OrgChart.node(
                ye + `_sublevel_layout_` + E,
                be.id,
                [],
                `subLevel`,
              );
              (OrgChart.manager._initDinamicNode(B, be.lcn),
                (B.parent = be),
                be.children.push(B),
                (c[B.id] = B),
                (be = B));
            ...
            if (Q.subLevels) {
              for (var E = 0; E < Q.childrenIds.length; E++) {
                var w = c[Q.childrenIds[E]],
                  v = _.children.indexOf(w);
                (v != -1 && _.children.splice(v, 1),
                  (w.parent = be),
                  be.children.push(w));
              }
              _ = be;
            }
            if (Q.layout == OrgChart.layout.grid && Q.childrenIds.length > 2) {
              Q.layoutGridColumns == `dynamic` &&
                (Q.layoutGridColumns = OrgChart._getDynamicGridCoulumns(
                  Q.childrenIds.length,
                ));
              for (var xe = _.id, d = _.children.length - 1; d >= 0; d--)
                for (var E = 0; E < Q.childrenIds.length; E++) {
              ...
              Se % 2 != 0 && Se > 2 && Se--;
              for (var d = 0; d < Q.childrenIds.length; d += Se)
                for (var Ce = null, E = 0; E < Se; E++) {
                  var we = d + Se >= Q.childrenIds.length;
                  if (Q.childrenIds.length - 1 < d + E) break;
                  var _e = Q.childrenIds[d + E],
                    w = c[_e];
                  ((w.parent = c[xe]),
                    c[xe].children.push(w),
                    we ||
                      (Se / 2 - 1 == E &&
                        ((Ce = new OrgChart.node(
                          Q.childrenIds[d + E - 1] +
                            `_grid_pseudo_node_` +
                            Q.childrenIds[d + E + 1],
                          xe,
                        ...
                        OrgChart.manager._initDinamicNode(Ce, _.lcn),
                        (Ce.parent = c[xe]),
                        c[xe].children.push(Ce),
                        (c[Ce.id] = Ce)),
                      Se - 1 == E && (xe = Ce.id)));
                }
            }
            if (Q.layout == OrgChart.layout.mixed)
              for (var Te = Q.childrenIds, d = Te.length - 1; d >= 0; d--) {
                var w = c[Te[d]];
                ((_ = w.parent), (w.layout = OrgChart.layout.mixed));
                for (var E = _.children.length - 1; E >= 0; E--)
                  if (w.id == _.children[E].id) {
                    _.children.splice(E, 1);
                    break;
                  }
                if (d > 0) {
                  var Ee = c[Te[d - 1]];
                  ((w.parent = Ee),
                    (w.layout = OrgChart.layout.mixed),
                    Ee.children.push(w));
              ...
              (_.movex != null && (B.movex = _.movex),
                _.movey != null && (B.movey = _.movey),
                OrgChart.manager._initDinamicNode(B, _.lcn),
                (c[B.id] = B),
                (B.layout = Q.layout));
              for (var $ = [], d = Q.childrenIds.length - 1; d >= 0; d--) {
                for (
                  var w = c[Q.childrenIds[d]], E = 0;
                  E < _.children.length;
                  E++
                )
                  _.children[E].id == w.id && _.children.splice(E, 1);
                if (
                  ((w.parent = null),
                  (w.layout = Q.layout),
                  (Q.layout == OrgChart.layout.treeRightOffset ||
                    Q.layout == OrgChart.layout.treeRight) &&
                    $.splice(0, 0, w.id),
                  Q.layout > 2)
                ) {
                  var De = new OrgChart.node(
                    ye + `_` + w.id + `_mirror`,
                    Z.id,
                    [],
                    `mirror`,
                  );
                  (OrgChart.manager._initDinamicNode(De, w.lcn),
                    (De.layout = Q.layout),
                    (c[De.id] = De),
                    $.splice(0, 0, De.id));
                }
              ...
              for (var ce = 1, E = $.length - 1; E >= 0; E--)
                if (E % 2 && E != $.length - 1) {
                  var W = new OrgChart.node(
                    ye + `_` + _.id + `_split_` + ce,
                    Z.id,
                    [],
                    `split`,
                  );
                  (OrgChart.manager._initDinamicNode(W, _.lcn),
                    _.movex != null && (W.movex = _.movex),
                    _.movey != null && (W.movey = _.movey),
                    (W.layout = Q.layout),
                    (c[W.id] = W),
    ...
    if (OrgChart.VERTICAL_CHILDREN_ASSISTANT)
      for (var d = 0; d < l.length; d++)
        OrgChart.manager._verticalAssistantIterate(l[d], c);
    var Y = { nodes: c, roots: l };
    return (
      OrgChart.events.publish(`nodes-initialized`, [t, Y]),
      { nodes: Y.nodes, roots: Y.roots, rootList: u }
    );
  }),
  (OrgChart.manager._getOrderSortArray = function (e) {
    if (typeof e == `string`) return [{ field: e, desc: !1 }];
    if (Array.isArray(e)) {
      var t = [];
      for (var n of e)
        typeof n == `string`
          ? t.push({ field: n, desc: !1 })
          : e instanceof Object
            ? t.push(n)
  ...
  (OrgChart.manager._getNodeWidth = function (t, n) {
  ...
  (OrgChart.manager._isVisible = function (t, n, r, i, a, o, s) {
    var c = 0;
    if (OrgChart.LAZY_LOADING_FACTOR == `auto`) {
      var l = (o / a) * 2,
        u = (s / a) * 2;
      c = Math.ceil(l > u ? l : u);
    } else c = OrgChart.LAZY_LOADING_FACTOR / a;
    if (!(t.x == null || t.y == null)) {
      if (OrgChart._getLazyLoading(n) && i !== OrgChart.action.exporting) {
        function e(e, t) {
          var n = e.x,
            r = e.y,
            i = e.w,
    ...
    for (var r = 0; r < t.nodes.length; r++)
      for (var i in t.nodes[r])
        i !== OrgChart.ID &&
          ...
          i !== `movex` &&
          i !== `movey` &&
          (t.nodeBinding[i] || n.has(i) || n.push(i));
    return n;
  }),
  (OrgChart.manager._getMostDeepChild = function (e) {
    if (!e) return;
    var t = e;
    function n(e) {
      e.sl > t.sl && (t = e);
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ((v.top = c - i.padding),
      (v.left = s - i.padding),
      (v.bottom = o + i.padding - n / S),
      (v.right = a + i.padding - t / S),
      (v.maxX = a),
      (v.minX = s),
      (v.maxY = o),
      (v.minY = c),
      u.length == 0 || (l == null && !h && i.align == OrgChart.CENTER))
    ) {
      var C = Math.ceil(t / S),
        w = Math.ceil(n / S),
        T = 0,
        E = 0;
      if (C - i.padding * 2 >= a - s)
        switch (((T = (a + s) / 2 - C / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            T = (s - a) / 2 - C / 2;
            break;
        ...
        switch (
          ((T = g.x - C / 2 + OrgChart.manager._getNodeWidth(g, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            ((T = -(C / 2 - (s - a) / 2)),
              T < i.padding - C && (T = i.padding - C));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
      ...
      if (w - i.padding * 2 >= o - c)
        switch (((E = (o + c) / 2 - w / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            E = (c - o) / 2 - w / 2;
            break;
        ...
        switch (
          ((E = -(w / 2 - (o - c) / 2)),
          E > -i.padding && (E = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            ((E = -(w / 2 - (c - o) / 2)),
              E < i.padding - w && (E = i.padding - w));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            E = g.y - w / 2 + OrgChart.manager._getNodeWidth(g, i) / 2;
            break;
        }
      l = [T, E, C, w];
    } else if (l == null && !h && i.align == OrgChart.ORIENTATION) {
      var C = Math.ceil(t / S),
        w = Math.ceil(n / S),
        T = 0,
        E = 0;
    ...
    if (d == OrgChart.action.centerNode || d == OrgChart.action.maximize) {
      var D = OrgChart._getCenterNodeFromParams(p, f);
      (f.options.horizontal == 1 && (l[0] = D.x + D.w / 2 - l[2] / 2),
        f.options.vertical == 1 && (l[1] = D.y + D.h / 2 - l[3] / 2));
    }
    if (
      ...
      if (
        d == OrgChart.action.insert &&
        f &&
        f.insertedNodeId != null &&
        f.insertedNodeId != null
      )
        O = p[f.insertedNodeId];
      else if (
        d == OrgChart.action.update &&
        f &&
        f.visId != null &&
        ...
        ((O = p[f.id]), (O = OrgChart.manager._getMostDeepChild(O)));
        ...
        O &&= OrgChart.manager._getMostDeepChild(O);
      }
      if (!OrgChart.FIXED_POSITION_ON_CLICK && O) {
        if (O.isTreeListItem) {
    ...
    for (var A = 0; A < u.length; A++)
      OrgChart.manager._iterate2(u[A], p, i, l, d, f, _, m, r, y, S, t, n);
    return {
      animations: y,
      boundary: v,
      viewBox: l,
  ...
  (OrgChart.manager._iterate2 = function (
    ...
    if (OrgChart.manager._isVisible(t, r, i, a, d, f, p)) {
      s.push(t.id);
      var m = null;
      if (
        (a == OrgChart.action.expand ||
        ...
        if (((m = { x: h.x, y: h.y }), h)) {
          m = { x: h.x, y: h.y };
          for (var g = t, _ = null; g != null; )
            (c[g.id] && c[g.id].collapsed && (_ = g), (g = g.parent));
          _ && _.parent && (m = { x: _.parent.x, y: _.parent.y });
        }
        var v = n[o.id];
        if (v) {
          for (var g = t.parent; g != null; ) g = g.parent;
          g && (m = { x: v.x + v.w / 2 - t.w / 2, y: v.y + v.h / 2 - t.h / 2 });
        }
      } else if (
        ...
        if (v) {
          for (
            var g = t.parent;
            g != null && o.ids.indexOf(t.id) == -1 && o.ids.indexOf(g.id) == -1;
          )
            g = g.parent;
          g && (m = { x: v.x + v.w / 2 - t.w / 2, y: v.y + v.h / 2 - t.h / 2 });
        }
      } else if (a == OrgChart.action.centerNode && c && c[t.id]) {
        var h = c[t.id];
        h.x != null && h.y != null && (m = { x: h.x, y: h.y });
        var y = OrgChart._getCenterNodeFromParams(n, o);
        if (y && y == t) {
          var g = t.parent;
          g &&
            g.id == o.id &&
            (m = { x: y.x + y.w / 2 - t.w / 2, y: y.y + y.h / 2 - t.h / 2 });
        }
      } else if (a == OrgChart.action.maximize && c && c[t.id]) {
        var h = c[t.id];
        h.x != null && h.y != null && (m = { x: h.x, y: h.y });
        var y = OrgChart._getCenterNodeFromParams(n, o);
        if (y && y == t) {
      ...
      } else if (a == OrgChart.action.minimize && c && c[t.id]) {
        var h = c[t.id];
        m = { x: h.x, y: h.y };
      } else if (
        a == OrgChart.action.insert &&
        ...
        m = { x: t.parent.x, y: t.parent.y };
      else if (
        (a == OrgChart.action.update || a == OrgChart.action.insert) &&
        c
      ) {
        var h = c[t.id];
        if ((!h || (OrgChart.isNEU(h.x) && OrgChart.isNEU(h.y))) && o) {
          var v = n[o.id];
          if (v) {
            for (var g = v; g && g.id == t.id; ) g = g.parent;
            g && (m = { x: v.x, y: v.y });
          }
        } else h && (m = { x: h.x, y: h.y });
      } else
        a !== OrgChart.action.exporting &&
          a !== OrgChart.action.init &&
          l.indexOf(t.id) == -1 &&
      ...
      m != null &&
        ...
        m.y != null &&
        (m.x != t.x || m.y != t.y) &&
        !(o && o.dragNodeIdList && o.dragNodeIdList.indexOf(t.id) != -1) &&
        !t.isSplit &&
        (u[0].push(t.id),
        u[1].push({ transform: [1, 0, 0, 1, m.x, m.y] }),
        u[2].push({ transform: [1, 0, 0, 1, t.x, t.y] }));
    }
    ...
    for (var b = 0; b < t.children.length; b++)
      OrgChart.manager._iterate2(
        t.children[b],
        n,
        r,
  ...
  (OrgChart.manager._addExpandedNodeIdsIterate = function (t, n, r) {
    for (var i = 0; i < t.childrenIds.length; i++)
      (r.push(t.childrenIds[i]),
        OrgChart.manager._addExpandedNodeIdsIterate(n[t.childrenIds[i]], n, r));
  }),
  (OrgChart.manager._setChildCountPropsIterate = function (t, n) {
    if (t) {
      (t.w !== void 0 || (t.collapsedChildrenIds = t.childrenIds.slice()),
        (t.deepChildCount = t.childrenIds.length),
        (t.deepCollapsedChildCount = t.collapsedChildrenIds.length));
      for (var r = n[t.pid]; r; )
        ((r.deepCollapsedChildCount += t.collapsedChildrenIds.length),
          (r.deepChildCount += t.childrenIds.length),
          (r = n[r.pid]));
      for (var i of t.stChildrenIds)
        OrgChart.manager._setChildCountPropsIterate(n[i], n);
  ...
  (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (
    ...
    ((t.x += o.x), (t.y += o.y));
    for (var l of t.stChildren)
      OrgChart.manager._setMinMaxXYAdjustifyIterate(l, l, r, 0, a, o, s, c);
    (t.isPartner ? (t.sl = i - 1) : (t.sl = i),
      a[n.id] ?? (a[n.id] = {}),
      a[n.id][t.sl] ??
        (a[n.id][t.sl] = { minX: null, minY: null, maxX: null, maxY: null }),
      t.layout
        ? (c[n.id] ?? (c[n.id] = {}), c[n.id][t.sl] ?? (c[n.id][t.sl] = t))
        : OrgChart._setMinMaxXY(t, a[n.id][t.sl], !0),
      t.movex != null && (t.x += t.movex),
      t.movey != null && (t.y += t.movey),
      OrgChart._setMinMaxXY(t, r, !0),
      i++);
    for (var l of t.children)
      OrgChart.manager._setMinMaxXYAdjustifyIterate(l, n, r, i, a, o, s, c);
  }),
  (OrgChart.manager._doNotChangePositionOfClickedNodeIfAny = function (
    ...
    if (
      ...
      return { x: 0, y: 0 };
    if (r == OrgChart.action.update && (!i || i.id == null)) {
      if (!t || !t.length) return { x: 0, y: 0 };
      i = { id: t[0].id };
    }
    if (i.id == null) return { x: 0, y: 0 };
    var s = i.id;
    ((r == OrgChart.action.minimize && n[s].parent) ||
      (r == OrgChart.action.maximize && n[s].parent)) &&
      (s = n[s].pid);
    var c = n[s],
      l = a[s];
    if (!l) return { x: 0, y: 0 };
    var u = l.movex == null ? 0 : l.movex,
      d = l.movey == null ? 0 : l.movey,
      f = { x: (l.x ? l.x - u : 0) - c.x, y: (l.y ? l.y - d : 0) - c.y };
    return c && c.isTreeListItem ? { x: 0, y: 0 } : f;
  }),
  (OrgChart.manager._verticalAssistantIterate = function (t, n) {
    for (var r = 0; r < t.stChildren.length; r++)
      OrgChart.manager._verticalAssistantIterate(t.stChildren[r], n);
    if (t.children.length == 3)
      (OrgChart.manager._verticalAssistantIterate(t.children[0], n),
        OrgChart.manager._verticalAssistantIterate(t.children[2], n),
        OrgChart.manager._verticalAssistantIterate(t.children[1], n));
    else
      for (var r = 0; r < t.children.length; r++)
        OrgChart.manager._verticalAssistantIterate(t.children[r], n);
    if (t.isAssistant && t.isSplit && t.children.length) {
      for (
        var i = t.parent.children[0], a = t.parent.children[2], o = t.parent;
        !o.hasAssistants;
      )
        o = o.parent;
      var s = { max: 0 },
        c = { max: 0 };
      (OrgChart.manager._verticalAssistantLevelCountIterate(i, 0, s),
        OrgChart.manager._verticalAssistantLevelCountIterate(a, 0, c));
      for (var l = Math.max(s.max, c.max), u = [], r = 0; r < l; r++) {
        ...
        (OrgChart.manager._initDinamicNode(d, t.lcn, !0),
          o.movex != null && (d.movex = o.movex),
          o.movey != null && (d.movey = o.movey),
          r > 0 && (u[r - 1].children.push(d), (d.parent = u[r - 1])),
          (n[d.id] = d),
          u.push(d));
      }
      if (u.length) {
        for (
          var f = u[u.length - 1], p = u[0], m = t.children.length - 1;
          m >= 0;
          m--
        ) {
          var h = t.children[m];
  ...
  (OrgChart.manager._verticalAssistantLevelCountIterate = function (t, n, r) {
    (r.max < n && (r.max = n), n++);
    for (var i = 0; i < t.children.length; i++)
      OrgChart.manager._verticalAssistantLevelCountIterate(t.children[i], n, r);
  }),
  (OrgChart._addDottedLines = function (e) {
    var t = e.nodes;
    if (
      ...
      for (var n = [], r = 0; r < e.groupDottedLines.length; r++) {
        ...
        if (!n.has(a)) {
          for (var o = 0; o < t.length; o++)
            if (t[o].id == i.rootId) {
              ...
              ((s.id = `balkan_group_dotted_${i.rootId}_balkan_id_${t[o].id}`),
                (s.pid = void 0),
                (s.stpid = t[o].id),
                t.push(s),
                n.push(a),
                ...
                t[o].tags.push(`group-dotted-lines-` + a));
              break;
            }
        }
        for (var o = 0; o < t.length; o++)
          if (t[o].id == i.from) {
            ...
            if (
              ((s.id = `balkan_group_dotted_${i.rootId}_balkan_id_${t[o].id}`),
              (s.pid = `balkan_group_dotted_${i.rootId}_balkan_id_${i.to}`),
              s.tags)
            ) {
              var c = s.tags.indexOf(`group-dotted-lines`);
              c != -1 && s.tags.splice(c, 1);
            }
            if (((s.tags ||= []), s.tags.push(`boc-dotted-connector`), i.tags))
              for (var l = 0; l < i.tags.length; l++) s.tags.push(i.tags[l]);
            t.push(s);
            break;
          }
      }
    if (e.dottedLines.length)
      for (var r = 0; r < e.dottedLines.length; r++) {
        ...
        for (var o = 0; o < t.length; o++)
          if (t[o].id == u.from) {
            var s = JSON.parse(JSON.stringify(t[o]));
            if (
              ((s.id = `balkan_dotted_${u.rootId}_balkan_id_${t[o].id}`),
              u.rootId == u.to
                ? (s.pid = u.to)
                : (s.pid = `balkan_dotted_${u.rootId}_balkan_id_${u.to}`),
              (s.tags ||= []),
              s.tags.push(`boc-dotted-connector`),
              u.tags)
            )
              for (var l = 0; l < u.tags.length; l++) s.tags.push(u.tags[l]);
            t.push(s);
            break;
          }
      }
  ...
  (OrgChart.templates.ana = {
    ...
    field_0: function (t, n, r, i, a) {
      return OrgChart.wrapText(
        a,
        `<text style="font-size: 18px;" fill="#ffffff" x="${t.w / 2}" y="${t.h - 25}" text-anchor="middle"></text>`,
        t.w - 20,
        1,
      );
    },
    field_1: function (t, n, r, i, a) {
      return OrgChart.wrapText(
        a,
        `<text style="font-size: 14px;" fill="#ffffff" x="${t.w - 20}" y="30" text-anchor="end"></text>`,
        t.w - 120,
        3,
      );
    },
  ...
  (OrgChart.templates.emily = Object.assign({}, OrgChart.templates.ana)),
  (OrgChart.templates.emily.size = [200, 270]),
  (OrgChart.templates.emily.defs = `<style>.boc-hover .boc-emily-fill{fill: #039BE5;}
...
.boc-hover-self .boc-emily-photo{ transform: matrix(0.4,0,0,0.4,0,30) }
  ...
  (OrgChart.templates.emily.padding = [80, 0, 90, 0]),
  (OrgChart.templates.emily.link = `<path class="boc-emily-stroke" stroke-linejoin="round" stroke="#aeaeae" stroke-width="1px" fill="none" d="{rounded}" />`),
  (OrgChart.templates.emily.plus = function (e, t, n, r, i) {
    var a = r.mode == `dark` ? `#1E1E1E` : `#ffffff`;
  ...
  (OrgChart.templates.emily.minus = function (e, t, n, r, i) {
    var a = r.mode == `dark` ? `#1E1E1E` : `#ffffff`;
    return `<g  transform="matrix(1,0,0,1,${i.x - 15},${i.y - 15})"><circle class="boc-emily-stroke" cx="15" cy="15" r="15" fill="${a}" stroke="#aeaeae" stroke-width="1"></circle>
        <line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line></g>`;
  }),
  (OrgChart.templates.emily.node = function (t, n, r, i) {
    var a = `<rect  class="boc-emily-white"  x="0.5"  y="30"  height="${t.h - 80}"  width="${t.w - 1}"  fill="#fff" style="--boc-emily-h:${t.h - 80}px"></rect>`;
    return (
      t.treeList &&
        (a = `<rect  x="0.5"  y="30"  height="${t.h - 125}"  width="${t.w - 1}"  fill="#fff"></rect>`),
      `<rect class="boc-emily-fill" x="0" y="0" height="${t.h}" width="${t.w}" fill="#039BE5" stroke ="#aeaeae"   stroke-width="1"  rx="10" ry="10"></rect>        
        ${a}
          <g ${OrgChart.attr.control_node_btn}="pdf_profile" class="boc-emily-btn " transform="matrix(1,0,0,1,${t.w - 70},40)">${OrgChart.icon.pdf(24, 24, `#039BE5`)}<rect  x="0" y="0" width="30" height="30" fill="red" fill-opacity="0"></rect></g>
          <g ${OrgChart.attr.control_node_btn}="share_profile" class="boc-emily-btn" transform="matrix(1,0,0,1,${t.w - 35},40)">${OrgChart.icon.share(24, 24, `#039BE5`)}<rect x="0" y="0" width="30" height="30" fill="red" fill-opacity="0"></rect></g>
  `
    );
  }),
  (OrgChart.templates.emily.field_0 =
    OrgChart.templates.emily.name =
    OrgChart.templates.emily.name =
      function (t, n, r, i, a) {
        return OrgChart.wrapText(
          a,
          `<text style="font-size: 18px;" x="${t.w / 2}" y="${t.h - 20}" fill="#fff"  text-anchor="middle"></text>`,
          t.w - 10,
          1,
        );
      }),
  (OrgChart.templates.emily.field_1 =
    OrgChart.templates.emily.title =
    OrgChart.templates.emily.title =
      function (t, n, r, i, a) {
        return OrgChart.wrapText(
          a,
          `<text style="font-size: 14px;" x="${t.w / 2}" y="19" fill="#fff"  text-anchor="middle"></text>`,
          t.w - 10,
          1,
        );
      }),
  (OrgChart.templates.emily.email = function (t, n, r, i, a) {
    return n.email
      ? `<a class="boc-emily-link" href="mailto:${a}">
            <g transform="matrix(1,0,0,1,7,${t.h - 150})">
              ...
              ${OrgChart.wrapText(a, `<text x="30" y="15" fill="#039BE5" font-size="13"></text>`, t.w - 30, 1)}                
              <rect style="opacity:0" x="0" y="0" width="${t.w - 14}" height="20" fill="red" />
            </g>  
          </a>`
      : ``;
  }),
  (OrgChart.templates.emily.address = function (t, n, r, i, a) {
    return n.address
      ? `<a class="boc-emily-link" target="_blank" href="https://www.google.com/maps/place/${a}/" >
  ...
  (OrgChart.templates.emily.description = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 14px;" x="${t.w / 2}" y="${t.h - 70}" fill="#fff"  text-anchor="middle"></text>`,
      t.w - 30,
      3,
    );
  }),
  (OrgChart.templates.emily.img_0 = function (e, t, n, r, i) {
    return i && !e.treeList
      ? `<g class="boc-emily-photo" transform="matrix(1,0,0,1,0,30)" ><image   preserveAspectRatio="xMidYMid slice" xlink:href="${i}" x="0.5" y="0"  width="${e.w - 1}" height="${e.h - 80}" ></image></g>`
      : ``;
  }),
  (OrgChart.templates.emily.nodeMenuButton = function (e, t, n, r) {
    return `
  ...
  (OrgChart.templates.ula.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.ula.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.ula.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.ula.img_0 = function (t, n, r, i, a) {
    var o = 50,
      s = 60,
      c = 40,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.ula.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.olivia.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.olivia.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.olivia.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.olivia.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.belinda.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" text-anchor="middle" fill="#ffffff"  x="${t.w / 2}" y="${t.h / 2 + 15}"></text>`,
      t.w - 10,
      1,
    );
  }),
  (OrgChart.templates.belinda.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 14px;" text-anchor="middle" fill="#ffffff"  x="${t.w / 2}" y="${t.h / 2 + 35}"></text>`,
      t.w - 20,
      2,
    );
  }),
  (OrgChart.templates.belinda.link = `<path class="boc-hoverable" stroke="#aeaeae" stroke-width="1px" fill="none" d="M{xa},{ya} C{xb},{yb} {xc},{yc} {xd},{yd}"/>`),
  (OrgChart.templates.belinda.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.rony.img_0 = function (t, n, r, i, a) {
    var o = t.w / 2,
      s = 160,
      c = 60,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.rony.node = function (e, t, n, r) {
    return `<rect  filter="url(#{randId})" x="0" y="0" height="${e.h}" width="${e.w}" fill="#ffffff" stroke-width="0" rx="10" ry="10"></rect>'`;
  }),
  (OrgChart.templates.rony.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" fill="#039BE5" x="${t.w / 2}" y="40" text-anchor="middle"></text>`,
      t.w - 15,
      1,
    );
  }),
  (OrgChart.templates.rony.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 14px;" fill="#F57C00" x="${t.w / 2}" y="60" text-anchor="middle"></text>`,
      t.w - 15,
      3,
    );
  }),
  (OrgChart.templates.rony.field_2 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 14px;" fill="#FFCA28" x="${t.w / 2}" y="80" text-anchor="middle"></text>`,
      t.w - 15,
      1,
    );
  }),
  (OrgChart.templates.rony.link = `<path class="boc-hoverable" stroke="#039BE5" stroke-width="1px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>`),
  (OrgChart.templates.rony.plus = function (e, t, n, r, i) {
  ...
  (OrgChart.templates.rony.minus = function (e, t, n, r, i) {
  ...
  (OrgChart.templates.rony.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.mery.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.mery.link = `<path class="boc-hoverable" stroke="#aeaeae" stroke-width="1px" fill="none" d="M{xa},{ya} C{xb},{yb} {xc},{yc} {xd},{yd}" />`),
  (OrgChart.templates.mery.img_0 = function (t, n, r, i, a) {
    var o = t.w / 2,
      s = t.h / 2,
      c = 24,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.mery.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" fill="#039BE5" x="${t.w / 2}" y="${t.h / 2 - 30}" text-anchor="middle"></text>`,
      t.w - 30,
      1,
    );
  }),
  (OrgChart.templates.mery.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 14px;" fill="#039BE5" x="${t.w / 2}" y="${t.h / 2 + 40}" text-anchor="middle"></text>`,
      t.w - 30,
      1,
    );
  }),
  (OrgChart.templates.mery.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.polina.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.polina.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.polina.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.polina.link = `<path class="boc-hoverable" stroke="#686868" stroke-width="1px" fill="none" d="M{xa},{ya} C{xb},{yb} {xc},{yc} {xd},{yd}" />`),
  (OrgChart.templates.polina.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.mila.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.mila.img_0 = function (e, t, n, r, i) {
    return `<image preserveAspectRatio="xMidYMid slice" xlink:href="${i}" x="20" y="${e.h - 115}"  width="64" height="64"></image>`;
  }),
  (OrgChart.templates.mila.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" fill="#039BE5" x="${t.w / 2}" y="${t.h - 28}" text-anchor="middle"></text>`,
      t.w - 10,
      1,
    );
  }),
  (OrgChart.templates.mila.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.diva.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.diva.img_0 = function (t, n, r, i, a) {
    var o = t.w / 2,
      s = 50,
      c = 45,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.diva.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" fill="#ffffff" x="${t.w / 2}" y="125" text-anchor="middle"></text>`,
      t.w - 15,
      1,
    );
  }),
  (OrgChart.templates.diva.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text  style="font-size: 14px;" fill="#ffffff" x="${t.w / 2}" y="145" text-anchor="middle"></text>`,
      t.w - 15,
      1,
    );
  }),
  ...
  (OrgChart.templates.diva.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.luba.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.luba.img_0 = function (t, n, r, i, a) {
    var o = 50,
      s = 25,
      c = 40,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.luba.nodeMenuButton = function (e, t, n, r) {
    return `<g transform="matrix(1,0,0,1,${e.w - 25},${e.h - 15})"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#aeaeae"></circle><circle cx="7" cy="0" r="2" fill="#aeaeae"></circle><circle cx="14" cy="0" r="2" fill="#aeaeae"></circle></g>`;
  }),
  (OrgChart.templates.luba.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 18px;" fill="#aeaeae" x="${t.w / 2}" y="${t.h - 30}" text-anchor="middle"></text>`,
      t.w - 15,
      1,
    );
  }),
  (OrgChart.templates.luba.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text  style="font-size: 14px;" fill="#aeaeae" x="${t.w - 10}" y="30" text-anchor="end"></text>`,
      t.w - 110,
      1,
    );
  }),
  (OrgChart.templates.luba.plus = `<rect class="boc-hoverable" x="0" y="0" width="36" height="36" rx="12" ry="12" fill="#2E2E2E" stroke="#aeaeae" stroke-width="1"></rect><line x1="4" y1="18" x2="32" y2="18" stroke-width="1" stroke="#aeaeae"></line><line x1="18" y1="4" x2="18" y2="32" stroke-width="1" stroke="#aeaeae"></line>`),
  (OrgChart.templates.luba.minus = `<rect class="boc-hoverable" x="0" y="0" width="36" height="36" rx="12" ry="12" fill="#2E2E2E" stroke="#aeaeae" stroke-width="1"></rect><line x1="4" y1="18" x2="32" y2="18" stroke-width="1" stroke="#aeaeae"></line>`),
  ...
  (OrgChart.templates.isla.node = function (e, t, n, r) {
  ...
  (OrgChart.templates.isla.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 12px;" fill="#fff" x="${t.w / 2}" y="${t.h - 30}" text-anchor="middle"></text>`,
      t.w - 60,
      1,
    );
  }),
  (OrgChart.templates.isla.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text  style="font-size: 13px;" fill="#039BE5" x="${t.w / 2}" y="64" text-anchor="middle"></text>`,
      t.w - 20,
      1,
    );
  }),
  (OrgChart.templates.isla.img_0 = ``),
  (OrgChart.templates.isla.img_0 = function (t, n, r, i, a) {
    var o = OrgChart.randomId();
  ...
  (OrgChart.templates.isla.minus = `<circle class="boc-hoverable" cx="15" cy="15" r="15" fill="#F57C00" stroke="#F57C00" stroke-width="1"></circle><line x1="8" y1="15" x2="22" y2="15" stroke-width="1" stroke="#ffffff"></line>`),
  (OrgChart.templates.isla.plus = `<circle class="boc-hoverable" cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#039BE5"></line>`),
  (OrgChart.templates.isla.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.deborah.field_0 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
  ...
  (OrgChart.templates.deborah.field_1 = function (t, n, r, i, a) {
    return OrgChart.wrapText(
      a,
      `<text style="font-size: 11px;" fill="#ffffff" x="15" y="${t.h - 15}" text-anchor="start"></text>`,
      t.w - 45,
      1,
    );
  }),
  (OrgChart.templates.deborah.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.clara.img_0 = function (t, n, r, i, a) {
    var o = 50,
      s = 30,
      c = 40;
  ...
  (OrgChart.templates.clara.field_0 = function (t, n, r, i, a) {
    var o = 65,
      s = t.w / 2,
      c = `middle`,
      l = t.w - 100;
    return (
      t.stChildren.length ||
        ((c = `middle`), (s = t.w / 2), (o = 160), (l = t.w - 20)),
      OrgChart.wrapText(
        a,
        `<text style="font-size: 20px;" fill="#ffffff" x="${s}" y="${o}" text-anchor="${c}"></text>`,
        l,
        1,
      )
    );
  }),
  (OrgChart.templates.clara.field_1 = function (t, n, r, i, a) {
    var o = 35,
      s = t.w - 15,
      c = `end`,
      l = t.w - 100;
    return (
      t.stChildren.length ||
        ((c = `middle`), (s = t.w / 2), (o = 180), (l = t.w - 20)),
      OrgChart.wrapText(
        a,
        `<text style="font-size: 14px;" fill="#ffffff" x="${s}" y="${o}" text-anchor="${c}"></text>`,
        l,
        1,
      )
    );
  }),
  (OrgChart.templates.clara.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.clara.node = function (e, t, n, r) {
    return `<rect class="boc-hoverable"  x="0" y="0" height="${e.h}" width="${e.w}" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="10" ry="10"></rect>`;
  }),
  (OrgChart.templates.treeListItem = Object.assign({}, OrgChart.templates.ana)),
  (OrgChart.templates.treeListItem.size = [350, 60]),
  (OrgChart.templates.treeListItem.field_0 = function (t, n, r, i, a) {
    var o = t.level * r.expandCollapseSize + 45,
      s = i.mode == `dark` ? `#ccc` : `#757575`;
    return OrgChart.wrapText(
      a,
      `<text fill="${s}"  x="${o}" y="27" style="font-size:16px;"></text>`,
      t.w - o - 70,
      1,
    );
  }),
  (OrgChart.templates.treeListItem.field_1 = function (t, n, r, i, a) {
    var o = t.level * r.expandCollapseSize + 45,
      s = i.mode == `dark` ? `#ccc` : `#757575`;
    return OrgChart.wrapText(
      a,
      `<text fill="${s}" x="${o}" y="47" style="font-size:12px;"></text>`,
      t.w - o - 70,
      1,
    );
  }),
  (OrgChart.templates.treeListItem.img_0 = function (t, n, r, i, a) {
    var o = t.w - 55,
      s = t.h / 2,
      c = t.h / 2 - 4,
      l = OrgChart.randomId();
  ...
  (OrgChart.templates.treeListItem.plus = function (e, t, n, r) {
    var i = n.expandCollapseSize / 2 + e.level * n.expandCollapseSize,
      a = e.h / 2;
  ...
  (OrgChart.templates.treeListItem.minus = function (e, t, n, r) {
    var i = n.expandCollapseSize / 2 + e.level * n.expandCollapseSize,
      a = e.h / 2;
    a -= n.expandCollapseSize / 2;
    var o = r.mode == `dark` ? `#ccc` : `#757575`;
  ...
  (OrgChart.templates.treeListItem.nodeMenuButton = function (e, t, n, r) {
  ...
  (OrgChart.templates.treeListItem.node = function (e, t, n, r) {
    var i = ``,
      a = `#FFFFFF`;
    if (
      (e.isTreeListItem && !e.stParent) ||
      (e.isTreeListItem && e.stParent && e.stParent.stChildren[0] != e)
    ) {
      var o = `#E0E0E0`;
      (r.mode == `dark` && (o = `#444444`),
        (i = `<line stroke="${o}" stroke-width="1" x1="0" x2="${e.w}" y1="0" y2="0"></line>`));
    }
    return (
      r.mode == `dark` && (a = `#252526`),
      `<rect fill="${a}" x="0" y="0" height="${e.h}" width="${e.w}"  rx="0" ry="0" ></rect>${i}`
    );
  }),
  (OrgChart.ui = {
    _defsIds: {},
    defs: function (t) {
      ...
      for (var r in OrgChart.templates) {
        ...
        i.defs &&
          ...
          (n += i.defs.replaceAll(`{randId}`, OrgChart.ui._defsIds[r])));
      }
    ...
    pointer: function (t, n, r) {
      if (n === OrgChart.action.exporting) return ``;
    ...
    node: function (t, n, r, i, a, o, s, c, l, u, d) {
      var f = OrgChart.t(t.templateName, t.min, l),
        p = ``;
      (typeof f.node == `function`
        ? (p = f.node(t, n, f, i))
        : OrgChart.isNEU(f.node) ||
          ((p = f.node),
          (p &&= p.replaceAll(`{w}`, t.w).replaceAll(`{h}`, t.h))),
        f.defs &&
          (p = p.replaceAll(`{randId}`, OrgChart.ui._defsIds[t.templateName])),
        (s ??= i.nodeBinding));
      var m = { node: t, data: n };
      for (var h in s) {
        var g = s[h],
        ...
        typeof m.element == `function` &&
          ((v = !0), (m.element = m.element(t, n, f, i, m.value)));
        var y = OrgChart._lblIsImg(i, h);
        if (
          ((m.name = g),
          (m.field = h),
          OrgChart.events.publish(`field`, [u, m]) !== !1 &&
            m.value != null &&
            m.value != null &&
            m.element != null)
        ) {
          if (v) p += m.element;
          else if (!y || (y && !OrgChart.isNEU(m.value))) {
            if (!y && typeof m.value == `string`) {
              var b = m.element;
              ((b &&= b
                .replaceAll(`{ew}`, t.w - (t.padding ? t.padding[1] : 0))
                .replaceAll(`{cw}`, t.w / 2)),
                (m.value = OrgChart.wrapText(m.value, b)));
            }
      ...
      var S = OrgChart._getPosition(r, t, a, o),
        C = `node`;
      ...
      var T = OrgChart.nodeOpenTag
          ...
          .replace(`{x}`, S.x)
          .replace(`{y}`, S.y),
        E = OrgChart._getOpacity(r, t);
      return (
        (T = T.replace(`{opacity}`, E)),
        (p += OrgChart.ui.nodeBtns(i, t, n, c, f, u)),
        (p = T + p + OrgChart.grCloseTag),
        p
      );
    },
    nodeBtns: function (t, n, r, i, a, o) {
      ...
      return (
        t.nodeMenu != null &&
          ...
          (typeof a.nodeMenuButton == `function`
            ? (s += a.nodeMenuButton(n, r, a, t))
            : OrgChart.isNEU(a.nodeMenuButton) ||
              (s += a.nodeMenuButton
                .replace(`{id}`, n.id)
                .replace(`{cw}`, n.w / 2)
                .replace(`{ch}`, n.h / 2)
                .replace(`{ew}`, n.w - (n.padding ? n.padding[1] : 0))
                .replace(`{eh}`, n.h - (n.padding ? n.padding[2] : 0)))),
        (s &&= `<g style="cursor:pointer;" ${OrgChart.attr.control_node_menu_id}="${n.id}">${s}</g>`),
        t.nodeCircleMenu != null &&
          !n.isSplit &&
          i !== OrgChart.action.exporting &&
          (OrgChart.isNEU(a.nodeCircleMenuButton) ||
            (s +=
              `<g style="cursor:pointer;" transform="matrix(1,0,0,1,` +
              a.nodeCircleMenuButton.x +
              `,` +
              a.nodeCircleMenuButton.y +
              `)" ` +
              OrgChart.attr.control_node_circle_menu_id +
              `="` +
              n.id +
              `"><circle cx="0" cy="0" fill="` +
              a.nodeCircleMenuButton.color +
              `" r="` +
              a.nodeCircleMenuButton.radius +
              `" stroke-width="1" stroke="` +
              a.nodeCircleMenuButton.stroke +
              `"></circle><line x1="-` +
              a.nodeCircleMenuButton.radius / 2 +
              `" y1="-6" x2="` +
              a.nodeCircleMenuButton.radius / 2 +
    ...
    expandCollapseBtn: function (t, n, r, i, a, o, s) {
      var c = ``;
      if (o !== OrgChart.action.exporting && !n.isSplit) {
        var l = a[n.lcn ? n.lcn : `base`],
          u = OrgChart.t(n.templateName, n.min, s);
        if (n.childrenIds.length) {
          ...
          var m = OrgChart._getDefailtPositionForExpandCollpase(l, n),
            h = {
              x: m.x + n.x - u.expandCollapseSize / 2,
              y: m.y + n.y - u.expandCollapseSize / 2,
            };
          (n.collapsedChildrenIds.length
            ? (typeof u.plus == `function`
                ? ((c += OrgChart.expcollOpenTag
                    .replace(`{id}`, n.id)
                    .replace(`{x}`, n.x)
                    .replace(`{y}`, n.y)),
                  (c += u.plus(n, r, u, i, m)))
                : ((c += OrgChart.expcollOpenTag
                    ...
                    .replace(`{y}`, h.y)),
                  (c += u.plus)),
              (c += OrgChart.grCloseTag))
            : (typeof u.minus == `function`
                ? ((c += OrgChart.expcollOpenTag
                    .replace(`{id}`, n.id)
                    .replace(`{x}`, n.x)
                    .replace(`{y}`, n.y)),
                ...
                : ((c += OrgChart.expcollOpenTag
                  ...
                  (c += u.minus)),
              (c += OrgChart.grCloseTag)),
            ((n.collapsedChildrenIds.length && typeof u.plus != `function`) ||
              (!n.collapsedChildrenIds.length &&
                typeof u.minus != `function`)) &&
              (c.indexOf(`{collapsed-children-count}`) != -1 &&
                (c = c.replace(
                  `{collapsed-children-count}`,
                  n.collapsedChildrenIds.length,
                )),
              c.indexOf(`{collapsed-children-total-count}`) != -1 &&
                (c = c.replace(
                  `{collapsed-children-total-count}`,
                  n.deepCollapsedChildCount,
                )),
              c.indexOf(`{children-count}`) != -1 &&
                (c = c.replace(`{children-count}`, n.childrenIds.length)),
              c.indexOf(`{children-total-count}`) != -1 &&
                (c = c.replace(`{children-total-count}`, n.deepChildCount))));
        }
        t._nodeHasHiddenParent(n) &&
          ((c += OrgChart.upOpenTag
            .replace(`{id}`, n.id)
            .replace(`{x}`, n.x)
            .replace(`{y}`, n.y)),
          (c += u.up),
      ...
      var g = { html: c, node: n };
      return (OrgChart.events.publish(`renderbuttons`, [t, g]), g.html);
    },
    link: function (t, n, r, i, a, o, s) {
      var c = t.lcn ? t.lcn : `base`,
        l = n._layoutConfigs[c],
        u = OrgChart.t(t.templateName, t.min, r),
        d = [],
        f = [],
        p = 0,
        m = l.levelSeparation / 2;
      ...
      if (t.hasPartners) {
        v = {
          ...
          partnerChildrenSplitSeparation:
            n.config.partnerChildrenSplitSeparation,
        };
        for (var y = 0; y < t.children.length; y++) {
          var b = t.children[y];
          b.parentPartner
            ? ((v.ppnodes[b.id] = b.parentPartner),
              v.ids.push(b.id),
              b.parentPartner.isPartner == 1
                ? (v.rightIds.indexOf(b.parentPartner.id) == -1 &&
                    v.rightIds.push(b.parentPartner.id),
                  (v.indexes[b.id] = v.rightIds.indexOf(b.parentPartner.id)),
                  (v.firstRight ||= b))
                : b.parentPartner.isPartner == 2 &&
                  (v.leftIds.indexOf(b.parentPartner.id) == -1 &&
                    v.leftIds.push(b.parentPartner.id),
                  (v.indexes[b.id] = v.leftIds.indexOf(b.parentPartner.id)),
                  (v.lastLeft = b)))
            : b.isPartner || ((v.lastLeft = b), (v.firstRight ||= b));
        }
        ((v.maxSidePartnersWithChildren = Math.max(
          v.leftIds.length,
          v.rightIds.length,
        )),
          (h =
            v.maxSidePartnersWithChildren == 0
              ? n.config.minPartnerSeparation / 2
              : n.config.minPartnerSeparation / 2 +
                v.partnerChildrenSplitSeparation *
                  v.maxSidePartnersWithChildren +
                v.partnerChildrenSplitSeparation / 2));
      }
      for (var y = 0; y < t.children.length; y++) {
        var b = t.children[y],
          x = i[g][b.sl],
        ...
        (b.isSplit &&
          (b.leftNeighbor &&
          !b.leftNeighbor.isMirror &&
          b.leftNeighbor.pid == b.pid
            ? (C = b.leftNeighbor.templateName)
            : b.rightNeighbor &&
              !b.rightNeighbor.isMirror &&
              b.rightNeighbor.pid == b.pid &&
              (C = b.rightNeighbor.templateName)),
          (u = OrgChart.t(C, b.min, r)));
        var w = u.link;
        if (b.isChildOfPartner)
          switch (l.orientation) {
            ...
            case OrgChart.orientation.top_left:
              ...
              S = OrgChart.ui._linkTopToBottom(b.parentPartner, b, u, m, T, n);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              var T = b.layout == 1 ? void 0 : x.maxY - (x.maxY - _.minY) / 2;
              S = OrgChart.ui._linkBottomToTop(b.parentPartner, b, u, m, T, n);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              var T = b.layout == 1 ? void 0 : x.maxX - (x.maxX - _.minX) / 2;
              S = OrgChart.ui._linkRightToLeft(b.parentPartner, b, u, m, T, n);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              var T = b.layout == 1 ? void 0 : x.minX - (x.minX - _.maxX) / 2;
              S = OrgChart.ui._linkLeftToRight(b.parentPartner, b, u, m, T, n);
              break;
          }
        else if (v && v.ids.indexOf(b.id) != -1)
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              S = OrgChart.ui._linkPpTop(v, t, b, x, _, u);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              S = OrgChart.ui._linkPpBottom(v, t, b, x, _, u);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              S = OrgChart.ui._linkPpRight(v, t, b, x, _, u);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              S = OrgChart.ui._linkPpLeft(v, t, b, x, _, u);
              break;
          }
        else {
          var E =
          ...
          if ((E || b.layout > 1) && b.rightNeighbor && b.rightNeighbor.isSplit)
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                S = OrgChart.ui._linkRightToLeft(b.rightNeighbor, b, u, m);
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                S = OrgChart.ui._linkRightToLeft(b.rightNeighbor, b, u, m);
              ...
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                S = OrgChart.ui._linkBottomToTop(b.rightNeighbor, b, u, m);
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                S = OrgChart.ui._linkBottomToTop(b.rightNeighbor, b, u, m);
            ...
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                S = OrgChart.ui._linkLeftToRight(b.leftNeighbor, b, u, m, n);
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                S = OrgChart.ui._linkLeftToRight(b.leftNeighbor, b, u, m, n);
              ...
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                S = OrgChart.ui._linkTopToBottom(b.leftNeighbor, b, u, m, n);
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                S = OrgChart.ui._linkTopToBottom(b.leftNeighbor, b, u, m, n);
            ...
            switch (l.orientation) {
              ...
              case OrgChart.orientation.top_left:
                if (b.isPartner == 1)
                  S = OrgChart.ui._linkLeftToRight(t, b, u, h);
                else if (b.isPartner == 2)
                  S = OrgChart.ui._linkRightToLeft(t, b, u, h);
                else {
                  var T =
                    b.layout == 1 ? void 0 : x.minY - (x.minY - _.maxY) / 2;
                  S = OrgChart.ui._linkTopToBottom(t, b, u, m, T, n);
                }
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (b.isPartner == 1)
                  ...
                  var T =
                    b.layout == 1 ? void 0 : x.maxY - (x.maxY - _.minY) / 2;
                  S = OrgChart.ui._linkBottomToTop(t, b, u, m, T, n);
                }
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (b.isPartner == 1)
                  S = OrgChart.ui._linkTopToBottom(t, b, u, h);
                else if (b.isPartner == 2)
                  S = OrgChart.ui._linkBottomToTop(t, b, u, h);
                else {
                  var T =
                    b.layout == 1 ? void 0 : x.maxX - (x.maxX - _.minX) / 2;
                  S = OrgChart.ui._linkRightToLeft(t, b, u, m, T, n);
                }
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (b.isPartner == 1)
                  ...
                  var T =
                    b.layout == 1 ? void 0 : x.minX - (x.minX - _.maxX) / 2;
                  S = OrgChart.ui._linkLeftToRight(t, b, u, m, T, n);
                }
                break;
            }
        }
        var O,
          k = OrgChart.ui._draggableLinkPath(n, t, b, S, m, l.orientation);
        if (k)
          ((O = k),
            (w = w
              .replaceAll(`{rounded}`, k)
              .replaceAll(`{edge}`, k)
              .replaceAll(`{curve}`, O)));
        else if (w.indexOf(`{rounded}`) != -1)
          if (
            (S.xa == S.xb && S.xa == S.xc && S.xa == S.xd) ||
            (S.ya == S.yb && S.ya == S.yc && S.ya == S.yd)
          )
            ((O = `M` + S.xa + `,` + S.ya + ` L` + S.xd + `,` + S.yd),
              (w = w.replaceAll(`{rounded}`, O)));
          else if (
            Math.abs(S.xa - S.xd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(S.xa - S.xc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(S.xa - S.xb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            ((O = `M` + S.xa + `,` + S.ya + ` L` + S.xa + `,` + S.yd),
              (w = w.replaceAll(`{rounded}`, O)));
          else if (
            Math.abs(S.ya - S.yd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(S.ya - S.yc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(S.ya - S.yb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            ((O = `M` + S.xa + `,` + S.ya + ` L` + S.xd + `,` + S.ya),
              (w = w.replaceAll(`{rounded}`, O)));
          else {
            var A = OrgChart.ui._roundedEdge(
                S.xa,
                S.ya,
                S.xb,
                S.yb,
              ...
              j = OrgChart.ui._roundedEdge(S.xb, S.yb, S.xc, S.yc, S.xd, S.yd);
            ((O =
              `M` +
              A.x1 +
              `,` +
        ...
        var M = { node: t, cnode: b, p: S, html: w, action: o };
        (OrgChart.events.publish(`render-link`, [n, M]),
          d.push(M.html),
          s && f.push({ id: t.id, childId: b.id, html: M.html }));
        var N = ``;
        for (var P in n.config.linkBinding) {
          var F = n.config.linkBinding[P],
            I = n._get(b.id);
          I &&
            ((M.value = I[F]),
            (M.element = u[P]),
            (M.name = F),
            OrgChart.events.publish(`label`, [n, M]) !== !1 &&
              !OrgChart.isNEU(M.value) &&
              !OrgChart.isNEU(M.element) &&
              (N += M.element.replace(`{val}`, M.value)));
        }
        if (N != ``) {
          var ee = S.x,
            L = S.y;
          (b.movey != null && (L += b.movey),
            (N =
    ...
    _roundedEdge: function (t, n, r, i, a, o) {
      var s = OrgChart.LINK_ROUNDED_CORNERS,
        c,
        l,
        u,
        d = 0;
      return (
        (t == r && t == a) || (n == i && n == o)
          ...
          : (t != a &&
              ...
              (l = i),
              n < o ? (d = i + s) : n > o && (d = i - s)),
            t < a && r == a ? (r -= s) : t > a && r == a && (r += s),
            n != o &&
              i == o &&
              ((c = r),
              (l = d = i),
              t < a ? (u = r + s) : t > a && (u = r - s)),
            n < o && i == o ? (i -= s) : n > o && i == o && (i += s)),
        {
          x1: t,
          y1: n,
          x2: r,
    ...
    _linkTopToBottom: function (t, n, r, i, a, o) {
      var s = 0,
        ...
        g = 0,
        _ = 0;
      ((s = t.x + t.w / 2 + r.linkAdjuster.toX),
        (c = t.y + t.h + r.linkAdjuster.toY),
        (p = d = n.x + n.w / 2 + r.linkAdjuster.fromX),
        (m = n.y + r.linkAdjuster.fromY),
        (l = s),
        (u = f =
          t.rightNeighbor &&
          t.rightNeighbor.isAssistant &&
          n.templateName == `split`
            ? t.rightNeighbor.y + t.rightNeighbor.h + i
            : t.templateName == `split` && (n.isAssistant || n.layout > 1)
              ? m
              : n.templateName == `split`
                ? c + i
                : (a ?? m - i)),
        (h = d),
        (g = OrgChart.isNEU(n.parentPartner) ? f + 16 : f));
      var v = {
        xa: s,
        ya: c,
        xb: l,
      ...
      return (o && OrgChart._addConnectorLines(o._connectorLines, v), v);
    },
    _linkBottomToTop: function (t, n, r, i, a, o) {
      var s = 0,
        ...
        _ = 0;
      ((s = t.x + t.w / 2 + r.linkAdjuster.toX),
        (c = t.y + r.linkAdjuster.toY),
        (p = d = n.x + n.w / 2 + r.linkAdjuster.fromX),
        (m = n.y + n.h + r.linkAdjuster.fromY),
        (l = s),
        (u = f =
          t.rightNeighbor &&
          t.rightNeighbor.isAssistant &&
    ...
    _linkRightToLeft: function (t, n, r, i, a, o) {
      var s = 0,
        ...
        g = 0,
        _ = 0;
      ((s = t.x + r.linkAdjuster.toX),
        (c = t.y + t.h / 2 + r.linkAdjuster.toY),
        (p = n.x + n.w + r.linkAdjuster.fromX),
        (m = f = n.y + n.h / 2 + r.linkAdjuster.fromY),
        (u = c),
        (l = d =
          t.rightNeighbor &&
          t.rightNeighbor.isAssistant &&
    ...
    _linkLeftToRight: function (t, n, r, i, a, o) {
      var s = 0,
        ...
        g = 0,
        _ = 0;
      ((s = t.x + t.w + r.linkAdjuster.toX),
        (c = t.y + t.h / 2 + r.linkAdjuster.toY),
        (p = n.x + r.linkAdjuster.fromX),
        (m = f = n.y + n.h / 2 + r.linkAdjuster.fromY),
        (u = c),
        (l = d =
          t.rightNeighbor &&
    ...
    _linkPpTop: function (t, n, r, i, a, o) {
      var s = t.ppnodes[r.id],
        c = s.y + s.h / 2,
        l = i.minY - (i.minY - a.maxY) / 2,
        u = (i.minY - a.maxY) / t.maxSidePartnersWithChildren / 4,
        d = OrgChart.ui.__linkPpBottomTop(t, n, r, l, u, s),
        f = d.x;
      return (
        (l = d.mid),
        OrgChart.ui._linkTopToBottom({ x: f, y: c, w: 0, h: 0 }, r, o, 0, l)
      );
    },
    _linkPpBottom: function (t, n, r, i, a, o) {
      var s = t.ppnodes[r.id],
        c = s.y + s.h / 2,
        l = i.maxY - (i.maxY - a.minY) / 2,
        u = (i.maxY - a.minY) / t.maxSidePartnersWithChildren / 4,
        d = OrgChart.ui.__linkPpBottomTop(t, n, r, l, u, s),
        f = d.x;
      return (
        (l = d.mid),
        OrgChart.ui._linkBottomToTop({ x: f, y: c, w: 0, h: 0 }, r, o, 0, l)
      );
    },
    _linkPpLeft: function (t, n, r, i, a, o) {
      var s = t.ppnodes[r.id],
        c = i.minX - (i.minX - a.maxX) / 2,
        l = (i.minX - a.maxX) / t.maxSidePartnersWithChildren / 4,
        u = s.x + s.w / 2,
        d = OrgChart.ui.__linkPpLeftRight(t, n, r, c, l, s),
        f = d.y;
      return (
        (c = d.mid),
        OrgChart.ui._linkLeftToRight({ x: u, y: f, w: 0, h: 0 }, r, o, 0, c)
      );
    },
    _linkPpRight: function (t, n, r, i, a, o) {
      var s = t.ppnodes[r.id],
        c = i.maxX - (i.maxX - a.minX) / 2,
        l = (i.maxX - a.minX) / t.maxSidePartnersWithChildren / 4,
        u = s.x + s.w / 2,
        d = OrgChart.ui.__linkPpLeftRight(t, n, r, c, l, s),
        f = d.y;
      return (
        (c = d.mid),
        OrgChart.ui._linkRightToLeft({ x: u, y: f, w: 0, h: 0 }, r, o, 0, c)
      );
    },
      ...
      return (
        a.isPartner == 1
          ? ((o =
              ...
              e.indexes[n.id] * e.partnerChildrenSplitSeparation -
              ((e.rightIds.length - 1) * e.partnerChildrenSplitSeparation) / 2),
            e.lastLeft && o < e.lastLeft.x + e.lastLeft.w / 2
              ? o < n.x + n.w / 2
                ? (r -= (e.indexes[n.id] + 1) * i)
                : (r -= (e.rightIds.length - e.indexes[n.id]) * i)
              : o < n.x + n.w / 2
                ? (r += (e.rightIds.length - e.indexes[n.id]) * i)
                : (r += (e.indexes[n.id] + 1) * i))
          : a.isPartner == 2 &&
            ...
            e.firstRight && o > e.firstRight.x + e.firstRight.w / 2
              ? o < n.x + n.w / 2
                ? (r -= (e.indexes[n.id] + 1) * i)
                : (r -= (e.leftIds.length - e.indexes[n.id]) * i)
              : o < n.x + n.w / 2
                ? (r += (e.leftIds.length - e.indexes[n.id]) * i)
                : (r += (e.indexes[n.id] + 1) * i)),
        { x: o, mid: r }
    ...
    _draggableLinkPath: function (t, n, r, i, a, o) {
      if (
        ...
        return null;
      if (OrgChart._isMoved(r) && !OrgChart._isMoved(n)) {
        var s,
          c,
          l = [];
        switch (o) {
          ...
          case OrgChart.orientation.right_top:
            ...
            ((c = i.ya < i.yd ? r.y - a / 2 : r.y + r.h + a / 2),
              (s = r.x + r.w + a / 2));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
        ...
        return OrgChart.roundPathCorners(l, OrgChart.LINK_ROUNDED_CORNERS, !1);
      } else if (!OrgChart._isMoved(r) && OrgChart._isMoved(n)) {
        var s,
          c,
          u = !1,
          l = [];
        switch (o) {
          ...
          case OrgChart.orientation.top_left:
            if (i.ya + a / 2 > i.yb)
              ((u = !0),
                (s = i.xa < i.xd ? n.x + n.w + a / 2 : n.x - a / 2),
                (c = n.y + n.h + a));
          ...
          case OrgChart.orientation.right_top:
            if (i.xa - a / 2 < i.xb)
              ((u = !0),
                (c = i.ya < i.yd ? n.y + n.h + a / 2 : n.y - a / 2),
                (s = n.x - a));
        ...
        switch (o) {
          ...
          case OrgChart.orientation.top_left:
            if (i.ya + a > i.yd) {
              var s = i.xa < i.xd ? n.x + n.w + a / 2 : n.x - a / 2,
                c = n.y + n.h + a,
                d = r.y - a;
              (l.push([`M`, i.xa, i.ya]),
                l.push([`L`, i.xa, c]),
              ...
              (l.push([`M`, i.xa, i.ya]),
                l.push([`L`, i.xa, n.y + n.h + a]),
                l.push([`L`, i.xc, n.y + n.h + a]),
                l.push([`L`, i.xd, i.yd]));
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.right_top:
            if (i.xa - a < i.xd) {
              var c = i.ya < i.yd ? n.y + n.h + a / 2 : n.y - a / 2,
                s = n.x - a,
                f = r.x + r.w + a;
              (l.push([`M`, i.xa, i.ya]),
                l.push([`L`, s, i.ya]),
          ...
          case OrgChart.orientation.left_top:
            if (i.xa + a > i.xd) {
              ...
              (l.push([`M`, i.xa, i.ya]),
                l.push([`L`, n.x + n.w + a, i.ya]),
                l.push([`L`, n.x + n.w + a, i.yc]),
                l.push([`L`, i.xd, i.yd]));
            break;
        }
        return OrgChart.roundPathCorners(l, OrgChart.LINK_ROUNDED_CORNERS, !1);
  ...
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart._validateConfig = function (e) {
    if (!e) console.error(`config is not defined`);
    else return !0;
    return !1;
  }),
  (OrgChart._arrayContains = function (e, t) {
    if (e && Array.isArray(e)) {
      for (var n = e.length; n--; ) if (e[n] === t) return !0;
    }
    return !1;
  }),
  (OrgChart._interceptions = function (e, t) {
    if (!e || !t) return [];
    var n = [];
    if (Array.isArray(e) && Array.isArray(t))
      for (var r in e) for (var i in t) e[r] == t[i] && n.push(e[r]);
    else if (Array.isArray(e) && !Array.isArray(t))
      for (var r in e) for (var i in t) e[r] == i && n.push(e[r]);
    else if (!Array.isArray(e) && Array.isArray(t))
      for (var r in e) for (var i in t) r == t[i] && n.push(t[i]);
    return n;
  }),
  (OrgChart._getTags = function (e) {
  ...
  (OrgChart._centerPointInPercent = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      i = t - r.left,
      a = n - r.top;
    return [i / (r.width / 100), a / (r.height / 100)];
  }),
  (OrgChart._trim = function (e) {
    return e.replace(/^\s+|\s+$/g, ``);
  }),
  (OrgChart._getTransform = function (t) {
    var n = t.getAttribute(`transform`);
    return (
      (n = n.replace(`matrix`, ``).replace(`(`, ``).replace(`)`, ``)),
      OrgChart._browser().msie && (n = n.replace(/ /g, `,`)),
      (n = OrgChart._trim(n)),
      (n = `[` + n + `]`),
      (n = JSON.parse(n)),
      n
  ...
  (OrgChart.getScale = function (t, n, r, i, a, o, s, c) {
    var l = 1;
    if (
      !t &&
    ...
    } else if (!t && i === OrgChart.match.width) l = n / s;
    else if (!t && i === OrgChart.match.height) l = r / c;
    else if (!t) l = i;
    else {
      var u = n / t[2],
        d = r / t[3];
  ...
  (OrgChart.isObject = function (e) {
    return (
      ...
      e !== null &&
      e.constructor &&
      e.constructor.name.toLowerCase() == `object`
    );
  }),
  (OrgChart.fileUploadDialog = function (e) {
  ...
  (OrgChart.mergeDeep = function (t, n) {
    if (OrgChart.isObject(t) && OrgChart.isObject(n))
      for (var r in n)
        OrgChart.isObject(n[r])
          ? (t[r] || Object.assign(t, { [r]: {} }),
            OrgChart.mergeDeep(t[r], n[r]))
          : Object.assign(t, { [r]: n[r] });
    return t;
  }),
  (OrgChart._lblIsImg = function (e, t) {
    return !!(
      e.nodeBinding &&
      typeof t == `string` &&
      t.indexOf(`img`) != -1 &&
  ...
  (OrgChart._getFistImgField = function (e) {
    if (e.nodeBinding) {
      for (var t in e.nodeBinding)
        if (t.indexOf(`img`) != -1) return e.nodeBinding[t];
    }
    return !1;
  }),
  (OrgChart._fieldIsImg = function (t, n) {
    if (t.nodeBinding) {
      for (var r in t.nodeBinding)
        if (t.nodeBinding[r] == n) return OrgChart._lblIsImg(t, r);
    }
    return !1;
  }),
  ...
  (OrgChart.htmlRipple = function (e) {
      ...
      r = function (t) {
        ...
        return (
          ...
          (o =
            ...
            a +
            `px;`),
          e.rippleContainer.appendChild(i),
    ...
    ((a.className = `boc-ripple-container`),
      ...
      e.addEventListener(`mouseup`, n(i, 2e3)),
      (e.rippleContainer = a),
      e.appendChild(a));
  }),
  (OrgChart._moveToBoundaryArea = function (t, n, r, i) {
    var a = n.slice(0);
    (n[0] < r.left &&
      n[0] < r.right &&
  ...
  (OrgChart._getClientTouchesXY = function (e, t) {
  ...
  (OrgChart._getOffset = function (t, n) {
    t &&
      ((n.x += t.offsetLeft),
      (n.y += t.offsetTop),
      OrgChart._getOffset(t.offsetParent, n));
  }),
  (OrgChart._getTopLeft = function (t) {
    var n = { x: 0, y: 0 };
    return (OrgChart._getOffset(t, n), n);
  }),
  (OrgChart._getOffsetXY = function (t, n) {
    if (n.type.indexOf(`touch`) != -1) {
      if (n.touches.length) {
        var r = OrgChart._getTopLeft(t);
        return { x: n.touches[0].pageX - r.x, y: n.touches[0].pageY - r.y };
      } else if (n.changedTouches.length) {
        var r = OrgChart._getTopLeft(t);
        return isNaN(r.x) || isNaN(r.y)
          ? { x: n.changedTouches[0].pageX, y: n.changedTouches[0].pageY }
          : {
              x: n.changedTouches[0].pageX - r.x,
              y: n.changedTouches[0].pageY - r.y,
            };
      }
    } else return { x: n.offsetX, y: n.offsetY };
  }),
  (OrgChart._pinchMiddlePointInPercent = function (t, n, r, i) {
    var a = OrgChart._getTopLeft(t),
      o = i.touches[0].pageX - a.x,
      s = i.touches[0].pageY - a.y,
      c = i.touches[1].pageX - a.x,
      l = i.touches[1].pageY - a.y;
    ...
    var e =
      ...
      n =
        ...
        (function (e) {
          ...
          !window.safari ||
            (window.safari !== void 0 && safari.pushNotification),
        ),
  ...
  (OrgChart._menuPosition = function (e, t, n) {
    var r = e.getBoundingClientRect(),
      ...
      s = r.top - i.top;
    return (
      r.top + a.height > i.top + i.height && (s -= a.height),
      r.left - a.width < i.left && (o += a.width),
      { x: o, y: s }
    );
  }),
  (OrgChart._getTemplate = function (e, t, n) {
    if (Array.isArray(e))
  ...
  (OrgChart._getSubLevels = function (e, t) {
    if (e && e.length)
      for (var n = 0; n < e.length; n++) {
        var r = t[e[n]];
  ...
  (OrgChart._getLabelSize = function (t) {
    var n = OrgChart._getTestDiv();
    return (
      (n.innerHTML = `<svg>` + t + `</svg>`),
      n.querySelector(`text`).getBoundingClientRect()
    );
  }),
  (OrgChart.wrapText = function (t, n, r, i) {
    if (r != null && i != null) return OrgChart._lineClamp(n, t, r, i);
    var a = n,
      o = a.toLowerCase();
    if (
      o.indexOf(`<text`) == -1 ||
      o.indexOf(OrgChart.attr.width) == -1 ||
      o.indexOf(`foreignobject`) != -1 ||
      a.indexOf(OrgChart.attr.width) == -1 ||
      (OrgChart.ESCAPE_HTML && typeof str == `string` && OrgChart._isHTML(t))
    )
      return OrgChart._escapeHtml(t);
    if (!OrgChart.ESCAPE_HTML && OrgChart._isHTML(t)) return t;
    var s = OrgChart._getTestDiv();
    ((a = a.replaceAll(`{cw}`, 0)), (s.innerHTML = `<svg>` + a + `</svg>`));
    var c = new DOMParser()
        .parseFromString(a, `text/xml`)
        .getElementsByTagName(`text`)[0],
      l = parseFloat(c.getAttribute(`x`)),
      u = parseFloat(c.getAttribute(`y`)),
      d = c.getAttribute(`text-anchor`),
      r = c.getAttribute(OrgChart.attr.width),
      f = c.getAttribute(OrgChart.attr.text_overflow),
      p = `http://www.w3.org/2000/svg`,
      m = s.getElementsByTagName(`svg`)[0].getElementsByTagName(`text`)[0],
      i,
      h;
    f ||= `ellipsis`;
    var g = f.split(`-`);
    if (
      (g.length > 1 &&
        ((i = parseInt(f.split(`-`)[1])),
        g.length > 2 && g[2] == `ellipsis` && (h = !0)),
      !r)
    )
      return OrgChart._escapeHtml(t);
    if (
      ...
      for (var _ = m.getComputedTextLength(), v = 2; _ > r; )
        ((m.textContent = t.substring(0, t.length - v)),
          (m.textContent += `...`),
          (_ = m.getComputedTextLength()),
          v++);
      return v > 2
        ? `<title>${OrgChart._escapeHtml(t)}</title>${m.textContent}`
      ...
      var x = document.createElementNS(p, `tspan`),
        S = document.createTextNode(y[0]);
      (x.setAttributeNS(null, `x`, l),
        x.setAttributeNS(null, `y`, u),
        x.setAttributeNS(null, `text-anchor`, d),
        x.appendChild(S),
        m.appendChild(x));
      for (var v = 1, C = 1, w = !1, T = 1; T < y.length; T++) {
        var E = x.firstChild.data.length;
        if (
          ((x.firstChild.data += ` ` + y[T]), x.getComputedTextLength() > r)
        ) {
          if (
            ((x.firstChild.data = x.firstChild.data.slice(0, E)),
            C++,
            i && C > i)
          ) {
            if (h && m.children.length == i) {
              var D = m.children[i - 1].textContent;
              ((m.children[i - 1].textContent =
                D.substring(0, D.length - 3) + `...`),
                (w = !0));
            }
            break;
          }
          var x = document.createElementNS(p, `tspan`);
          (x.setAttributeNS(null, `x`, l),
            x.setAttributeNS(null, `y`, u + b * v),
            x.setAttributeNS(null, `text-anchor`, d),
            (S = document.createTextNode(y[T])),
            x.appendChild(S),
            m.appendChild(x),
            v++);
        }
      ...
      if (m.innerHTML != null) ((O = m.innerHTML), (m.innerHTML = ``));
        ...
        for (var k = ``, T = m.childNodes.length - 1; T >= 0; T--)
          ((k = XMLSerializer().serializeToString(m.childNodes[T]) + k),
            m.removeChild(m.childNodes[T]));
        O = k;
      }
      return w ? `<title>${OrgChart._escapeHtml(t)}</title>${O}` : O;
    }
  }),
  (OrgChart._downloadFile = function (e, t, n, r, i) {
    ...
    if (r == 1) {
      ...
      if (s.download !== void 0) {
        ...
        var c = n;
        (c.toLowerCase().endsWith(i.toLowerCase()) || (c = c + `.` + i),
          s.setAttribute(`download`, c),
  ...
  (OrgChart._getPosition = function (e, t, n, r) {
    var i = { x: t.x, y: t.y };
    if ((n != null && (i.x = n), r != null && (i.y = n), e && e.length == 3)) {
      var a = e[0].indexOf(t.id);
      a != -1 &&
        e[1][a].transform != null &&
        (n ?? (i.x = e[1][a].transform[4]), r ?? (i.y = e[1][a].transform[5]));
    }
    return i;
  }),
  (OrgChart._getOpacity = function (e, t) {
    var n = 1;
    if (e && e.length == 3) {
  ...
  (OrgChart.setNodeSize = function (t) {
    var n = OrgChart.t(t.templateName, t.min);
    ((t.w = n && n.size ? n.size[0] : 0), (t.h = n && n.size ? n.size[1] : 0));
  }),
  (OrgChart._imgs2base64 = function (t, n, r, i) {
    ...
    for (var s = 0; s < o; s++)
      (function () {
        var t = s,
          n = a[t];
        OrgChart._getDataUri(n.getAttribute(r), function (e) {
          (e.success && n.setAttribute(r, e.result), t == o - 1 && i());
        });
      })();
  }),
  (OrgChart._getDataUri = function (e, t) {
      ...
      (n.open(`GET`, e),
        ...
        (n.onload = function () {
          n.status === 200
            ...
            : n.status === 404 && t({ success: !1, result: n.status });
        }));
  ...
  (OrgChart._convertStringToArray = function (t, n) {
    return OrgChart.ARRAY_FIELDS.indexOf(t) == -1
      ? n
      : OrgChart.isNEU(n)
        ? []
        : n.split(`,`);
  ...
  (OrgChart._csvToArray = function (t, n) {
    n ||= OrgChart.CSV_DELIMITER;
    for (
      var r = RegExp(
          `(\\` +
            n +
      ...
      var o = a[1];
      o.length && o !== n && i.push([]);
      var s = a[2] ? a[2].replace(RegExp(`""`, `g`), `"`) : a[3];
      i[i.length - 1].push(s);
    }
    return i;
  }),
  (OrgChart._json2xml = function (t) {
    for (
      var n = document.implementation.createDocument(``, ``, null),
        r = n.createElement(`nodes`),
        i = 0;
      i < t.length;
      i++
    ) {
      var a = n.createElement(`node`),
        o = t[i];
      for (var s in o) {
        var c = o[s];
        a.setAttribute(s, OrgChart._convertArrayToString(c));
      }
      r.appendChild(a);
    }
    return (
  ...
  (OrgChart._xml2json = function (t) {
    for (
      ...
      for (var a = n[i], o = {}, s = 0; s < a.attributes.length; s++) {
        ...
        o[c.name] = OrgChart._convertStringToArray(c.name, c.value);
      }
      r.push(o);
    }
    return r;
      ...
      var n = [],
        r = function (t) {
          for (var r = ``, i = 0; i < n.length; i++) {
            ...
            (a instanceof Date && (a = a.toLocaleString()),
              (a = a === null ? `` : a.toString()));
            var o = a.replace(/"/g, `""`),
              s = RegExp(
                `("|;|
...
`
      ...
      for (var o in t[a])
        OrgChart._arrayContains(n, o) ||
          (n.push(o), (i += o + OrgChart.CSV_DELIMITER));
...
`));
  ...
  (OrgChart.isTrial = function () {
    return OrgChart.remote !== void 0;
  }),
  (OrgChart.childrenCount = function (e, t) {
    for (var n = 0, r = 0; r < t.childrenIds.length; r++)
      e.nodes[t.childrenIds[r]] && n++;
    return n;
  }),
  (OrgChart.childrenTotalCount = function (t, n) {
  ...
  (OrgChart.collapsedChildrenCount = function (e, t) {
    for (var n = 0, r = 0; r < t.childrenIds.length; r++) {
  ...
  (OrgChart.collapsedChildrenTotalCount = function (t, n, r) {
    for (var i = 0, a = 0; a < n.childrenIds.length; a++) {
      var o = t.nodes[n.childrenIds[a]];
      o &&
        ((r || o.collapsed === !0) && i++,
        (i += OrgChart.collapsedChildrenTotalCount(t, o, !0)));
    }
    return i;
  }),
  (OrgChart._setMinMaxXY = function (e, t, n) {
    (n && e.isTreeListItem) ||
      ((t.minX == null || (e.x != null && e.x < t.minX)) && (t.minX = e.x),
      (t.minY == null || (e.y != null && e.y < t.minY)) && (t.minY = e.y),
      (t.maxX == null || (e.x != null && e.x + e.w > t.maxX)) &&
        (t.maxX = e.x + e.w),
      (t.maxY == null || (e.y != null && e.y + e.h > t.maxY)) &&
        (t.maxY = e.y + e.h));
  }),
  (OrgChart.getStParentNodes = function (t, n) {
    for (n ||= []; t.parent; ) t = t.parent;
    return (
      t.stParent &&
        (n.push(t.stParent), OrgChart.getStParentNodes(t.stParent, n)),
      n
    );
  }),
  (OrgChart.getRootOf = function (e) {
    for (; e && e.parent; ) e = e.parent;
    return e;
  }),
  (OrgChart._getViewBox = function (e) {
    var t = null;
    return e
  ...
  (OrgChart.isNEU = function (e) {
    return e == null || e === ``;
  }),
  (OrgChart.gradientCircleForDefs = function (e, t, n, r) {
    ...
    function a(e, t, n, r, a) {
      var o = i(e, t, n, a),
        s = i(e, t, n, r),
        c = a - r <= 180 ? `0` : `1`;
      return [`M`, o.x, o.y, `A`, n, n, 0, c, 0, s.x, s.y].join(` `);
    }
  ...
  (OrgChart._intersectionObserver = function (e, t) {
  ...
  (OrgChart.convertCsvToNodes = function (t) {
    for (
      var n = OrgChart._csvToArray(t), r = n[0], i = [], a = 1;
      a < n.length;
      a++
    ) {
      for (var o = {}, s = 0; s < n[a].length; s++) {
        var c = r[s],
          l = n[a][s];
        o[r[s]] = OrgChart._convertStringToArray(c, l);
      }
      o.id.trim() != `` && i.push(o);
    }
    return i;
  ...
  (OrgChart._escapeHtml = function (t) {
    return OrgChart.ESCAPE_HTML && typeof t == `string`
      ? t
          .replace(/&/g, `&amp;`)
          .replace(/</g, `&lt;`)
          .replace(/>/g, `&gt;`)
  ...
  (OrgChart._escapeDoubleQuotes = function (e) {
    return typeof e == `string` ? e.replace(/"/g, `&quot;`) : e;
  }),
  (OrgChart._escapeGreaterLessSign = function (e) {
    return typeof e == `string`
      ? e.replace(/</g, `&lt;`).replace(/>/g, `&gt;`)
      : e;
  }),
  (OrgChart.roundPathCorners = function (e, t, n) {
    function r(e, t, n) {
      var r = t.x - e.x,
        a = t.y - e.y,
        o = Math.sqrt(r * r + a * a);
      ...
      for (var u = 1; u < e.length; u++) {
        ...
        if (
          ...
          var m = o(d),
            ...
            v;
          (n
            ? ((_ = i(h, d.origPoint || m, t)), (v = i(h, p.origPoint || g, t)))
            : ((_ = r(h, m, t)), (v = r(h, g, t))),
            a(f, _),
            (f.origPoint = h),
            s.push(f));
  ...
  (OrgChart._isMoved = function (e) {
    return e.movex != null || e.movey != null;
  }),
  (OrgChart._getDynamicGridCoulumns = function (e) {
    for (var t = 1; t < e && (e / t, !(e / t - t <= 0)); t++);
    return (t % 2 != 0 && t > 2 && t--, t);
  }),
  (OrgChart._getLazyLoading = function (e) {
    var t = e.lazyLoading;
    return (t == `auto` && (t = !!(e && e.nodes && e.nodes.length > 700)), t);
  }),
  (OrgChart._getSvgAttributes = function (e) {
    let t = /width="([\d.]+)"/,
      n = /height="([\d.]+)"/,
      r = /x="([\d.]+)"/,
      i = /y="([\d.]+)"/,
      ...
      l = e.match(i),
      u = e.match(a),
      d = o ? parseFloat(o[1]) : 0,
      f = s ? parseFloat(s[1]) : 0,
      p = c ? parseFloat(c[1]) : 0,
      m = l ? parseFloat(l[1]) : 0,
      h = [0, 0, 0, 0];
    return (
      u && ((h = u[1]), (h = JSON.parse(`[${h}]`))),
      { width: d, height: f, viewBox: h, x: p, y: m }
    );
  }),
  (OrgChart._setSvgAttributes = function (e, t) {
    var n = t.x,
      r = t.y,
      i = t.width,
      a = t.height,
  ...
  (OrgChart._convertTextToNodes = function (e, t) {
    let n = e.split(/\r?\n/).filter((e) => e.trim() !== ``),
      r = [],
      i = 1,
      a = [];
    for (let e of n) {
      ...
      let s = e.match(/^([^\(]+)\(([^)]+)\)$/),
        ...
        l = [];
      s
        ? ((c = s[1].trim()), (l = s[2].split(`,`).map((e) => e.trim())))
        : (c = e);
      let u = n === 0 ? null : a[n - 1].id,
        d = { id: i++, pid: u, name: c, tags: l };
      ((a[n] = d), (a.length = n + 1), r.push(d));
    }
    return r;
  }),
  (OrgChart._convertFromNodesToText = function (e, t) {
    let n = {},
      r = [];
    (e.forEach((e) => {
      n[e.id] = { ...e, children: [] };
...
`));
      for (let t of Object.keys(e))
        [`id`, `pid`, `name`, `children`, `tags`].includes(t) ||
          (a +=
            r +
            `[` +
            t +
...
`);
  ...
  (OrgChart._onClickHandler = function (t, n, r, i, a) {
    var o;
    if (r === void 0)
      if (n === `add`) {
        var s = { id: t.generateId(), pid: i };
        t.addNode(s, null, !0);
      } else if (n === `edit`) {
        var c = t.getNode(i);
        t.editUI.show(c.id);
      ...
      } else if (n === `visio_export` || n === `visio`)
        i == null
          ? t.exportToVisio()
          : t.exportToVisio({ pages: [{ nodeId: i }] });
        ...
        (i != null && ((l.expandChildren = !1), (l.pages[0].nodeId = i)),
        ...
        n === `pdf_profile` || n === `csv`
          ? t.exportToPDFProfile(i)
          : n === `share_profile` || n === `csv`
            ? t.shareProfile(i)
            : n === `csv_export` || n === `csv`
              ? t.exportToCSV({ nodeId: i })
              : n === `xml_export` || n === `xml`
                ? t.exportToXML({ nodeId: i })
                : n === `json_export` || n === `json`
                                ...
                                : n === `layout_right_offset`
                                  ...
                                  : n === `layout_left_offset`
                                    ...
                                    : n === `layout_tree`
                                      ...
                                      : n === `layout_grid` &&
                                        t.setLayout(OrgChart.layout.grid);
    else o = r.call(t, i, a);
    return o;
  }),
  (OrgChart._isSVG = function (e) {
    ...
    try {
      ...
      return e.querySelector(`parsererror`)
        ? !1
        : e.documentElement.nodeName.toLowerCase() === `svg`;
    } catch {
      return !1;
    }
  }),
  (OrgChart._treeListAdjustToSTNodePostition = function (t, n) {
    for (var r of t)
      ((r.y += n.y + n.padding[0]),
        (r.x += n.x + n.padding[3]),
        OrgChart._treeListAdjustToSTNodePostition(r.children, n));
  }),
  (OrgChart._treeListSetProps = function (t, n) {
    var r = -t.treeList.scrollTop,
      i = { nodesByLevels: [], lastNode: null, y: 0 };
    ((t.treeList.pinnedIds = []),
      OrgChart._treeListIterate(t.stChildren, i, -1));
    var a =
      i.lastNode.y +
      i.lastNode.h -
      0 -
    ...
    for (var o = i.nodesByLevels.length - 1; o >= 0; o--)
      for (var s = i.nodesByLevels[o], c = s.length - 1; c >= 0; c--) {
        for (
          var l = s[c], u = l.y, d = 0, f = l.parent;
          f && ((d += f.h), f.parent);
        )
          f = f.parent;
    ...
    if (n == OrgChart.orientation.bottom) {
  ...
  (OrgChart._treeListIterate = function (t, n, r) {
    r++;
    for (var i of t)
      ((i.y = n.y),
        (n.y += i.h),
        n.nodesByLevels[r] || (n.nodesByLevels[r] = []),
        n.nodesByLevels[r].push(i),
        (n.lastNode = i),
        OrgChart._treeListIterate(i.children, n, r));
  }),
  (OrgChart._treeListGetTumbPositionFromScrollTop = function (e) {
    var t = e.h - e.padding[0] - e.padding[2],
      n = t / ((e.treeList.scrollTopMax + t) / 100),
      r = (t / 100) * n,
      i = t - r,
      a = -e.treeList.scrollTop / (e.treeList.scrollTopMax / 100),
      o = e.y + e.padding[0] + (i / -100) * a,
      s = `initial`;
    return (
      (isNaN(r) || isNaN(o) || r < 0 || n > 100) &&
        ((s = `none`), (r = 0), (o = 0)),
      { thumbHeight: r, thumbPosition: o, scrollBarDisplay: s }
    );
  }),
  (OrgChart._treeListGetScrollTopFromTumbPosition = function (e, t, n) {
    var r = e.h - e.padding[0] - e.padding[2] - t,
      i =
        ((((n - (e.y + e.padding[0])) / r) * 100) / 100) *
        e.treeList.scrollTopMax;
    return (
      (isNaN(i) || i < 0) && (i = 0),
      i > e.treeList.scrollTopMax && (i = e.treeList.scrollTopMax),
      i
    );
  }),
  (OrgChart._getCenterNodeFromParams = function (e, t) {
    var n = e[t.id];
    if (n) {
      if (n.isTreeListItem) {
  ...
  (OrgChart._getScrollTopForNode = function (t, n) {
    ...
    var l = t.padding[0],
      u = t.padding[2],
      d = t.treeList.maxHeight - l - u,
      f = r.lastNode.y + r.lastNode.h - d;
    f < 0 && (f = 0);
    var p = t.treeList.scrollTop,
      m = i.y - s,
      h = i.y + i.h - d,
      g = p;
    return (
      i.y < p + s ? (g = m) : i.y + i.h > p + d && (g = i.h > d - s ? m : h),
      g < 0 ? (g = 0) : g > f && (g = f),
      g
    );
  }),
  (OrgChart._getDefailtPositionForExpandCollpase = function (t, n) {
    var r = { x: 0, y: 0 };
  ...
  (OrgChart._measureCacheElement = null),
  (OrgChart._getMeasureElement = function () {
    return document.querySelector(`[data-hidden-measure]`);
  }),
  (OrgChart._lineClamp = function (t, n, r, i) {
    if (n === void 0 || n == null) return ``;
    (typeof n != `string` && (n = n.toString()), (n = OrgChart._escapeHtml(n)));
    let a = /(\w+(?:-\w+)?)="([^"]*)"/g,
      o = {},
      s;
    for (; (s = a.exec(t)) !== null; ) o[s[1]] = s[2];
    let c = OrgChart._getMeasureElement();
    c.textContent = ``;
    for (let [e, t] of Object.entries(o))
      e !== `x` && e !== `y` && c.setAttribute(e, t);
    let l = (e) => ((c.textContent = e), c.getComputedTextLength()),
      u = n.split(` `),
      d = [],
      f = ``,
      p = 0;
    ...
    let m =
      p < u.length || (p === u.length && u[p - 1] === `` && n.endsWith(` `));
    if (m && d.length > 0) {
      let e = d[d.length - 1],
        t = 0,
        n = e.length,
      ...
      g =
        d.length === 1
          ...
          : d
              .map(
                (e, t) =>
                  `<tspan${h} dy="${t === 0 ? 0 : `1.2em`}">${e}</tspan>`,
              )
              .join(``);
    return `<text${Object.entries(o)
      .map(([e, t]) => ` ${e}="${t}"`)
      .join(``)}>${m ? `<title>${n}</title>` : ``}${g}</text>`;
  }),
  (OrgChart._getScrollableTreeListNodeInTouchEnabledDevice = function (t) {
    ...
    var n = OrgChart.getRootOf(t).stParent,
      {
        thumbHeight: r,
        thumbPosition: i,
        scrollBarDisplay: a,
      } = OrgChart._treeListGetTumbPositionFromScrollTop(n);
  ...
  (OrgChart._convertImagesToBase64 = async function (t) {
    ...
    return await Promise.all(
      t.map(async (t) => {
        let r = n.parseFromString(t, `image/svg+xml`),
        ...
        for (let t of i) {
          ...
          if (n && !n.startsWith(`data:`))
            try {
              ...
              if (r > 0 && i > 0) {
                let a = await OrgChart._resizeAndConvert(n, r, i);
  ...
  (OrgChart._resizeAndConvert = function (e, t, n) {
      ...
      ((a.crossOrigin = `anonymous`),
        (a.onload = () => {
          let e = document.createElement(`canvas`),
            i = e.getContext(`2d`),
            o = Math.min(t / a.width, n / a.height),
            s = a.width * o,
            c = a.height * o;
          ((e.width = s),
            (e.height = c),
            i.drawImage(a, 0, 0, s, c),
  ...
  (OrgChart._reorderNodeBinding = function (e) {
    if (!e.nodeBinding) return;
    let t = {};
    (Object.keys(e.nodeBinding)
      .filter((e) => !e.startsWith(`img`))
      .forEach((n) => {
        t[n] = e.nodeBinding[n];
      }),
      Object.keys(e.nodeBinding)
  ...
  (OrgChart._moveNodesToVisibleAreaAfterExpand = function (t, n, r, i) {
    if (t.config.orientation != OrgChart.orientation.top) {
      console.error(
        `_moveNodesToVisibleAreaAfterExpand works only for OrgChart.orientation.top, not implemented for others!`,
      );
      return;
    }
    var a = t.getSvg(),
    ...
    if (t.getNode(r[0]).y > p.y) {
      ...
      for (var m of r) {
        var h = t.getNode(m),
          g = h.y - t.config.padding;
        g < f && (f = g);
      }
      f < p.y + p.h - u + t.config.padding &&
        (f = p.y + p.h - u + t.config.padding);
    }
    if (f != c || d != s) {
      var _ = [d, f, l, u];
      OrgChart.animate(
        ...
        { viewBox: o },
        { viewBox: _ },
        t.config.anim.duration,
        t.config.anim.func,
        function () {
          t.draw(OrgChart.action.update, void 0, i);
        },
      );
    }
  }),
  (OrgChart.xScrollUI = function (t, n, r, i, a) {
    ((this.element = t),
  ...
  (OrgChart.xScrollUI.prototype.addListener = function (t) {
    var n = this;
    if (
      (this.config.mouseScroll != OrgChart.action.xScroll &&
        this.config.mouseScroll != OrgChart.action.scroll) ||
      !this.bar
    )
      return;
    ...
    function i(t, i, a) {
      ...
      function s(t) {
        if ((t.preventDefault(), !t.ctrlKey)) {
          var a = 0;
          if (n.config.mouseScroll == OrgChart.action.xScroll)
            ((a = t.deltaX || t.wheelDeltaX),
              (a ||= t.deltaY || t.wheelDeltaY));
          else if (
            n.config.mouseScroll == OrgChart.action.scroll &&
            ((a =
              r || !t.shiftKey
          ...
          ((a = -a),
            ...
            (n.position += -a * i));
          var s =
            parseFloat(n.innerBar.clientWidth) - parseFloat(n.bar.clientWidth);
          (n.position < 0 && (n.position = 0),
            n.position > s && (n.position = s),
            o || c());
        }
      }
      function c() {
        ...
        Math.ceil(n.bar.scrollLeft) == Math.ceil(n.position)
          ? (o = !1)
          : ((n.bar.scrollLeft += e), l(c));
      }
      var l = (function () {
        return (
          window.requestAnimationFrame ||
    ...
    if (
      ...
      (this.bar &&
        ...
        this.bar.addEventListener(`scroll`, function () {
          ...
          var e = n.requestParams(),
            t =
              (parseFloat(n.innerBar.clientWidth) -
                parseFloat(n.bar.clientWidth)) /
              100,
            r = this.scrollLeft / t,
            i = (e.boundary.right - e.boundary.left) / 100;
          ((e.viewBox[0] = r * i + e.boundary.left),
            n.onSetViewBoxCallback(e.viewBox),
    ...
    if (this.bar) {
      ...
      ((this.bar.ignore = !0),
        ...
        OrgChart.events.publish(`change`, [
          this,
          { isScrollBarVisible: this.bar.style.visibility != `hidden` },
        ]));
    }
  }),
  (OrgChart.xScrollUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.yScrollUI = function (t, n, r, i, a) {
    ((this.element = t),
      (this.requestParams = r),
      (this.config = n),
      (this.onSetViewBoxCallback = i),
  ...
  (OrgChart.yScrollUI.prototype.addListener = function (t) {
    var n = this;
    if (
      (this.config.mouseScroll != OrgChart.action.yScroll &&
        this.config.mouseScroll != OrgChart.action.scroll) ||
      !this.bar
    )
      return;
    ...
    function i(t, i, a) {
      ...
      function s(t) {
        if ((t.preventDefault(), !t.ctrlKey)) {
          var a = 0;
          if (n.config.mouseScroll == OrgChart.action.yScroll)
            ((a = t.deltaY || t.wheelDeltaY),
              (a ||= t.deltaX || t.wheelDeltaX));
          else if (
            n.config.mouseScroll == OrgChart.action.scroll &&
      ...
      function c() {
        ...
        Math.ceil(n.bar.scrollTop) == Math.ceil(n.position)
          ? (o = !1)
          : ((n.bar.scrollTop += e), l(c));
      }
      var l = (function () {
        return (
          window.requestAnimationFrame ||
        ...
        this.bar.addEventListener(`scroll`, function () {
          ...
          var e = n.requestParams(),
            t =
              ...
              100,
            r = this.scrollTop / t,
            i = (e.boundary.bottom - e.boundary.top) / 100;
          ((e.viewBox[1] = r * i + e.boundary.top),
            n.onSetViewBoxCallback(e.viewBox),
            clearTimeout(this._timeout),
            (this._timeout = setTimeout(function () {
              n.onDrawCallback();
  ...
  (OrgChart.yScrollUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.prototype.zoom = function (t, n, r, i) {
    var a = this.getViewBox().slice(0),
      o = a,
      s = a[2],
      c = a[3];
    (t === !0
      ? ((a[2] /= OrgChart.SCALE_FACTOR), (a[3] /= OrgChart.SCALE_FACTOR))
      : t === !1
        ? ((a[2] *= OrgChart.SCALE_FACTOR), (a[3] *= OrgChart.SCALE_FACTOR))
        : ((a[2] /= t), (a[3] /= t)),
      (n ||= [50, 50]),
      (a[0] = o[0] - (a[2] - s) / (100 / n[0])),
      (a[1] = o[1] - (a[3] - c) / (100 / n[1])));
    var l = this.getScale(a);
    if (
      ((a[2] = this.width() / l),
      (a[3] = this.height() / l),
      (t === !0 && l < this.config.scaleMax) ||
        (t === !1 && l > this.config.scaleMin) ||
        (t != 0 &&
          t != 1 &&
            ...
            function () {
              (clearTimeout(u._timeout),
                (u._timeout = setTimeout(function () {
                  u._draw(!0, OrgChart.action.zoom, null, i);
                }, 500)));
            },
          ))
        : (this.setViewBox(a),
  ...
  (OrgChart.loading = {}),
  (OrgChart.loading.show = function (e) {
  ...
  (OrgChart.loading.hide = function (e) {
    var t = e.element.querySelector(`#boc-loading`);
    t && t.parentNode.removeChild(t);
  }),
  (OrgChart.pdfPrevUI = {}),
  (OrgChart.pdfPrevUI.show = function (e, t) {
    console.warn(
  ...
  OrgChart === void 0 && (OrgChart = {}),
  OrgChart.events.on(`renderdefs`, function (t, n) {
  ...
  OrgChart.events.on(`prerender`, function (t, n) {
    OrgChart.RENDER_CLINKS_BEFORE_NODES && t._clink(t, n);
  }),
  OrgChart.events.on(`render`, function (t, n) {
    OrgChart.RENDER_CLINKS_BEFORE_NODES || t._clink(t, n);
  }),
  OrgChart.events.on(`drag`, function (t, n, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
      for (var a = 0; a < i.length; a++) {
        for (
          var o = i[a],
            s = t.element.querySelectorAll(`[data-c-l-from="${o}"]`),
            c = t.element.querySelectorAll(`[data-c-l-to="${o}"]`),
            l = 0;
          l < s.length;
          l++
        )
  ...
  (OrgChart.prototype._clink = function (t, n) {
    for (var r = ``, i = 0; i < this.config.clinks.length; i++) {
      ...
      if (
        !o ||
        n.res.visibleNodeIds.indexOf(o.id) == -1 ||
        !s ||
        n.res.visibleNodeIds.indexOf(s.id) == -1
      )
        continue;
      var c = o.x,
        l = o.y,
      ...
      function w(t, n, r) {
        ...
        var i = n.x - t.x,
          o = n.y - t.y,
          s = Math.sqrt((n.x - t.x) ** 2 + (n.y - t.y) ** 2) / 3;
        return (
          (s = (s / (Math.sqrt(i * i + o * o) * r)) * OrgChart.clinkCurve(a)),
          { x: t.x + i / 2 - o * s, y: t.y + o / 2 + i * s }
        );
      }
      var y = w(f, p, v),
        b = a.template;
      b ||= `orange`;
      var x = OrgChart.clinkTemplates[b];
      if (a.label) {
        var S = OrgChart.clinkLabelPosition(a, f, p, y);
        r += x.label
          .replace(`{x}`, S.x)
          .replace(`{y}`, S.y)
          .replace(`{val}`, a.label);
  ...
  (OrgChart.clinkLabelPosition = function (e, t, n, r) {
    var i = (n.x - t.x) / 2 + t.x,
      a = (n.y - t.y) / 2 + t.y;
    return { x: (i - r.x) / 2 + r.x, y: (a - r.y) / 2 + r.y };
  }),
  (OrgChart.clinkCurve = function (t) {
    return OrgChart.CLINK_CURVE;
  }),
  (OrgChart.prototype.addClink = function (t, n, r, i) {
    (this._putInUndoStack(), this.clearRedo());
    ...
    return (
      this.config.clinks.push({ from: t, to: n, label: r, template: i }),
      this._ai.setContext(),
      OrgChart.events.publish(`updated`, [this]),
      this
    );
  }),
  (OrgChart.prototype.removeClink = function (t, n) {
    (this._putInUndoStack(), this.clearRedo());
  ...
  OrgChart.events.on(`render`, function (e, t) {
    e._slinks(e, t);
  }),
  OrgChart.events.on(`drag`, function (t, n, r, i) {
    if (t instanceof OrgChart && t.config.movable && i)
      for (var a = 0; a < i.length; a++) {
        for (
          var o = i[a],
            s = t.element.querySelectorAll(`[data-s-l-from="${o}"]`),
            c = t.element.querySelectorAll(`[data-s-l-to="${o}"]`),
            l = 0;
          l < s.length;
          l++
        )
  ...
  (OrgChart.prototype._slinks = function (t, n) {
    var r = ``,
      i = this.getScale(),
      a = n.res.boundary;
    function o(e, t) {
      return { x: (e[0] + t[0]) / 2, y: (e[1] + t[1]) / 2 };
    }
    function s(n, r, o, s, c) {
      var l = [],
        u = null,
        d = OrgChart.t(n.templateName, n.min, i),
        f = s.levelSeparation;
      ...
      switch (s.orientation) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
          p = { p: n.x + n.w / 2, q: n.y, r: n.x + n.w / 2, s: a.minY + f };
          break;
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          p = { p: n.x + n.w / 2, q: n.y + n.h, r: n.x + n.w / 2, s: a.maxY };
          break;
        case OrgChart.orientation.left:
        case OrgChart.orientation.left_top:
          p = { p: n.x, q: n.y + n.h / 2, r: a.minX + f, s: n.y + n.h / 2 };
          break;
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
          p = { p: n.x + n.w, q: n.y + n.h / 2, r: a.maxX, s: n.y + n.h / 2 };
          break;
      }
      if (n.sl == r.sl)
        switch (((u = r), s.orientation)) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            (l.push([p.p, p.q]),
              l.push([p.p, p.q - OrgChart.SLINK_GAP * 2]),
              (d = OrgChart.t(u.templateName, u.min, i)),
              l.push([u.x + u.w / 2, l[l.length - 1][1]]),
              l.push([l[l.length - 1][0], u.y]));
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (l.push([p.p, p.q]),
              ...
              (d = OrgChart.t(u.templateName, u.min, i)),
              l.push([u.x + u.w / 2, l[l.length - 1][1]]),
              l.push([l[l.length - 1][0], u.y + u.h]));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            (l.push([p.p, p.q]),
              l.push([p.p - OrgChart.SLINK_GAP * 2, p.q]),
              (d = OrgChart.t(u.templateName, u.min, i)),
              l.push([l[l.length - 1][0], u.y + u.h / 2]),
              l.push([u.x, l[l.length - 1][1]]));
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (l.push([p.p, p.q]),
        ...
        switch (s.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            (l.push([p.p, p.q]), l.push([p.r, n.y - OrgChart.SLINK_GAP * 2]));
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (l.push([p.p, p.q]),
              l.push([p.r, n.y + n.h + OrgChart.SLINK_GAP * 2]));
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            (l.push([p.p, p.q]), l.push([n.x - OrgChart.SLINK_GAP * 2, p.s]));
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (l.push([p.p, p.q]),
              l.push([n.x + n.w + OrgChart.SLINK_GAP * 2, p.s]));
            break;
        }
        ...
        for (; u == null; ) {
          ...
          if (
            (_.id == r.id
              ? (u = _)
              : OrgChart._intersects(_, p, s) &&
                ((p = OrgChart._addPoint(_, l, s, p, c)), (g = !0)),
            _.id != r.id)
          ) {
            for (; v; ) {
              if (v.id == r.id) {
              ...
              (OrgChart._intersects(v, p, s) &&
                ((p = OrgChart._addPoint(v, l, s, p, c)), (g = !0)),
                (v = v.leftNeighbor));
            }
            for (; y; ) {
              if (y.id == r.id) {
              ...
              (OrgChart._intersects(y, p, s) &&
                ((p = OrgChart._addPoint(y, l, s, p, c)), (g = !0)),
                (y = y.rightNeighbor));
            }
          }
          if (!g) {
            ...
            if (_.parent) {
              ((f = s.levelSeparation),
                _.parent.layout && (f = s.mixedHierarchyNodesSeparation));
              var S = t.manager.bordersByRootIdAndLevel[h.id][_.parent.sl];
              switch (s.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  ((b = l[l.length - 1][0]),
                    (x = S.maxY + f - OrgChart.SLINK_GAP));
                  break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                  ((b = l[l.length - 1][0]),
                    (x = S.minY - f + OrgChart.SLINK_GAP));
                  break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  ((b = S.maxX + f - OrgChart.SLINK_GAP),
                    (x = l[l.length - 1][1]));
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  ((b = S.minX - f + OrgChart.SLINK_GAP),
                    (x = l[l.length - 1][1]));
                  break;
              }
            }
        ...
        switch (
          ...
          case OrgChart.orientation.top_left:
            ...
            (c == `left` && (C *= -1),
              l.push([u.x + u.w / 2 + C, l[l.length - 1][1]]),
              l.push([l[l.length - 1][0], u.y + u.h]));
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.left_top:
            var C = d.expandCollapseSize;
            (c == `top` && (C *= -1),
              l.push([l[l.length - 1][0], u.y + u.h / 2 + C]),
              l.push([u.x + u.w, l[l.length - 1][1]]));
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
    ...
    for (
      var c = [], l = [], u = [], d = [], f = [], p = 0;
      p < this.config.slinks.length;
      p++
    ) {
      var m = this.config.slinks[p],
        h = t.getNode(m.from),
        g = t.getNode(m.to);
      if (
        h &&
        g &&
        n.res.visibleNodeIds.indexOf(g.id) != -1 &&
        n.res.visibleNodeIds.indexOf(h.id) != -1
      ) {
        var _ = h.lcn ? h.lcn : `base`,
          v = t._layoutConfigs[_],
          y = h.sl < g.sl,
          b = `left`;
    ...
    for (var p = 0; p < c.length; p++) {
      var x = c[p],
        m = l[p],
        b = d[p];
      switch ((OrgChart._slinkRemoveUnusedPoints(x), v.orientation)) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
    ...
    for (var p = 0; p < c.length; p++) {
      var x = c[p],
        ...
        S = m.template;
      S ||= `orange`;
      var C = OrgChart.slinkTemplates[S],
        w = null;
      switch (C.labelPosition) {
        ...
        case `middle`:
          ...
          break;
        case `end`:
          w = { x: x[x.length - 2][0], y: x[x.length - 2][1] };
          break;
      }
      var E = structuredClone(x);
      E[0].unshift(`M`);
      for (var D = 1; D < x.length; D++) E[D].unshift(`L`);
      var O = OrgChart.roundPathCorners(E, OrgChart.LINK_ROUNDED_CORNERS, !1);
      if (m.label) {
        var k = C.label
            .replace(`{x}`, w.x)
            .replace(`{y}`, w.y)
            .replace(`{val}`, m.label),
          A = OrgChart._getLabelSize(k),
          j = -(A.height / 2);
        switch (v.orientation) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
  ...
  (OrgChart.prototype.addSlink = function (t, n, r, i) {
    (this._putInUndoStack(), this.clearRedo());
    ...
    return (
      this.config.slinks.push({ from: t, to: n, label: r, template: i }),
      this._ai.setContext(),
      OrgChart.events.publish(`updated`, [this]),
      this
    );
  }),
  (OrgChart.prototype.removeSlink = function (t, n) {
    (this._putInUndoStack(), this.clearRedo());
  ...
  (OrgChart._ai = function (e) {
    ((this.instance = e), (this.sessionId = null));
  }),
  (OrgChart._ai.prototype.prompt = function (e, t) {
    var n = this;
    ((e = e.trim()),
      e &&
        (this.sessionId
          ? n._prompt([{ Role: `user`, Text: e }], t)
          : this.setContext(function () {
              n._prompt([{ Role: `user`, Text: e }], t);
            })));
  }),
  (OrgChart._ai.prototype._prompt = function (t, n) {
    var r = this,
      i = [];
    for (var a of OrgChart.AI_SYSTEM_MESSAGES)
      i.push({ Role: `system`, Text: a });
    var o =
      this.instance.config.serverUrl +
      `/OrgChartJSAI/Prompt?client_messages=${encodeURIComponent(JSON.stringify(t))}&system_messages=${encodeURIComponent(JSON.stringify(i))}&sessionId=${this.sessionId}`;
    let s = new EventSource(o);
    ((s.onmessage = function (e) {
      var t = JSON.parse(e.data),
        i = ``;
      (t.kind == `end` && s.close(),
        t.kind == `text` && ((i += t.text), n && n(t.text)),
        t.kind == `assistant-message-with-tools`
          ? r.toolCalls(t.message, n)
          : t.kind == `error` && console.error(t.text));
    }),
      (s.onerror = function (e) {
        (console.error(e), s.close());
      }));
  }),
  (OrgChart._ai.prototype.setContext = function (e) {
    if (
      this.instance &&
      ...
      var t = this.instance.config.serverUrl + `/OrgChartJSAI/SetContext`,
        n = this.instance.config.aiChatTools.slice();
      for (var r of n)
        ((r.functionParameters ??= null),
          (r.functionParameters = JSON.stringify(r.functionParameters)));
      fetch(t, {
        method: `post`,
        headers: {
  ...
  (OrgChart._ai.prototype.toolCalls = function (t, n) {
    var r = this,
    ...
    var a = [],
      ...
      p = null,
      m = null;
    for (var h of i.toolCalls)
      h.FunctionResult ??
        (h.FunctionName == `removeNode`
          ? a.push(h)
          : h.FunctionName == `addNode`
            ? o.push(h)
            : h.FunctionName == `updateNode`
              ? s.push(h)
              : h.FunctionName == `select`
                ? c.push(h)
                : h.FunctionName == `deselect`
                  ? l.push(h)
                  : h.FunctionName == `exportToPDF`
                    ? (u = h)
                    : h.FunctionName == `changeTemplate`
                      ? (d = h)
                      : h.FunctionName == `addSlink`
                        ? (f = h)
                        : h.FunctionName == `removeSlink`
                          ? (p = h)
                          : h.FunctionName == `fit` && (m = h));
    var g = !1;
    if (
      (d &&
        ((g = !0),
        (h.FunctionResult = `ok`),
        (this.instance.config.template = h.FunctionArguments.templateName)),
      f)
    ) {
      var _ = this.instance.getNode(h.FunctionArguments.employeeId1),
        v = this.instance.getNode(h.FunctionArguments.employeeId2);
      !_ || !v || _ == v
        ? (h.FunctionResult = `Cannot add link between ${h.FunctionArguments.employeeId1} and ${h.FunctionArguments.employeeId2}`)
        : ((g = !0),
          this.instance.addSlink(_.id, v.id),
          (h.FunctionResult = `ok`));
    }
    if (p) {
      var _ = this.instance.getNode(h.FunctionArguments.employeeId1),
        v = this.instance.getNode(h.FunctionArguments.employeeId2);
      !_ || !v || _ == v
        ? (h.FunctionResult = `Cannot remove link between ${h.FunctionArguments.employeeId1} and ${h.FunctionArguments.employeeId2}`)
        : ((g = !0),
          this.instance.removeSlink(_.id, v.id),
          (h.FunctionResult = `ok`));
    }
    ...
    for (var h of a)
      ((g = !0),
        (h.FunctionResult = `ok`),
        this.instance.remove(h.FunctionArguments.id));
    for (var h of o) {
      ((g = !0), (h.FunctionResult = `ok`));
      var y = JSON.parse(JSON.stringify(h.FunctionArguments));
      (y.isAssistant && (y.tags = [`assistant`]),
        delete y.isAssistant,
        OrgChart.isNEU(y.id) && (y.id = this.instance.generateId()),
        this.instance.add(y));
    }
    for (var h of s) {
      ((g = !0), (h.FunctionResult = `ok`));
      var y = this.instance.get(h.FunctionArguments.id);
      for (var b in h.FunctionArguments)
        b != `id` &&
          h.FunctionArguments[b] != null &&
          (y[b] = h.FunctionArguments[b]);
    ...
    for (var h of c) {
      ...
      for (var x of h.FunctionArguments.ids) {
        ...
        C &&
          ((C.style.stroke = h.FunctionArguments.color),
          (C.style.strokeWidth = 5));
      }
    }
    var w = function () {
      for (var e of l)
        if (((e.FunctionResult = `ok`), e.FunctionArguments.ids))
          for (var t of e.FunctionArguments.ids) {
    ...
    g
      ? (this.setContext(),
        this.instance.draw(OrgChart.action.update, void 0, w))
      : w();
    var T = function () {
      var e = [];
      for (var t of i.toolCalls)
        e.push({ Role: `tool`, Text: t.FunctionResult, Id: t.Id });
      r._prompt(e, n);
    };
    u
  ...
  (OrgChart.aiUI.prototype.init = function (e) {
    this.instance = e;
    var t = this,
      n = this.instance.element.querySelector(`[data-boc-ai-button]`);
    n &&
  ...
  (OrgChart.aiUI.prototype.show = function (t, n) {
    (this.instance.pdfPreviewUI.hide(),
      this.instance.svgPreviewUI.hide(),
      this.instance.pngPreviewUI.hide(),
      this.instance.powerPointPreviewUI.hide(),
  ...
  (OrgChart.aiUI.prototype._create = function () {
    if (!this.element) {
      var t = this,
        n = `inp_` + this.instance.generateId();
      ((this.element = document.createElement(`div`)),
      ...
      (r &&
        ...
        (this.inputElement = this.element.querySelector(`#` + n)),
        (this.btnSendElement =
        ...
        this.inputElement.addEventListener(`keyup`, function (n) {
          ...
          switch (
            ...
            case `Enter`:
              ...
              break;
            case `ArrowUp`:
              var i = OrgChart.aiUI._getSuggestions();
              if (i.length) {
                var a = i.indexOf(t.inputElement.value);
                (a == -1 ? (a = i.length - 1) : a--,
                  a == -1 && (a = i.length - 1),
                  (t.inputElement.value = i[a]));
              }
              break;
            case `ArrowDown`:
              var i = OrgChart.aiUI._getSuggestions();
  ...
  (OrgChart.aiUI.prototype.addUserMessage = function (e) {
    this.btnSendElement.classList.remove(`boc-ai-send-cansend`);
    var t = this.element.querySelector(`.boc-ai-start`);
    t &&
      (t.classList.remove(`boc-ai-start`),
      (this.messagesElement.innerHTML = ``));
    var n = document.createElement(`div`);
    (n.classList.add(`boc-ai-user-message`),
      (n.innerHTML = `<span class="boc-inner-user-message">${e}</span>`),
      this.messagesElement.appendChild(n));
  }),
  ...
  (OrgChart.aiUI._addSuggestion = function (t) {
    t = t.trim();
    var n = OrgChart.aiUI._getSuggestions(),
      r = n.indexOf(t);
    (r != -1 && n.splice(r, 1),
      n.push(t),
      localStorage.setItem(`suggestions`, JSON.stringify(n)));
  }),
  ...
  (OrgChart.orgScribeUI.prototype.init = function (e) {
    this.instance = e;
  }),
  OrgChart.events.on(`updated`, function (t, n) {
  ...
  (OrgChart.orgScribeUI.prototype.show = function (t, n) {
    (this.instance.pdfPreviewUI.hide(),
      this.instance.svgPreviewUI.hide(),
      this.instance.pngPreviewUI.hide(),
      this.instance.powerPointPreviewUI.hide(),
  ...
  (OrgChart.orgScribeUI.prototype._create = function () {
    if (!this.element) {
      ...
      ((this.element = document.createElement(`div`)),
        ...
        this.element.classList.add(this.instance.config.mode));
      var n = OrgChart._convertFromNodesToText(
        this.instance.config.nodes,
        OrgChart.ORGSCRIBE_OFFSET,
      );
      ...
      (r &&
        ...
        this.textAreaElement.addEventListener(`input`, function () {
          ...
          t._timeout = setTimeout(function () {
            var r = OrgChart._convertTextToNodes(n, OrgChart.ORGSCRIBE_OFFSET);
            t.instance.load(r);
          }, 500);
        }));
    }
  ...
  (function (e, t) {
    typeof exports == `object` && typeof module < `u`
      ...
      : typeof define == `function` && define.amd
        ? define([`exports`], t)
        : t(
            ((e = typeof globalThis < `u` ? globalThis : e || self).marked =
              {}),
          );
  })(this, function (e) {
    "use strict";
    ...
    let a = {
      ...
      O = i(D, `u`).replace(/punct/g, S).getRegex(),
      k = i(D, `u`).replace(/punct/g, E).getRegex(),
      ...
      ie = {
        ...
        punctuation: T,
        reflink: ne,
        reflinkSearch: i(`reflink|nolink(?!\\()`, `g`)
          .replace(`reflink`, ne)
          .replace(`nolink`, re)
          .getRegex(),
        tag: ee,
      ...
      oe = { normal: _, gfm: y, pedantic: b },
      B = { normal: ie, gfm: z, breaks: ae, pedantic: R },
      V = {
        "&": `&amp;`,
        "<": `&lt;`,
        ">": `&gt;`,
    ...
    function U(e, t) {
      if (t) {
        ...
        return e.replace(a.escapeReplaceNoEncode, H);
      return e;
    }
    function se(e) {
      try {
    ...
    function G(e, t, n, r, i) {
      ...
      return { type: `image`, raw: n, href: a, title: o, text: s };
    }
    class le {
      options;
      rules;
...
`
    ...
    class K {
      ...
      constructor(t) {
        ...
        let n = { other: a, block: oe.normal, inline: B.normal };
        (this.options.pedantic
          ? ((n.block = oe.pedantic), (n.inline = B.pedantic))
          : this.options.gfm &&
            ((n.block = oe.gfm),
    ...
    class Y {
      ...
      parseMarkdown(e) {
        return (t, n) => {
          ...
          let o = i.hooks ? i.hooks.provideLexer() : e ? K.lex : K.lexInline,
            s = i.hooks ? i.hooks.provideParser() : e ? J.parse : J.parseInline;
          if (i.async)
...
Please report this to https://github.com/markedjs/marked.`),
  ...
  OrgChart.events.on(`renderbuttons`, function (t, n) {
    if (n.node && n.node.tags && n.node.tags.has(`group-dotted-lines`)) {
      var r = t.getScale(),
        i = OrgChart.t(n.node.templateName, n.node.min, r),
        a = ``;
      (n.node.min
        ? (i.nodeGroupDottedOpenButton ||
            console.error(
              `[${n.node.templateName}].nodeGroupDottedOpenButton is not defined`,
            ),
          (a += `<g style="cursor:pointer;"  data-ctrl-n-dotted-open="${n.node.id}" transform="matrix(1,0,0,1,${n.node.x},${n.node.y})">`),
          (a += i.nodeGroupDottedOpenButton))
        : (i.nodeGroupDottedCloseButton ||
            console.error(
              `[${n.node.templateName}].nodeGroupDottedCloseButton is not defined`,
            ),
          (a += `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${n.node.x},${n.node.y})" data-ctrl-n-dotted-close="${n.node.id}">`),
          (a += i.nodeGroupDottedCloseButton)),
        (a += `</g>`),
        (a = a
          .replaceAll(`{cw}`, n.node.w / 2)
          .replaceAll(`{ch}`, n.node.h / 2)
          .replaceAll(
            `{ew}`,
            n.node.w - (n.node.padding ? n.node.padding[1] : 0),
          )
          .replaceAll(
            `{eh}`,
            n.node.h - (n.node.padding ? n.node.padding[2] : 0),
          )));
      var o = t.getNode(n.node.stChildrenIds[0]);
      (a.indexOf(`{collapsed-children-count}`) != -1 &&
        (a = a.replace(
          `{collapsed-children-count}`,
          o.collapsedChildrenIds.length,
        )),
        a.indexOf(`{collapsed-children-total-count}`) != -1 &&
          (a = a.replace(
            `{collapsed-children-total-count}`,
            o.deepCollapsedChildCount,
          )),
        a.indexOf(`{children-count}`) != -1 &&
          (a = a.replace(`{children-count}`, o.childrenIds.length)),
        a.indexOf(`{children-total-count}`) != -1 &&
          (a = a.replace(`{children-total-count}`, o.deepChildCount)),
        (n.html += a));
    }
  }),
  OrgChart.events.on(`redraw`, function (t, n) {
    ...
    if (
      ...
      var i = t.getNode(r);
      if (i.isTreeListItem) {
        var a = OrgChart._getCenterNodeFromParams(
            t.manager.nodes,
            t.manager.actionParams,
          ),
          o = a.stChildren[0].lcn ? a.stChildren[0].lcn : `base`,
          s = t.manager.layoutConfigs[o],
          c = OrgChart._getScrollTopForNode(a, i.id),
          l = a.treeList.scrollTop;
        c != l &&
          (t._treeListUpdateInterval = OrgChart.animate(
            ...
            function () {},
            function (e) {
              ((a.treeList.scrollTop = e * (c - l) + l),
                t._treeListUpdate(a, s.orientation));
            },
          ));
      }
    }
  }),
  (OrgChart.prototype.__mouseScrollHandlerTreeList = function (t, n) {
    var r = n.delta || n.wheelDelta;
    for (
      r === void 0 && (r = -n.detail), r = Math.max(-1, Math.min(1, r));
      t && !t.stParent;
    )
      t = t.parent;
    t = t.stParent;
    var i = OrgChart.TREELIST_WHEEL_STEP;
    (i == `auto` && (i = t.stChildren[0].h / 2),
      (t.treeList.scrollTop += -r * i));
    var a = t.stChildren[0].lcn ? t.stChildren[0].lcn : `base`,
      o = this.manager.layoutConfigs[a];
    ((this._treeListUpdateInterval &&=
      (clearInterval(this._treeListUpdateInterval), null)),
      OrgChart._treeListGetTumbPositionFromScrollTop(t).scrollBarDisplay ==
        `none` || (n.preventDefault(), this._treeListUpdate(t, o.orientation)));
  }),
  (OrgChart.prototype._treeListUpdate = function (t, n) {
    (OrgChart._treeListSetProps(t, n),
      OrgChart._treeListAdjustToSTNodePostition(t.stChildren, t));
    var r = this.getScale(),
      i = this.element.querySelector(`[data-treelist-content="${t.id}"]`),
      a = i.transform.baseVal.consolidate().matrix;
    ((a.f = -t.treeList.scrollTop),
    ...
    var c = this.element.querySelector(`[data-treelist-thumb="${t.id}"]`),
  ...
  (OrgChart.prototype._treeListIterate2 = function (e, t, n, r) {
    for (var i of e)
      (t.treeList.pinnedIds.includes(i.id) ||
        this._treeListSetPositions(i, n, r, !1),
        this._treeListIterate2(i.children, t, n, r));
  }),
  (OrgChart.prototype._treeListSetPositions = function (e, t, n, r) {
    var i = this.getNodeElement(e.id);
    if (i) {
      var a = i.transform.baseVal.consolidate().matrix;
      (i.classList.remove(`treelist-pinned`),
        r && (i.classList.add(`treelist-pinned`), n.appendChild(i)),
        (a.f = e.y),
        (a.e = e.x));
  ...
  (OrgChart.prototype._treeListThumbMouseDownHandler = function (t, n, r) {
    var i = t.getAttribute(`data-treelist-thumb`),
      a = this.getNode(i),
      o = this.getSvg(),
      s = this,
      c = !0,
      l = OrgChart._getClientXY(n),
      u = this.getScale(),
      d = parseFloat(t.getAttribute(`y`)),
      f = parseFloat(t.getAttribute(`height`)),
      p = function (t) {
        if (c) {
          thumbPosition = d + (OrgChart._getClientXY(t).y - l.y) / u;
          var n = OrgChart._treeListGetScrollTopFromTumbPosition(
            a,
            f,
            thumbPosition,
          );
          ((a.treeList.scrollTop = n),
            (s._treeListUpdateInterval &&=
              (clearInterval(s._treeListUpdateInterval), null)),
            s._treeListUpdate(a));
        }
      },
      m = function (e) {
        ((c = !1),
          o.removeEventListener(r.move, p),
          o.removeEventListener(r.up, m));
      };
  ...
  (OrgChart.prototype._treeListExpandCollapseHandler = function (t) {
    ...
    if (n && n.isTreeListItem) {
      var r = OrgChart.getRootOf(n).stParent;
      if (r.treeList.pinnedIds.includes(t)) {
        var i = OrgChart._getScrollTopForNode(r, n.id);
  ...
  (OrgChart.prototype.undo = function (t) {
    if (this.config.undoRedoStorageName) {
      ...
      if (n != 0) {
        ...
        var r = `${this.config.undoRedoStorageName}_undo_` + (n - 1),
  ...
  (OrgChart.prototype.redo = function (t) {
    if (this.config.undoRedoStorageName) {
      ...
      if (n != 0) {
        this._putInUndoStack();
        var r = `${this.config.undoRedoStorageName}_redo_` + (n - 1),
          i = sessionStorage.getItem(r);
        sessionStorage.removeItem(r);
        var a = JSON.parse(i);
        ((this.config.nodes = a.nodes),
  ...
  (OrgChart.prototype.clearRedo = function () {
    if (this.config.undoRedoStorageName) {
      for (
        ...
        (sessionStorage.removeItem(e + n), n++);
      this.undoRedoUI.refresh();
    }
  }),
  ...
  (OrgChart.undoRedoUI.prototype.init = function (e) {
  ...
  (OrgChart.undoRedoUI.prototype.refresh = function () {
    ...
    if (this.instance.config.undoRedoStorageName) {
      ...
      if (OrgChart.events.publish(`change`, [this, n]) !== !1) {
        ...
        (n.undoStepsCount > 0
          ? (r.classList.add(`boc-ur-clickable`),
            (r.querySelector(`.boc-undo-i`).innerHTML = n.undoStepsCount),
          ...
          n.redoStepsCount > 0
            ? (i.classList.add(`boc-ur-clickable`),
              (i.querySelector(`.boc-redo-i`).innerHTML = n.redoStepsCount),
  ...
  (OrgChart.undoRedoUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.undoRedoUI.prototype.onChange = function (e) {
  ...
  OrgChart.events.on(`redraw`, function (t, n) {
    ...
    if (t.manager.action == OrgChart.action.move) return;
    ...
    (OrgChart.miniMap._init(t),
      ...
      OrgChart.miniMap._drawRectSelectorCanvas(t, i));
    var a = t.element.querySelector(`[data-id="mini-map-focus"]`),
      o = !1,
      s,
      c,
      l,
    ...
    function f(t, n) {
      var r =
          (t - OrgChart.miniMap._settings._translateX) /
          OrgChart.miniMap._settings._scale,
        a =
          (n - OrgChart.miniMap._settings._translateY) /
          OrgChart.miniMap._settings._scale;
    ...
    function p(e) {
      var t = a.getBoundingClientRect(),
        ...
        r = t.top;
      if (
        ((s = parseInt(e.clientX - n)), (c = parseInt(e.clientY - r)), f(s, c))
      ) {
    ...
    function m(n) {
      if (o) {
        ...
        var m = (l - s) / OrgChart.miniMap._settings._scale,
          h = (u - c) / OrgChart.miniMap._settings._scale;
        ((i[0] = m + i[0]),
          (i[1] = h + i[1]),
          t.setViewBox(i),
    ...
    function _(n) {
      if (
        (n.preventDefault(), n.stopPropagation(), OrgChart.miniMap._mouseMove)
      )
        OrgChart.miniMap._mouseMove = !1;
      else {
        var r = a.getBoundingClientRect(),
        ...
        var c = l / OrgChart.miniMap._settings._scale,
          f = u / OrgChart.miniMap._settings._scale;
        ((i[0] =
          c -
          (i[0] + i[2] - i[0]) / 2 -
          OrgChart.miniMap._settings._translateX /
  ...
  (OrgChart.miniMap._drawMainCanvas = function (t) {
    var n = t.element.querySelector(`[data-id="mini-map-main"]`),
      r = n.getContext(`2d`);
    OrgChart.miniMap._initCtx(t, n, 1);
    var i = 0,
      a = [];
    function o(t, n) {
      if (Array.isArray(n)) {
      ...
      for (var s = 0; s < n.stChildrenIds.length; s++)
        (i++,
          a.includes(n.id) ||
            (i == 1
              ...
              : i == 2
                ...
                : i == 3 && (r.fillStyle = OrgChart.miniMap.colors[2]),
            r.beginPath(),
            r.fillRect(n.x, n.y, n.w, n.h),
            r.strokeRect(n.x, n.y, n.w, n.h),
            a.push(n.id)),
          o(t, t.getNode(n.stChildrenIds[s])),
          i--);
      for (var s = 0; s < n.childrenIds.length; s++)
        o(t, t.getNode(n.childrenIds[s]));
    }
    o(t, t.roots);
  }),
  (OrgChart.miniMap._drawRectSelectorCanvas = function (t, n) {
    ...
    ((i.lineWidth = 0.5 / OrgChart.miniMap._settings._scale),
      ...
      (i.globalAlpha = 1),
      i.clearRect(a, o, s, c),
      i.strokeRect(a, o, s, c));
  }),
  (OrgChart.miniMap._initCtx = function (t, n, r) {
  ...
  (OrgChart.miniMap._init = function (t) {
    if (!t.element.querySelector(`[data-id="mini-map"]`)) {
      ...
      ((n.width = OrgChart.miniMap.width),
        (n.height = OrgChart.miniMap.height),
        n.setAttribute(`data-id`, `mini-map-main`),
        (n.style.display = `inline-block`),
        (n.style.backgroundColor = OrgChart.miniMap.backgroundColor),
      ...
      for (
        var a = [`top`, `right`, `left`, `bottom`], o = 0;
        o < a.length;
        o++
      ) {
        var s = a[o];
        OrgChart.isNEU(OrgChart.miniMap.position[s]) ||
          (OrgChart.miniMap.position[s] == `padding`
            ? (i.style[s] = t.config.padding + `px`)
            : (i.style[s] = OrgChart.miniMap.position[s] + `px`));
      }
      ...
      ((c.style.position = `relative`),
        (c.style.width = OrgChart.miniMap.width + `px`),
        (c.style.height = OrgChart.miniMap.height + `px`),
        c.appendChild(n),
        c.appendChild(r),
        i.appendChild(c),
      ...
      OrgChart.miniMap.draggable && i.addEventListener(`mousedown`, d);
    }
  }),
  ...
  (OrgChart._search = {}),
  (OrgChart._search.search = function (t, n, r, i, a, o, s) {
    var c = [],
      l = n.toLowerCase();
    document.documentElement.lang &&
      (l = n.toLocaleLowerCase(document.documentElement.lang));
    var u = l.split(` `);
    if (s && u.length > 1) {
      var d = u[0];
    ...
    for (var f = {}, p = 0; p < t.length; p++)
      for (var m = t[p], h = 0; h < r.length; h++) {
        var g = r[h];
        if (!OrgChart.isNEU(m[g])) {
          var _ = m[g],
            n = OrgChart._search.searchAndComputeScore(u, _, g, o);
          if (n != null) {
            var v = m.id;
            if (!f[v])
              ((f[v] = n.__score),
                OrgChart._search.addNodeToResult(c, i, m, n, g, a));
            else if (f[v] && f[v] < n.__score) {
              f[v] = n.__score;
              for (var y = c.length - 1; y >= 0; y--)
                c[y].id == v && c.splice(y, 1);
              OrgChart._search.addNodeToResult(c, i, m, n, g, a);
            }
          }
        }
  ...
  (OrgChart._search.addNodeToResult = function (t, n, r, i, a, o) {
    var s = {};
    ((s.id = r.id), OrgChart.isNEU(r[o]) || (s[o] = r[o]));
    for (var c = 0; c < n.length; c++) {
      var l = n[c];
      OrgChart.isNEU(r[l]) || (OrgChart.isNEU(s[l]) && (s[l] = r[l]));
    }
    (i != null &&
      (OrgChart.isNEU(s.__score) && (s.__score = i.__score),
      OrgChart.isNEU(s.__searchField) && (s.__searchField = a),
      OrgChart.isNEU(s.__searchMarks) && (s.__searchMarks = i.__searchMarks)),
      t.push(s));
  }),
  (OrgChart._search.searchAndComputeScore = function (t, n, r, i) {
    if (OrgChart.isNEU(n) || OrgChart.isNEU(t) || !t.length) return null;
    typeof n != `string` && (n = n.toString());
    var a = n.toLowerCase();
    document.documentElement.lang &&
      (a = n.toLocaleLowerCase(document.documentElement.lang));
    var o = OrgChart._search.searchIndexesOf(a, t);
    if (!o.length) return null;
    for (
      var s = a.length / 100, c = 0, l = 0, u = c > 0 ? 100 : 0, d = 0, f = 0;
      f < t.length;
      f++
    )
      for (var p = t[f], m = 0; m < o.length; m++)
        if (p.indexOf(o[m].searchPhrase) != -1) {
          d++;
          break;
        }
    ...
    if (o.length) {
      ...
      for (var m = 0; m < o.length; m++)
        if (
          ((c += o[m].length),
          o[m].start < l && (l = o[m].start),
          m >= 1 && o[m - 1].start > o[m].start)
        ) {
          u = 0;
          break;
        }
    ...
    for (var m = o.length - 1; m >= 0; m--)
      for (var f = 0; f < o.length; f++)
        f < m && o[f].start + o[f].length > o[m].start && o.splice(m, 1);
    for (var b = n, m = o.length - 1; m >= 0; m--)
      ((b = b.insert(o[m].start + o[m].length, `</mark>`)),
        (b = b.insert(o[m].start, `<mark>`)));
    return { __searchMarks: b, __score: y };
  }),
  (OrgChart._search.searchIndexesOf = function (t, n) {
    var r = [];
    if (!OrgChart.isNEU(t))
      for (var i = 0; i < n.length; i++) {
        var a = n[i];
        if (!OrgChart.isNEU(a))
          for (var o = 0; (o = t.indexOf(a, o)), o > -1; )
            (r.push({ length: a.length, start: o, searchPhrase: a }),
              (o += a.length));
      }
    return (
      r.sort(function (e, t) {
  ...
  OrgChart.events.on(`redraw`, function (t, n) {
    ...
    function a(e) {
      ...
      (typeof e.id != `string` ||
        (typeof e.id == `string` &&
          e.id.indexOf(`split`) == -1 &&
          e.id.indexOf(`mirror`) == -1)) &&
        (r.push(e.id), e.min == 1 && i.push(e.id));
  ...
  (OrgChart.state = {}),
  (OrgChart.state._buildStateNames = function (e) {
    return {
      paramScale: e + `-scale`,
      paramX: e + `-x`,
      paramY: e + `-y`,
  ...
  (OrgChart.state._put = function (t, n, r, i, a, o, s, c) {
    if (c && !(OrgChart.isNEU(a) || a.length == 0)) {
      var l = OrgChart.state._buildStateNames(c.name),
        u = {
          roots: t,
      ...
      if (c.writeToUrlParams) {
        ...
        (d.has(l.paramScale)
          ? d.set(l.paramScale, u.scale)
          : d.append(l.paramScale, u.scale),
          d.has(l.paramX) ? d.set(l.paramX, u.x) : d.append(l.paramX, u.x),
          d.has(l.paramY) ? d.set(l.paramY, u.y) : d.append(l.paramY, u.y),
          d.has(l.paramExp)
            ? d.set(l.paramExp, u.exp.join(`*`))
            : d.append(l.paramExp, u.exp.join(`*`)),
          d.has(l.paramRoots) && Array.isArray(u.roots)
            ? d.set(l.paramRoots, u.roots.join(`*`))
            : Array.isArray(u.roots) &&
              d.append(l.paramRoots, u.roots.join(`*`)),
          d.has(l.paramMin)
            ? d.set(l.paramMin, u.min.join(`*`))
            : d.append(l.paramMin, u.min.join(`*`)),
          d.has(l.paramAdjustify)
            ? d.set(l.paramAdjustify, u.adjustify.x + `*` + u.adjustify.y)
            : d.append(l.paramAdjustify, u.adjustify.x + `*` + u.adjustify.y),
          window.history.replaceState(null, null, `?` + d));
      }
      (c.writeToIndexedDB &&
        ((u.id = c.name),
        OrgChart.idb.put(u, function (e) {
          e == 0 && console.error(`Cannot write row - ` + c.name);
        })),
        c.writeToLocalStorage &&
          OrgChart.localStorage.setItem(c.name, JSON.stringify(u)));
    }
  }),
  (OrgChart.state._get = function (t, n, r, i) {
    if (!t) {
      i(null);
      return;
    }
    ...
    if (t.readFromUrlParams) {
      ...
      if (
        ...
        var s = {},
          c = parseFloat(o.get(a.paramScale)),
          l = parseFloat(o.get(a.paramX)),
          u = parseFloat(o.get(a.paramY)),
          d = [];
        ((d[0] = l),
          (d[1] = u),
          (d[2] = n / c),
          ...
          (s.y = u),
          (s.roots = null),
          o.has(a.paramRoots) && (s.roots = o.get(a.paramRoots).split(`*`)),
          (s.exp = o.get(a.paramExp).split(`*`)),
          (s.min = o.get(a.paramMin).split(`*`)));
        var f = o.get(a.paramAdjustify).split(`*`);
        ((s.adjustify = { x: parseFloat(f[0]), y: parseFloat(f[1]) }), i(s));
        return;
    ...
    if (t.readFromLocalStorage) {
      var s = OrgChart.localStorage.getItem(t.name);
      if (s != null) {
        s = JSON.parse(s);
        var d = [];
        ((d[0] = s.x),
    ...
    t.readFromIndexedDB &&
      OrgChart.idb.read(t.name, function (e, a) {
  ...
  (OrgChart.state.clear = function (t) {
    ...
    try {
      ...
      var n = OrgChart.state._buildStateNames(t),
        r = new URLSearchParams(window.location.search);
      (r.has(n.paramScale) && r.delete(n.paramScale),
        r.has(n.paramX) && r.delete(n.paramX),
        r.has(n.paramY) && r.delete(n.paramY),
        r.has(n.paramExp) && r.delete(n.paramExp),
        r.has(n.paramRoots) && r.delete(n.paramRoots),
        r.has(n.paramMin) && r.delete(n.paramMin),
        r.has(n.paramAdjustify) && r.delete(n.paramAdjustify),
  ...
  (OrgChart._magnify = {}),
  (OrgChart.prototype.magnify = function (t, n, r, i, a) {
    i ||= this.config.anim;
    var o = this.getNode(t),
      s = this.getNodeElement(t);
    if (!(!o && !s)) {
      var c = OrgChart._magnify[t];
      (c &&
        (c.timer != null && clearInterval(c.timer),
        c.timerBack != null && clearInterval(c.timerBack),
        s.setAttribute(
          `transform`,
          `matrix(` + c.transformStart.toString() + `)`,
        ),
        (OrgChart._magnify[t] = null)),
        r && ((s = s.cloneNode(!0)), this.getSvg().appendChild(s)));
      var l = OrgChart._getTransform(s),
        u = JSON.parse(JSON.stringify(l));
      ((u[0] = n), (u[3] = n));
      var d = o.w + o.w * (n - 1),
        f = o.h + o.h * (n - 1);
      ((u[4] += (o.w - d) / 2), (u[5] += (o.h - f) / 2));
      var p = OrgChart.animate(
        s,
        { transform: l },
        { transform: u },
        i.duration,
  ...
  (OrgChart.prototype.magnifyBack = function (t, n, r) {
    n ||= this.config.anim;
    var i = OrgChart._magnify[t];
    if (i) {
      (i.timer != null && clearInterval(i.timer),
        i.timerBack != null && clearInterval(i.timerBack));
      ...
      i.timerBack = OrgChart.animate(
        ...
        n.func,
        function (t) {
          var n = t[0].getAttribute(OrgChart.attr.node_id);
          (OrgChart._magnify[n] &&
            OrgChart._magnify[n].front &&
            (t[0].parentNode.removeChild(t[0]), (OrgChart._magnify[n] = null)),
            r && r(t[0]));
        },
      );
    }
  ...
  OrgChart === void 0 && (OrgChart = {}),
  OrgChart.events.on(`init`, function (t, n) {
    if (
  ...
  (OrgChart.prototype._windowKeyDownHandler = function (t, n) {
    ...
    if (r) {
      var a = i ? this.getNode(i) : null,
        o = { node: a, data: i ? this.get(i) : null, event: n };
      if (OrgChart.events.publish(`key-down`, [this, o]) !== !1 && a) {
        if (n.code == `KeyF`) this.searchUI.find(``);
        else if (
          n.code == `ArrowRight` ||
          (a.isAssistant && n.code == `ArrowDown`) ||
  ...
  OrgChart.events.on(`click`, function (e, t) {
    e.config &&
  ...
  (OrgChart.elements = {}),
  (OrgChart.elements.textbox = function (t, n, r, i) {
    var a = OrgChart.elements._vidrf(t, n, i);
    if (a.doNotRender) return { html: `` };
    var o = ``;
    return (
      n.btn &&
        (o = `<a href="#" data-input-btn="" class="boc-link boc-link-boc-button">${n.btn}</a>`),
      {
  ...
  (OrgChart.elements.checkbox = function (t, n, r, i) {
    var a = OrgChart.elements._vidrf(t, n, i);
    if (a.doNotRender) return { html: `` };
    var o = a.value ? `checked` : ``,
      s = i ? `onclick="return false;"` : ``;
    return {
      html: `<div class="boc-form-field"  style="min-width: ${r};" >
                        <label class="boc-checkbox" data-boc-input="" ${a.disabledAttribute}>
                            <input ${o} ${s} data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" type="checkbox"><span class="boc-checkbox-checkmark" type="checkbox"></span>${OrgChart._escapeGreaterLessSign(a.label)}
                        </label>
                    </div>`,
      id: a.id,
      value: o,
  ...
  (OrgChart.elements.select = function (t, n, r, i) {
    if (i) return OrgChart.elements.textbox(t, n, r, i);
    var a = OrgChart.elements._vidrf(t, n, i);
                        ...
                        <select data-binding="${OrgChart._escapeDoubleQuotes(a.binding)}" ${a.readOnlyAttribute} id="${a.id}" name="${a.id}">
                            ${(function () {
                              for (
                                ...
                                var r = a.options[n],
                                  i = r.value == a.value ? `selected` : ``;
                                t += `<option ${i} value="${OrgChart._escapeDoubleQuotes(r.value)}">${OrgChart._escapeGreaterLessSign(r.text)}</option>`;
                              }
                              return t;
                            })()}                           
                        </select>
  ...
  (OrgChart.elements.multiSelect = function (t, n, r, i) {
    if (i) return OrgChart.elements.textbox(t, n, r, i);
    var a = OrgChart.elements._vidrf(t, n, i);
    return a.doNotRender
      ? { html: `` }
  ...
  (OrgChart.elements.date = function (t, n, r, i) {
    var a = OrgChart.elements._vidrf(t, n, i);
    return a.doNotRender
      ? { html: `` }
      : {
  ...
  (OrgChart.elements._vidrf = function (t, n, r) {
    var i = {};
    if (
      ((n.binding ||= ``),
      (n.label ||= ``),
      n.type == `select` && !Array.isArray(n.options)
        ? (i.options = [])
        : (i.options = n.options),
      (i.value = t && !OrgChart.isNEU(t[n.binding]) ? t[n.binding] : ``),
      r && i.options)
    ) {
    ...
    if (
      ...
      r && n.binding == `photo` && ((i.id = null), (i.doNotRender = !0)),
      (i.binding = n.binding),
      (i.label = n.label),
      (i.vlidators = ``),
      n.vlidators)
    )
      for (var o in n.vlidators)
        i.vlidators += `data-v-${o}="${n.vlidators[o]}" `;
    return i;
  }),
  ...
  (OrgChart.input.init = function (t) {
    for (
      ...
      var i = n[r],
        a = null;
      (i.type && i.type.toLowerCase() == `hidden` && (a = i),
        (a ||= i.querySelector(`input`)),
        (a ||= i.querySelector(`select`)));
  ...
  (OrgChart.input.blurHandler = function (e) {
  ...
  (OrgChart.input.validate = function (t) {
    var n = null;
    (t.type && t.type.toLowerCase() == `hidden` && (n = t),
    ...
    var a = t.getAttribute(`data-v-required`),
      ...
      s = t.getAttribute(`data-v-email`),
      c = t.getAttribute(`data-v-emails`);
    return a && n.value == ``
      ? ((r.innerHTML +=
          `<span class="boc-validation-error-message">&nbsp;` + a + `</span>`),
        n.classList.add(`boc-validation-error`),
        !1)
      : o && !OrgChart.input.validatePassword(n.value)
        ? ((r.innerHTML +=
          ...
          n.classList.add(`boc-validation-error`),
          !1)
        : s && !OrgChart.input.isValidEmail(n.value)
          ? ((r.innerHTML +=
              `<span class="boc-validation-error-message">&nbsp;` +
              s +
              `</span>`),
            n.classList.add(`boc-validation-error`),
            !1)
          : c && !OrgChart.input.isValidEmails(n.value)
            ? ((r.innerHTML +=
                `<span class="boc-validation-error-message">&nbsp;` +
                c +
                `</span>`),
  ...
  (OrgChart.input.validateAndGetData = function (t) {
    for (
      var n = t.querySelectorAll(`[data-boc-input]`), r = !0, i = 0;
      i < n.length;
      i++
    ) {
      var a = n[i];
    ...
    return r ? OrgChart.input.getData(t) : !1;
  }),
  (OrgChart.input.getData = function (e) {
    for (
      var t = e.querySelectorAll(`[data-binding]`), n = {}, r = 0;
      r < t.length;
      r++
    ) {
      var i = t[r],
        a = i.getAttribute(`data-binding`);
  ...
  (OrgChart.input.validatePassword = function (e) {
    return (
      (e &&= e.trim()),
      e.length < 5 || e.length > 18 ? !1 : e.indexOf(` `) == -1
    );
  }),
  ...
  (OrgChart.input.isValidEmail = function (e) {
    return (
      (e &&= e.trim()),
  ...
  OrgChart === void 0 && (OrgChart = {}),
  (OrgChart.prototype.onField = function (e) {
    return this.on(`field`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onInit = function (e) {
    return this.on(`init`, function (t) {
      return e.call(t);
    });
  }),
  (OrgChart.prototype.onRedraw = function (e) {
    return this.on(`redraw`, function (t) {
      return e.call(t);
    });
  }),
  (OrgChart.prototype.onUpdateNode = function (e) {
    return this.on(`update`, function (t, n, r) {
      var i = { oldData: n, newData: r };
      return e.call(t, i);
    });
  }),
  (OrgChart.prototype.onUpdated = function (e) {
    return this.on(`updated`, function (t) {
      return e.call(t);
    });
  }),
  (OrgChart.prototype.onRemoveNode = function (e) {
    return this.on(`remove`, function (t, n, r) {
      var i = { id: n, newPidsAndStpidsForIds: r };
      return e.call(t, i);
    });
  }),
  (OrgChart.prototype.onAddNode = function (e) {
    return this.on(`add`, function (t, n) {
      var r = { data: n };
      return e.call(t, r);
    });
  }),
  (OrgChart.prototype.onDrop = function (e) {
    return this.on(`drop`, function (t, n, r, i, a) {
      var o = { dragId: n, dropId: r, dragNodeElement: i, event: a };
      return e.call(t, o);
    });
  }),
  (OrgChart.prototype.onDrag = function (e) {
    return this.on(`drag`, function (t, n, r, i) {
      var a = { dragId: n, event: r, nodeIds: i };
      return e.call(t, a);
    });
  }),
    ...
    OrgChart.prototype.onExpandCollpaseButtonClick =
      function (e) {
        return this.on(`expcollclick`, function (t, n, r, i) {
          var a = { collapsing: n, id: r, ids: i };
          return e.call(t, a);
        });
      }),
  (OrgChart.prototype.onExportStart = function (e) {
    return this.on(`exportstart`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onExportEnd = function (e) {
    return this.on(`exportend`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onNodeClick = function (e) {
    return this.on(`click`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onNodeMouseover = function (e) {
    return this.on(`node-mouseover`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onNodeMouseleave = function (e) {
    return this.on(`node-mouseleave`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onDemand = function (e) {
    return this.on(`on-demand`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onCanvasClick = function (e) {
    return this.on(`canvas-click`, function (t, n) {
      return e.call(t, n);
    });
  }),
  (OrgChart.prototype.onNodeDoubleClick = function (e) {
    return this.on(`dbclick`, function (t, n) {
      var r = { data: n };
      return e.call(t, r);
    });
  }),
  (OrgChart.prototype.onAIToolCalls = function (e) {
  ...
  (OrgChart.filterUI.prototype.addFilterTag = function (t) {
    if (!this.instance.config.filterBy || OrgChart.isNEU(t)) return !1;
    if (
      (this.filterBy === null &&
        typeof this.instance.config.filterBy == `object` &&
  ...
  (OrgChart.filterUI.prototype.show = function (e) {
  ...
  (OrgChart.filterUI.prototype._removeFilter = function (e) {
  ...
  (OrgChart.filterUI.prototype.update = function () {
    if (this.instance.config.filterBy) {
      var t = {};
      if (this.instance.config.filterBy == `all`)
        for (
          var n = OrgChart.manager.getAllFields(this.instance.config), r = 0;
          r < n.length;
          r++
        ) {
          var i = n[r];
        ...
        for (var r = 0; r < this.instance.config.filterBy.length; r++)
          t[this.instance.config.filterBy[r]] = {};
      else if (typeof this.instance.config.filterBy == `object`)
        for (var a in this.instance.config.filterBy) t[a] = {};
      for (var o in t)
        for (var s = t[o], r = 0; r < this.instance.config.nodes.length; r++) {
          var c = this.instance.config.nodes[r][o];
          c != null && (s[c] || (s[c] = { checked: !0, text: c }));
        }
      if (this.filterBy != null) {
        for (var l in t)
          if (this.filterBy[l])
            for (var u in t[l])
              this.filterBy[l][u] && (t[l][u] = this.filterBy[l][u]);
      }
      ...
      for (var l in this.filterBy) {
        var g = { name: l, html: `<div data-filter-field="${l}">${l}</div>` };
        (OrgChart.events.publish(`add-filter`, [m, g]), (h += g.html));
      }
      ((this.element.innerHTML = `<div>${h}</div>`),
        this.element.addEventListener(`click`, function (t) {
          if (
            ...
            for (
              var n = t.target.getAttribute(`data-filter-field`),
                r = m.instance.element.querySelectorAll(`[data-filter-menu]`),
                i = 0;
              i < r.length;
              i++
            )
            ...
            for (
              var a = m.instance.element.querySelectorAll(
            ...
            if (
              ...
              return;
            var s = m.instance.element.querySelector(
              `[data-filter-menu="${n}"]`,
            );
            if (!s) {
              var c = `checked`;
              ...
              var u = {
                ...
                html: `<div>
                        ...
                        <label for="${n}">${OrgChart.filterUI.all}</label>
                    </div>`,
              };
              OrgChart.events.publish(`add-item`, [m, u]);
              var d = u.html;
              for (var f in m.filterBy[n]) {
                var p = m.filterBy[n][f],
                  h = p.text;
                ((h ??= f),
                  (u = {
                    name: n,
              ...
              ((s.innerHTML = `<fieldset>
                ...
                s.setAttribute(`data-filter-menu`, n),
                s.classList.add(`boc-filter-menu`),
                t.target.parentNode.parentNode.appendChild(s));
              for (
                var _ = s.querySelectorAll(`input`), i = 0;
                i < _.length;
                i++
              )
                _[i].addEventListener(`change`, function (t) {
                  for (
                    var n = t.target;
                    n && !n.hasAttribute(`data-filter-menu`);
                  )
                    n = n.parentNode;
                  if (n) {
                    ...
                    if (t.target.hasAttribute(`data-all`)) {
                      for (
                        ...
                        if (i[a] != t.target)
                          for (var o in ((i[a].checked = t.target.checked),
                          m.filterBy[r]))
                            m.filterBy[r][o].checked = t.target.checked;
                    } else if (
                      (m.filterBy[r][this.name] != null &&
                        (m.filterBy[r][this.name].checked = this.checked),
                      this.checked)
                    ) {
                      for (
                        var s = m.instance.config.nodes, c = 0;
                        c < s.length;
                        c++
                      )
                        if (s[c][r] == this.name) {
                          for (var l = s[c]; l; )
                            if (OrgChart.isNEU(l.stpid))
                              ...
                              u
                                ? ((u.checked = this.checked),
                                  (m.filterBy[r][l[r]].checked = this.checked))
                                : console.error(
                    ...
                    var d = !0;
                    for (var f in m.filterBy[r])
                      m.filterBy[r][f].checked || (d = !1);
            ...
            ((s.style.display = `block`),
              ...
              OrgChart.events.publish(`show-items`, [m, { name: n }]));
          }
        }),
  ...
  (OrgChart.filterUI.prototype.on = function (t, n) {
    return (OrgChart.events.on(t, n, this._event_id), this);
  }),
  (OrgChart.filterUI.textFilterBy = `Filter by`),
  (OrgChart.filterUI.all = `[All]`),
  OrgChart === void 0 && (OrgChart = {}),
  OrgChart.remote === void 0 && (OrgChart.remote = {}),
  (OrgChart.LIMIT_NODES = !0),
  (OrgChart.remote._fromResDTO = function (t, n, r, i, a) {
    var o = n[t.id];
    ((t.x = o.p[0]),
      (t.y = o.p[1]),
      (t.w = o.p[2]),
      (t.h = o.p[3]),
      o.ln != null && (t.leftNeighbor = a[o.ln]),
      o.rn != null && (t.rightNeighbor = a[o.rn]),
      o.tl &&
        ((t.treeList = {}),
        (t.treeList.pinnedIds = o.tl[0]),
        (t.treeList.scrollTop = o.tl[1]),
        (t.treeList.scrollTopMax = o.tl[2]),
        (t.treeList.maxHeight = o.tl[3])));
    for (var s = 0; s < t.stChildren.length; s++)
      OrgChart.remote._fromResDTO(t.stChildren[s], n, r, i, a);
    for (var s = 0; s < t.children.length; s++)
      OrgChart.remote._fromResDTO(t.children[s], n, r, i, a);
  }),
  (OrgChart.remote._toReqDTO = function (t, n) {
    var r = {
      p: [
        t.id,
    ...
    (t.children.length > 0 &&
      ...
      t.layout != null && t.layout != 0 && (r.l = t.layout),
      t.isAssistant && (r.a = 1),
    ...
    for (var i = 0; i < t.stChildren.length; i++)
      OrgChart.remote._toReqDTO(t.stChildren[i], n);
    for (var i = 0; i < t.children.length; i++)
      OrgChart.remote._toReqDTO(t.children[i], n);
  }),
  (OrgChart.remote._toReqLayoutConfigsDTO = function (e) {
    var t = {};
    for (var n in e) {
      var r = e[n];
      (t[n] || (t[n] = []),
        (t[n][0] = r.orientation),
        (t[n][1] = r.levelSeparation),
        (t[n][2] = r.mixedHierarchyNodesSeparation),
        (t[n][3] = r.subtreeSeparation),
        (t[n][4] = r.siblingSeparation),
        (t[n][5] = r.layout),
        (t[n][6] = r.columns),
        (t[n][7] = r.collapse),
        (t[n][8] = r.assistantSeparation),
        (t[n][9] = r.partnerNodeSeparation));
    }
    return t;
  }),
  (OrgChart.remote._convertToIdArray = function (e) {
    for (var t = [], n = 0; n < e.length; n++) t.push(e[n].id);
    return t;
  }),
  (OrgChart.remote._setPositions = function (t, n, r, i) {
    for (
      var a = [], o = [], s = OrgChart.remote._toReqLayoutConfigsDTO(n), c = 0;
      c < t.length;
      c++
    )
      (o.push(t[c].id), OrgChart.remote._toReqDTO(t[c], a));
    var l = { n: a, c: s, r: o, v: `9.00.19` };
    if (
      (OrgChart.LIMIT_NODES || (l.l = !0), OrgChart.remote._fromReqDTO != null)
    )
      OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function (n) {
        for (var a = 0; a < t.length; a++)
          OrgChart.remote._fromResDTO(t[a], n, 0, t, i);
        r();
      });
    else {
      l = JSON.stringify(l);
      var u = OrgChart.localStorage.getItem(l);
      ((u &&= JSON.parse(u)),
        u && !u.limit
          ? OrgChart.remote._proceed(t, u, i, r)
          : OrgChart.remote._findRegion(function (n) {
              OrgChart._ajax(n, `post`, l, `json`, function (n) {
                n.error
                  ? r(2)
                  : (OrgChart.remote._proceed(t, n, i, r),
                    OrgChart.localStorage.setItem(l, JSON.stringify(n)));
              });
            }));
    }
  }),
  (OrgChart.remote._proceed = function (t, n, r, i) {
    if ((typeof n == `string` && (n = JSON.parse(n)), n.limit && n.limit == 1))
      i(n.limit);
    else {
      for (var a = 0; a < t.length; a++)
        OrgChart.remote._fromResDTO(t[a], n, 0, t, r);
      i();
    }
  }),
  (OrgChart.remote._findRegion = function (t) {
    var n = OrgChart.localStorage.getItem(OrgChart.FUNC_URL_NAME);
    if (n) t(n);
    else {
      for (
        var r = [
      ...
      for (var a = 0; a < r.length; a++)
        (function () {
          var n = `https://` + r[a] + OrgChart.SERVER_PREFIX,
            o = i[a];
          ((o.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
              (OrgChart.localStorage.setItem(OrgChart.FUNC_URL_NAME, n), t(n));
